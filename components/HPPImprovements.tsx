...
const initialIdeas: HPPImprovement[] = [
    {
        id: 'idea-5',
        title: 'Redizajn Privodnog Kola (Guide Vanes)',
        description: 'Buduće istraživanje redizajna privodnog kola (GV) primjenom kombiniranih principa tuberkula i denticle tehnologije za optimizaciju protoka, smanjenje vibracija i povećanje efikasnosti pri djelomičnim opterećenjima.',
        category: 'Systemic',
    },
    {
        id: 'idea-4',
        title: 'Shark Skin (DENTICLE) Tehnologija',
        description: 'Primjena mikro-struktura inspiriranih kožom morskog psa (denticles) na površine lopatica i kućišta kako bi se smanjilo trenje, spriječilo nakupljanje biofilma i poboljšala hidrodinamička efikasnost.',
        category: 'Mechanical',
    },
    {
        id: 'idea-1',
...
const HPPImprovements: React.FC<{ onBack: () => void }> = ({ onBack }) => {
