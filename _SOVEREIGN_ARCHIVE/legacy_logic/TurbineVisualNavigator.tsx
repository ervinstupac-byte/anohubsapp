...
const TurbineVisualNavigator: React.FC = () => {
    ...
    // NC-9.0 PRECISION TOPOLOGY - DEBUG MODE ENABLED
    useEffect(() => {
        fetch('/Turbine_Grouped.svg')
            ...
            .then(data => {
                ...
                if (svgElement) {
                    ...
                    // Utility: Create Hitbox with NC-9.0 Precision Coordinates
                    ...
                    // =====================================================
                    // NC-9.0 PRECISION TOPOLOGY CALIBRATION
        ...
        <div ref={containerRef} className={`relative w-full ${isFullscreen ? 'h-screen rounded-none' : 'aspect-[1184/864] rounded-xl'} bg-[#0A0F14] border border-cyan-500/20 shadow-2xl transition-all duration-700`}>
            <AnimatePresence mode="wait">
                {viewMode === 'overview' ? (
                    ...
                    >
                        {/* NC-9.0 ZERO-DRIFT CONTAINER: Fixed 1184x864 for 1:1 pixel parity */}
                        <div
                            className="relative"
                            style={{
                                width: '1184px',
                        ...
                        >
                            {/* SVG Container - NC-9.0 ABSOLUTE PIXEL GRID */}
                                ...
                                >
                                    <g
                                        ...
                                        onClick={(e) => {
                                            ...
                                            // NC-9.0 PRODUCTION: Clean click handler
                                    ...
                                    <g className="pointer-events-none">
                                        {COMPONENTS.map(comp => {
                                            // NC-9.0: Direct pixel values, no percentage conversion
                  ...
                  `}>
                                        ...
                                        <div className="p-6 border-b border-cyan-500/10 bg-gradient-to-r from-cyan-900/20 to-transparent flex justify-between items-center">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-cyan-400 font-mono tracking-widest">NC-9.0 COMPONENT ANALYSIS</p>
                                                </div>
                                            </div>
                                            <button
                                                onClick={() => setFocusedId(null)}
                        ...
                        <div className="absolute top-4 left-4 right-4 z-20 pointer-events-none flex justify-between items-start">
                            <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-[10px] font-mono font-bold text-cyan-400 tracking-tighter">NC-9.0 COMPLIANT TOPOLOGY</span>
                                </div>
