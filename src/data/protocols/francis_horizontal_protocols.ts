    ...
    steps: [
      {
        ...
        detail:
          'Verify oil is clear. Milky appearance indicates water ingress. Vibration Check: {{VIB-901-A}}',
        critical: true,
      },
      {
        id: 'b2',
        ...
        detail:
          'Target range 18°C - 55°C. Current: {{TMP-404-X}}. Warning at 60°C. Trip (Shutdown) at 70°C.',
      },
      {
        id: 'b3',
    ...
    steps: [
      {
        ...
        detail:
          'Verify dP < 0.5 Bar. Pressure: {{PRE-202-B}}. Auto-flush triggers at 0.5 Bar or 12h timer.',
      },
      {
        id: 'cw2',
        action: 'Verify Flow Rates',
        detail:
          'Generator Air (1,200 L/min), Thrust Bearing (450 L/min), Guide Bearing (150 L/min).',
      },
      {
        id: 'cw3',
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        detail:
          'Disengage clutch. Turn hand-wheel clockwise (50-100 rotations). Requires 2 operators.',
      },
    ],
  },
  {
