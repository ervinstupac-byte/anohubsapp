...
export const CONTEXT_MAP: Record<string, ContextDefinition> = {
  ...
  [ROUTES.FRANCIS.SOP.PENSTOCK]: {
    ...
    logCategory: 'CIVIL',
    slogan:
      'Water Hammer: Rapid valve closure creates pressure waves (ΔP = ρ·a·Δv). Steel integrity protects against catastrophic rupture.',
  },
  [ROUTES.FRANCIS.SOP.INTAKE]: {
    ...
    logCategory: 'CIVIL',
    slogan:
      'Head Loss: Flow obstructions dissipate energy as turbulence. Clean racks maximize hydraulic efficiency and prevent cavitation.',
  },
  [ROUTES.FRANCIS.SOP.WATER_HAMMER]: {
    ...
    logCategory: 'SAFETY',
    slogan:
      'Pressure Surge: Joukowsky equation (ΔP = ρ·c·Δv) predicts shock magnitude. Surge tanks and controlled closure prevent pipe failure.',
  },
  [ROUTES.FRANCIS.SOP.CATHODIC]: {
    ...
    logCategory: 'CIVIL',
    slogan:
      'Corrosion Prevention: Sacrificial anodes protect steel via electron donation. Monitor potential to ensure -850mV threshold.',
  },
  [ROUTES.FRANCIS.SOP.AUXILIARY]: {
    ...
    logCategory: 'CIVIL',
    slogan:
      'Support Infrastructure: HVAC, lighting, and drainage ensure operational environment. Redundancy prevents single-point failures.',
  },
  ...
  [ROUTES.FRANCIS.SOP.BEARINGS]: {
    ...
    logCategory: 'MECH',
    slogan:
      'Hydrodynamic Lubrication: Oil viscosity creates pressure wedge separating surfaces. Temperature >65°C degrades film strength.',
  },
  [ROUTES.FRANCIS.SOP.ALIGNMENT]: {
    ...
    logCategory: 'MECH',
    slogan:
      'Precision Coupling: Misalignment induces harmonic vibration and bearing overload. Target: <0.05mm offset, <0.1° angular error.',
  },
  [ROUTES.FRANCIS.SOP.THRUST_BALANCE]: {
    ...
    logCategory: 'MECH',
    slogan:
      'Axial Force Balance: Runner generates upward thrust (F = ρ·Q·Δv). Thrust bearing absorbs imbalance preventing shaft migration.',
  },
  [ROUTES.FRANCIS.SOP.VORTEX_CONTROL]: {
    ...
    logCategory: 'FLUID',
    slogan:
      'Draft Tube Vortex: Residual swirl creates low-pressure cores inducing vibration. Fins and air injection disrupt coherent structures.',
  },
  [ROUTES.FRANCIS.SOP.MIV_DISTRIBUTOR]: {
    ...
    logCategory: 'MECH',
    slogan:
      'Flow Control: Distributor ensures symmetric runner loading. MIV provides emergency isolation in <10 seconds.',
  },
  [ROUTES.FRANCIS.SOP.REGULATING_RING]: {
    ...
    logCategory: 'MECH',
    slogan:
      'Guide Vane Actuation: Ring synchronizes wicket gate position controlling flow rate. Hydraulic servo maintains <0.5° deviation.',
  },
  [ROUTES.FRANCIS.SOP.LINKAGE]: {
    ...
    logCategory: 'MECH',
    slogan:
      'Precision Transmission: Linkage converts servo stroke to gate rotation. Wear tolerance <1mm prevents flow asymmetry and vibration.',
  },
  [ROUTES.FRANCIS.SOP.COUPLING]: {
    ...
    logCategory: 'MECH',
    slogan:
      'Power Transfer: Elastic coupling transmits torque while dampening torsional oscillations. Misalignment accelerates fatigue failure.',
  },
  [ROUTES.FRANCIS.SOP.BRAKING_SYSTEM]: {
    ...
    logCategory: 'SAFETY',
    slogan:
      'Rotational Energy Arrest: Disc brakes convert kinetic energy to heat (E = ½Iω²). Emergency stop: <120 seconds from rated speed.',
  },
  [ROUTES.FRANCIS.SOP.SEAL_RECOVERY]: {
    ...
    logCategory: 'MECH',
    slogan:
      'Leakage Prevention: Compressed air seals prevent water ingress at shaft penetration. Differential >0.2 bar maintains dry rotor.',
  },
  ...
  [ROUTES.FRANCIS.SOP.OIL_HEALTH]: {
    ...
    logCategory: 'FLUID',
    slogan:
      'Lubricant Integrity: Oxidation and contamination degrade viscosity index. Ferrography detects wear particles indicating component failure.',
  },
  [ROUTES.FRANCIS.SOP.COOLING_WATER]: {
    ...
    logCategory: 'FLUID',
    slogan:
      'Thermal Management: Heat exchangers dissipate bearing and winding losses (Q = mcΔT). Flow <80% triggers thermal runaway risk.',
  },
  [ROUTES.FRANCIS.SOP.DRAINAGE_PUMPS]: {
    ...
    logCategory: 'FLUID',
    slogan:
      'Water Removal: Sump pumps prevent transformer pit flooding and bearing contamination. Redundancy ensures continuous operation.',
  },
  [ROUTES.FRANCIS.SOP.LUBRICATION]: {
    ...
    logCategory: 'FLUID',
    slogan:
      'Oil Distribution: Centralized system delivers filtered oil to bearings and governor. Pressure <1.5 bar triggers alarm sequence.',
  },
  [ROUTES.FRANCIS.SOP.HPU]: {
    ...
    logCategory: 'FLUID',
    slogan:
      'Actuator Power: HPU provides 160 bar pressure for wicket gate and MIV control. Accumulators buffer demand spikes.',
  },
  ...
  [ROUTES.FRANCIS.SOP.GENERATOR]: {
    ...
    logCategory: 'ELEC',
    slogan:
      'Power Generation: Rotating magnetic field induces voltage (E = 4.44·f·N·Φ). Insulation resistance >1GΩ prevents winding failure.',
  },
  [ROUTES.FRANCIS.SOP.ELECTRICAL_HEALTH]: {
    ...
    logCategory: 'ELEC',
    slogan:
      'Insulation Monitoring: Partial discharge and tan-delta tests detect degradation. Temperature rise >80K indicates cooling failure.',
  },
  [ROUTES.FRANCIS.SOP.GOVERNOR_PID]: {
    ...
    logCategory: 'ELEC',
    slogan:
      'Speed Control: PID loop adjusts wicket gates maintaining 50Hz ±0.1%. Dead band <0.02% prevents hunting oscillations.',
  },
  [ROUTES.FRANCIS.SOP.GRID_SYNC]: {
    ...
    logCategory: 'ELEC',
    slogan:
      'Breaker Closure: Voltage, frequency, and phase must align (<5° error). Out-of-sync closure induces destructive torque pulse.',
  },
  [ROUTES.FRANCIS.SOP.DISTRIBUTOR_SYNC]: {
    ...
    logCategory: 'ELEC',
    slogan:
      'Load Sharing: Droop control divides grid demand between units. Reactive power balance prevents circulating currents.',
  },
  [ROUTES.FRANCIS.SOP.DC_SYSTEMS]: {
    ...
    logCategory: 'ELEC',
    slogan:
      'Backup Power: 110V DC batteries supply control circuits and emergency lighting. Capacity: 8-hour autonomy at full load.',
  },
  [ROUTES.FRANCIS.SOP.EXCITATION]: {
    ...
    logCategory: 'ELEC',
    slogan:
      'Field Control: AVR regulates rotor current maintaining terminal voltage. Fast response (<100ms) suppresses voltage dips.',
  },
  [ROUTES.FRANCIS.SOP.TRANSFORMER]: {
    ...
    logCategory: 'ELEC',
    slogan:
      'Voltage Transformation: Electromagnetic induction steps 11kV to 110kV. Oil temperature >85°C indicates overload or cooling fault.',
  },
};
