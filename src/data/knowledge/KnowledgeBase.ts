...
export const KNOWLEDGE_BASE: KnowledgeNode[] = [
  ...
  // ========================================================
  {
    ...
    triggers: [{ routeMatcher: 'sop-penstock' }],
    insights: [
    ...
    resources: [
      {
        id: 'doc_60123',
        title: 'ASME B31.1: Pressure Piping Code',
        type: 'PDF',
        url: '/docs/asme-b31.pdf',
      },
      {
        id: 'hist_p1',
        title: '2019: Internal coating renewal',
        type: 'LOG',
        url: '/logs/view/2019-p1',
      },
    ],
  },
  {
    ...
    triggers: [{ routeMatcher: 'sop-intake' }],
    insights: [
    ...
    resources: [
      {
        id: 'sop_cleaning',
        title: 'Rack Cleaning Schedule',
        type: 'LINK',
        url: '/francis/sop-intake',
      },
    ],
  },
  ...
  // ========================================================
  {
    ...
    triggers: [{ routeMatcher: 'sop-bearings' }],
    insights: [
  ...
  },
  {
    ...
    resources: [
      {
        id: 'sop_lube',
        title: 'Lubrication System Troubleshooting',
        type: 'LINK',
        url: '/francis/sop-lubrication',
      },
    ],
  },
  {
    ...
    triggers: [{ routeMatcher: 'sop-shaft-alignment' }, { routeMatcher: 'sop-coupling' }],
    insights: [
    ...
    resources: [
      {
        id: 'alignment_protocol',
        title: 'Laser Alignment Procedure',
        type: 'PDF',
        url: '/docs/alignment.pdf',
      },
    ],
  },
  ...
  },
  {
    ...
    triggers: [{ routeMatcher: 'sop-oil-health' }],
    insights: [
    ...
    resources: [
      {
        id: 'oil_analysis',
        title: 'Latest Lab Report (Dec 2025)',
        type: 'PDF',
        url: '/docs/oil-report-2025-12.pdf',
      },
    ],
  },
  {
    ...
    tags: ['fluid', 'thermal'],
    triggers: [{ routeMatcher: 'sop-cooling-water' }],
    insights: [
    ...
    resources: [
      {
        id: 'cooling_schematic',
        title: 'Cooling System P&ID',
        type: 'PDF',
        url: '/docs/cooling-pid.pdf',
      },
    ],
  },
  ...
  // ========================================================
  {
    ...
    triggers: [{ routeMatcher: 'sop-generator' }],
    insights: [
  ...
  },
  {
    ...
    tags: ['electrical', 'critical'],
    triggers: [{ routeMatcher: 'sop-transformer' }],
    insights: [
    ...
    resources: [
      {
        id: 'transformer_manual',
        title: 'ABB Transformer Manual',
        type: 'PDF',
        url: '/docs/abb-transformer.pdf',
      },
      {
        id: 'dga_guide',
        title: 'DGA Interpretation Guide',
        type: 'PDF',
        url: '/docs/dga-guide.pdf',
      },
    ],
  },
  {
    ...
    resources: [
      {
        id: 'transformer_cooling',
        title: 'Cooling System Diagnostics',
        type: 'LINK',
        url: '/francis/sop-transformer',
      },
    ],
  },
  {
    ...
    triggers: [{ routeMatcher: 'sop-excitation' }],
    insights: [
  ...
  },
  {
    ...
    triggers: [{ routeMatcher: 'sop-governor-pid' }],
    insights: [
    ...
    resources: [
      {
        id: 'governor_manual',
        title: 'Woodward Governor Manual',
        type: 'PDF',
        url: '/docs/woodward-gov.pdf',
      },
    ],
  },
  {
    ...
    tags: ['electrical', 'safety'],
    triggers: [{ routeMatcher: 'sop-grid-sync' }],
    insights: [
    ...
    resources: [
      {
        id: 'sync_procedure',
        title: 'Synchronization Procedure',
        type: 'PDF',
        url: '/docs/sync-procedure.pdf',
      },
    ],
  },
  ...
  // ========================================================
  {
    ...
    triggers: [
      {
        sensorId: 'francis.sensors.draft_tube_pressure',
        threshold: { max: -0.7, condition: 'LT' },
      },
    ],
    insights: [
    ...
    resources: [
      {
        id: 'cavitation_guide',
        title: 'Cavitation Damage Atlas',
        type: 'PDF',
        url: '/docs/cavitation-atlas.pdf',
      },
    ],
  },
  {
    ...
    tags: ['mechanical', 'safety'],
    triggers: [{ sensorId: 'francis.sensors.vibration', threshold: { min: 3.5, condition: 'GT' } }],
    insights: [
    ...
    resources: [
      {
        id: 'vibration_standard',
        title: 'ISO 10816-5: Vibration Limits',
        type: 'PDF',
        url: '/docs/iso-10816.pdf',
      },
    ],
  },
];
