  ...
  VIBRATION_CRITICAL: [
    {
      ...
      description:
        'Restriktivan rad: Zabraniti rad u zoni kavitacije (65-75% opterećenja). Provjeriti vijke spojnice.',
  ...
  BEARING_TEMP_CRITICAL: [
    {
      ...
      description:
        'Increase cooling water flow by 15% via bypass valve. Check lubrication oil level.',
