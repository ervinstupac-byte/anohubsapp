...
const SandboxPage: React.FC = () => {
  ...
  const DEMOS = [
    {
      id: 'chaos',
      label: 'Chaos Gauntlet',
      path: '/chaos',
      icon: <Shield className="w-4 h-4" />,
      desc: 'Stress test system resilience',
    },
    {
      id: 'vibration',
      label: 'Vibration Audit',
      path: '/forensics/audio',
      icon: <Activity className="w-4 h-4" />,
      desc: 'Frequency spectrum analysis',
    },
    {
      id: 'francis',
      label: 'Francis Hub',
      ...
      desc: '3D Digital Twin Interaction',
    },
    {
      id: 'turbine',
    ...
    },
    {
      ...
      desc: 'System Internals',
    },
    {
      id: 'alignment',
      label: 'Alignment Wizard',
    ...
    <div className="min-h-screen bg-slate-950 text-white p-8 font-mono">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {DEMOS.map(demo => (
          <div
            key={demo.id}
            className="p-6 bg-slate-900 border border-slate-800 rounded-xl hover:border-emerald-500/50 transition-all group"
          >
            ...
            <ModernButton variant="primary" onClick={() => navigate(demo.path)} className="w-full">
              LAUNCH MODULE
            </ModernButton>
          </div>
        ))}
