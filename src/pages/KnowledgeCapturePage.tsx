...
const KnowledgeCapturePage: React.FC = () => {
  return (
    <div className="flex flex-col min-h-screen bg-[#020617] text-slate-100">
      <DashboardHeader
        title={
          <span className="text-purple-400 font-black tracking-widest uppercase">
            KNOWLEDGE BANK // CAPTURE
          </span>
        }
        onToggleSidebar={() => {}}
      />
        ...
        <div className="mb-6 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-slate-400 max-w-2xl">
              Digitize engineering wisdom. Document incident patterns, root causes, and field
              solutions to train the Sovereign AI model.
            </p>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-slate-900/50 border border-slate-800 rounded-lg">
              ...
              <div className="text-sm text-slate-400 italic">
                No recent captures in current session.
              </div>
            </div>
          </div>
        </div>
