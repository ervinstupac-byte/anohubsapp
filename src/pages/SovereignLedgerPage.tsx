...
const SovereignLedgerPage: React.FC = () => {
  return (
    <div className="flex flex-col min-h-screen bg-[#020617] text-slate-100">
      <DashboardHeader
        title={
          <span className="text-amber-500 font-black tracking-widest uppercase">
        ...
        <div className="mb-6 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-slate-400 max-w-2xl">
              Immutable record of all system overrides, Commander interactions, and autonomous
              setpoint adjustments.
              <span className="text-amber-500/80 ml-2 font-mono text-xs border border-amber-500/30 px-2 py-0.5 rounded">
                READ ONLY
              </span>
            </p>
          </div>
