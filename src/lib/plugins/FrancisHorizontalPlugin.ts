  ...
  diagnostics: {
    patterns: [
      ...COMMON_HYDRO_PATTERNS,
      {
        ...
        physicsNarrative:
          'Flow turbulence detected: Differential pressure in Draft Tube suggests vortex rope formation, transferring destructive energy to the Runner linkage.',
        conditions: [
          { variableId: 'vibration', operator: 'TREND_MATCH', targetTrend: 'RISING', weight: 0.35 },
          {
            variableId: 'draftTubePressure',
            operator: 'VARIANCE_MATCH',
            threshold: 1.0,
            weight: 0.35,
          },
        ...
        actions: [
          {
            type: 'FOCUS_3D',
            label: 'Inspect Draft Tube',
            targetId: 'Mesh_DraftTube_Liner',
            icon: 'Box',
          },
          {
            type: 'OPEN_SOP',
            label: 'Drainage Protocol',
            targetId: 'Francis_SOP_Drainage_Pumps',
            icon: 'FileText',
          },
        ],
      },
      {
        ...
        physicsNarrative: (probability: number) =>
          `Anomaly detected: Kinetic energy at the Runner is disippating as friction-induced Heat in Bearing #2. Efficiency loss projected at ${(probability * 3.5).toFixed(1)}%.`,
        conditions: [
          {
            variableId: 'bearingTemp',
            operator: 'DYNAMIC_THRESHOLD',
            baselineId: 'bearingTemp_Loaded',
            sigmaMultiplier: 2.5,
            weight: 0.4,
          },
        ...
        actions: [
          {
            type: 'FOCUS_3D',
            label: 'Focus Guide Bearing',
            targetId: 'Mesh_GuideBearing_Pad3',
            icon: 'Box',
          },
          {
            type: 'OPEN_SOP',
            label: 'Active Cooling Reset',
            targetId: 'Francis_SOP_Cooling',
            icon: 'FileText',
          },
        ],
      },
      {
        ...
        physicsNarrative:
          'Differential thermal expansion detected (ΔT > 5°C). Asymmetric friction suggests shaft centerline deviation, risking coupling fatigue and seal degradation.',
        conditions: [
          {
            variableId: 'bearingTemp',
            operator: 'DELTA_GREATER',
            compareVariableId: 'generatorTemp',
            threshold: 5.0,
            weight: 0.6,
          },
        ...
        actions: [
          {
            type: 'FOCUS_3D',
            label: 'Inspect Coupling',
            targetId: 'Mesh_Shaft_Coupling',
            icon: 'Box',
          },
          {
            type: 'OPEN_SOP',
            label: 'Alignment Protocol',
            targetId: 'Francis_SOP_Alignment',
            icon: 'FileText',
          },
        ],
      },
      {
        ...
        physicsNarrative: (probability: number) =>
          `Low-Load Vortex Rope detected. Operation at ${(probability * 20).toPrecision(2)}% guide vane opening is creating a hollow core vortex in the draft tube, inducing structural vibration.`,
        conditions: [
        ...
        actions: [
          {
            type: 'FOCUS_3D',
            label: 'Inspect Draft Tube',
            targetId: 'Mesh_DraftTube_Flow',
            icon: 'Box',
          },
          {
            type: 'OPEN_SOP',
            label: 'Vortex Control Protocol',
            targetId: 'Francis_SOP_Vortex_Control',
            icon: 'FileText',
          },
        ],
      },
      {
        ...
        physicsNarrative:
          'Excessive axial pressure detected. Risk of thrust bearing wiping and structural deformation of the turbine cover.',
        conditions: [
    ...
    passport_sections: [
      {
        ...
        fields: [
          ...
          {
            id: 'axialPlay',
            label: 'passport.fields.axialPlay',
            type: 'number',
            unit: 'mm',
            step: '0.05',
          },
          {
            id: 'bearingScraping',
            label: 'passport.fields.bearingScraping',
            type: 'number',
            unit: '%',
            step: '1',
          },
      ...
      },
      {
        ...
        fields: [
          {
            id: 'statorInsulation',
            label: 'passport.fields.statorInsulation',
            type: 'number',
            unit: 'MOhm',
            step: '10',
          },
          {
            id: 'windingResistance',
            label: 'passport.fields.windingResistance',
            type: 'number',
            unit: 'Ohm',
            step: '0.001',
          },
      ...
      },
      {
        ...
        fields: [
          {
            id: 'sealLeakageRate',
            label: 'passport.fields.sealLeakageRate',
            type: 'number',
            unit: 'l/min',
            step: '0.1',
          },
      ...
      },
      {
        ...
        fields: [
          {
            id: 'sealLeakageRate',
            label: 'francis:passport.auxiliary.sealLeakageRate',
            type: 'number',
            unit: 'ml/min',
          },
          {
            id: 'oilViscosity',
            label: 'francis:passport.auxiliary.oilViscosity',
            type: 'number',
            unit: 'cSt',
          },
          {
            id: 'oilAge',
            label: 'francis:passport.auxiliary.oilAge',
            type: 'number',
            unit: 'Hours',
          },
          {
            id: 'acousticObservation',
            label: 'francis:passport.auxiliary.acousticObservation',
            type: 'select',
            options: [
      ...
      },
      {
        ...
        fields: [
          ...
          {
            id: 'labyrinthFront',
            label: 'francis:passport.pressure.labyrinthFront',
            type: 'number',
          },
      ...
      },
      {
        ...
        fields: [
          {
            id: 'mivOpeningTime',
            label: 'francis:passport.kinematics.mivOpening',
            type: 'number',
            unit: 's',
          },
          {
            id: 'mivClosingTime',
            label: 'francis:passport.kinematics.mivClosing',
            type: 'number',
            unit: 's',
          },
          {
            id: 'distributorCylinderStrokeTime',
            label: 'francis:passport.kinematics.distributorStroke',
            type: 'number',
            unit: 's',
          },
        ],
      },
      {
        ...
        fields: [
          {
            id: 'lastOilChange',
            label: 'francis:passport.maintenance.lastOilChange',
            type: 'date',
          },
          {
            id: 'lastAlignmentCheck',
            label: 'francis:passport.maintenance.lastAlignmentCheck',
            type: 'date',
          },
          {
            id: 'lastRelayTest',
            label: 'francis:passport.maintenance.lastRelayTest',
            type: 'date',
          },
        ],
      },
