...
export class FrancisBigBrotherEngine extends BaseTurbineEngine {
  ...
  getAllWhispers(telemetry: ExtendedTelemetryStream): {
    ...
    return {
      ...
      auxiliary: {
        ...
        coolingDeltaT:
          telemetry.auxiliary.coolingWaterOutletTemp - telemetry.auxiliary.coolingWaterInletTemp,
      },
    };
  }
  ...
  getSpecializedMetrics(
    telemetry: TelemetryStream | ExtendedTelemetryStream
   ...
   */
  private isExtendedTelemetry(
    telemetry: TelemetryStream | ExtendedTelemetryStream
  ): telemetry is ExtendedTelemetryStream {
