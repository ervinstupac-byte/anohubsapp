    ...
    reports: [
      {
        id: 'R-24-11',
        date: '2024-11-15',
        title: 'Q4 Technical Audit',
        summary: 'Bolt fatigue detected in Unit 2. Recommendation: Replace Grade 4.6 bolts.',
        downloadUrl: '#',
      },
      {
        id: 'R-24-06',
        date: '2024-06-20',
        title: 'Mid-Year Inspection',
        summary: 'All systems nominal. Efficiency optimized via new Hill Chart.',
        downloadUrl: '#',
      },
    ],
    timeline: [
    ...
    reports: [
      {
        ...
        summary: 'Successful grid sync. Vibrations within Zone A.',
        downloadUrl: '#',
      },
    ],
    timeline: [
...
export const ClientProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  return (
    <ClientContext.Provider
      value={{ activeClient, loginClient, logout, clients: SIMULATED_CLIENTS }}
    >
      {children}
    </ClientContext.Provider>
  );
