...
const ContextAwareSystemContext = createContext<ContextAwareSystemContextType | undefined>(
  undefined
);
...
export const ContextAwareSystemProvider: React.FC<{ children: React.ReactNode }> = ({
  children,
}) => {
...
export function useComponentVisibility(
  componentName: keyof MorphingConfig['showComponents']
): boolean {
