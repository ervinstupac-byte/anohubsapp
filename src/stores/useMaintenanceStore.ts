    ...
    (set, get) => {
      ...
      return {
        ...
        updateChecklistItem: (itemId: string, value: any) => {
          ...
          const template = ServiceChecklistEngine.getTemplateForTurbine(
            state.activeChecklist.turbineType
          );
        ...
        updateWorkOrder: async (
          ...
          if (updates.assignedTechnician)
            dbUpdates.assigned_technician = updates.assignedTechnician;
