...
export const useAuditStore = create<AuditStore>((set, get) => ({
    ...
    logAction: async (action: string, target: string, status: 'SUCCESS' | 'FAILURE' = 'SUCCESS', details?: any) => {
        ...
        if (isSupabaseConfigured) {
            ...
            try {
                ...
                console.debug(`[AuditStore] Remote log suppressed (${err.message || 'Unknown'}). Using local storage.`);
                try {
