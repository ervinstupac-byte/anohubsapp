  ...
  static generateRecommendations(state: TechnicalProjectState): Recommendation[] {
    ...
    if (eff < 88 && eff > 0) {
      recommendations.push({
        ...
        description:
          'Turbine efficiency has dropped below 88%. Adjust guide vanes to restore optimal flow angle.',
        priority: 'MEDIUM',
    ...
    if (cavNoise > 20) {
      recommendations.push({
        ...
        description:
          'High frequency acoustic noise detected. Close MIV by 5% or increase tailwater level to suppress cavitation bubbles.',
        priority: 'HIGH',
        actionType: 'SAFETY',
    ...
    if (vib > 4.5) {
      ...
      recommendations.push({
        ...
        description:
          'Vibration levels exceed ISO 10816 limits. Schedule immediate bearing inspection.',
        priority: 'HIGH',
        actionType: 'SAFETY',
      ...
      recommendations.push({
        ...
        description:
          'Vibration rising above baseline. Verify shaft alignment and check for thermal growth.',
        priority: 'MEDIUM',
    ...
    if (bearingTemp > 65) {
      recommendations.push({
        ...
        description:
          'Bearing temperature high. Verify cooling water flow rate and heat exchanger efficiency.',
        priority: 'MEDIUM',
        actionType: 'MAINTENANCE',
