...
// NC-9.0 Compliant Hotspot Definitions with Ground-Truth Engineering Data
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-3">
                            <p className="text-[10px] text-cyan-400 font-bold uppercase tracking-tighter opacity-70">
                                NC-9.0 {t('common.technicalAnalysis', 'Technical Analysis')} // 8 PRECISION HOTSPOTS
                            </p>
                            {/* Live RPM Indicator */}
                            {liveRpm > 0 && (
                ...
                >
                    ...
                    <div className="absolute bottom-4 left-4 flex flex-col gap-1">
                        ...
                        <div className="text-[10px] text-cyan-500/40 font-bold uppercase tracking-tighter">
                            NC-9.0 COMPLIANT // 8 HOTSPOTS: 5 CORE + 3 FOUNDATION
                        </div>
                    </div>
                ...
                <div className="flex items-center gap-8 animate-marquee whitespace-nowrap">
                    {[1, 2, 3].map(i => (
                        <span key={i} className="text-[8px] font-bold text-cyan-500/40 uppercase tracking-[0.2em]">
                            ASSET: GENO_FR_H_MANJE_OD_5 // NC-9.0 COMPLIANT // 8 HOTSPOTS: DE BEARING | NDE BEARING | GROUNDING BRUSH | LUBRICATION | STATOR | ANCHOR BOLTS | JACKING BOLTS | SHIMS // ALIGNMENT TRIO ACTIVE
                        </span>
                    ))}
                </div>
            </div>
