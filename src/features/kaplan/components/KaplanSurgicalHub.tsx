...
import KaplanSurgicalTwin from './KaplanSurgicalTwin';
...
const KAPLAN_ASSETS = [
    { id: 'generator', label: 'Generator', detail: 'Main AC Generator' },
    { id: 'spiral-casing', label: 'Spiral Casing', detail: 'Water Intake Casing' },
    { id: 'guide-vanes', label: 'Guide Vanes', detail: 'Wicket Gates' },
    { id: 'runner', label: 'Kaplan Runner', detail: 'Adjustable Blades Hub' },
    { id: 'draft-tube', label: 'Draft Tube', detail: 'Water Discharge' },
];

export const KaplanSurgicalHub: React.FC = () => {
    ...
    const currentAssets = KAPLAN_ASSETS;
            ...
            <header className="px-6 py-4 border-b border-cyan-900/40 flex items-center justify-between bg-black/20 backdrop-blur-md z-50">
                <div className="flex items-center gap-6 font-mono tracking-tighter uppercase">
                    <div className="flex flex-col">
                        ...
                        <span className="text-white text-lg leading-none">Kaplan Hub</span>
                    </div>
                    <div className="h-8 w-[1px] bg-cyan-900/50 mx-2" />
                    <div className="flex flex-col opacity-60">
                        <span className="text-[10px]">Current Schema</span>
                        <span className="text-sm">Kaplan Vertical Configuration</span>
                    </div>
                </div>
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-2 no-scrollbar">
                        {currentAssets.map(asset => {
                            ...
                            return (
                                ...
                                >
                                    {isActive && (
                                        <motion.div layoutId="activeSurgicalLineKaplan" className="absolute left-0 top-0 bottom-0 w-1 bg-cyan-400" />
                                    )}
...
export default KaplanSurgicalHub;
