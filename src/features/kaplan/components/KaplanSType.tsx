...
export const KaplanSType: React.FC = () => {
  const backgroundImage = '/assets/pic.s_Background/main dash.jpg';

  const [bladeCount, setBladeCount] = useState<number>(4);
  const [driveType, setDriveType] = useState<'DIRECT' | 'GEARBOX'>('GEARBOX');
  ...
  return (
    <div className="relative min-h-[calc(100vh-64px)] overflow-hidden flex flex-col p-6 md:p-12 w-full">
      ...
      <div 
        ...
        style={{ backgroundImage: `url('${backgroundImage}')`, filter: 'hue-rotate(-15deg)' }} 
      />
      ...
      >
        <h2 className="text-3xl md:text-4xl font-black mb-10 text-white tracking-widest uppercase text-center shadow-black drop-shadow-md">
          Kaplan — <span className="text-cyan-400">S-Type</span> 
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center p-4 bg-slate-900/60 hover:bg-slate-800/80 transition-colors rounded-xl border border-white/5 shadow-lg">
                ...
                <span className="font-black text-white text-lg">3.5 <span className="text-cyan-500 text-sm">MW</span></span>
              </div>
              <div className="flex justify-between items-center p-4 bg-slate-900/60 hover:bg-slate-800/80 transition-colors rounded-xl border border-white/5 shadow-lg">
                <span className="text-slate-400 font-mono text-xs uppercase tracking-wider">Rated Net Head</span>
                <span className="font-black text-white text-lg">12.0 <span className="text-cyan-500 text-sm">m</span></span>
              </div>
              <div className="flex justify-between items-center p-4 bg-slate-900/60 hover:bg-slate-800/80 transition-colors rounded-xl border border-white/5 shadow-lg">
                <span className="text-slate-400 font-mono text-xs uppercase tracking-wider">Rated Flow Rate</span>
                <span className="font-black text-white text-lg">35.0 <span className="text-cyan-500 text-sm">m³/s</span></span>
              </div>
              <div className="flex justify-between items-center p-4 bg-slate-900/60 hover:bg-slate-800/80 transition-colors rounded-xl border border-white/5 shadow-lg">
                <span className="text-slate-400 font-mono text-xs uppercase tracking-wider">Nominal Speed</span>
                <span className="font-black text-white text-lg">{driveType === 'DIRECT' ? '200' : '750'} <span className="text-cyan-500 text-sm">rpm</span></span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-slate-900/60 p-5 rounded-xl border border-white/5 shadow-lg hover:border-cyan-500/50 transition-all group">
                ...
                <div className="font-black text-white text-xl group-hover:text-cyan-400 transition-colors">12,500 <span className="text-sm text-slate-500">kg</span></div>
              </div>
              <div className="bg-slate-900/60 p-5 rounded-xl border border-white/5 shadow-lg hover:border-cyan-500/50 transition-all group">
              ...
              <div className="bg-slate-900/60 p-5 rounded-xl border border-white/5 shadow-lg hover:border-cyan-500/50 transition-all group">
                <div className="text-cyan-500 font-mono text-[10px] uppercase mb-1">S-Shaped Draft Tube</div>
                <div className="font-black text-white text-xl group-hover:text-cyan-400 transition-colors">15,000 <span className="text-sm text-slate-500">kg</span></div>
              </div>
              <div className="bg-slate-900/60 p-5 rounded-xl border border-white/5 shadow-lg hover:border-cyan-500/50 transition-all group">
                <div className="text-cyan-500 font-mono text-[10px] uppercase mb-1">Generator Shaft</div>
                <div className="font-black text-white text-xl group-hover:text-cyan-400 transition-colors">4,200 <span className="text-sm text-slate-500">kg</span></div>
              </div>
            </div>
          </div>
        </div>
