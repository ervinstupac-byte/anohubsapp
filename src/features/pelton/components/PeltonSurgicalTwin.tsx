...
const VERTICAL_MARKERS: Marker[] = [
    { id: 'injector-1', x: 20, y: 30, label: 'Injector 1' },
    { id: 'injector-2', x: 80, y: 30, label: 'Injector 2' },
    { id: 'generator', x: 50, y: 50, label: 'Generator' },
    { id: 'housing', x: 50, y: 80, label: 'Housing' },
];

const HORIZONTAL_MARKERS: Marker[] = [
    { id: 'injector-main', x: 30, y: 50, label: 'Main Injector' },
    { id: 'runner', x: 70, y: 50, label: 'Runner Assembly' },
    { id: 'generator', x: 50, y: 70, label: 'Generator' },
];

/**
 * PeltonSurgicalTwin - Image-based interactive twin for Pelton
 */
const PeltonSurgicalTwin: React.FC<Props> = ({ viewMode, activeAssetId, xrayEnabled, setXrayEnabled, onMarkerClick }) => {
...
export default PeltonSurgicalTwin;
