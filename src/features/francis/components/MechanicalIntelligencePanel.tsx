...
const intelligenceData: Record<FrancisComponentId, ComponentIntelligence> = {
  generator: {
    ...
    description:
      'Synchronous unit that converts 428.6 RPM mechanical torque into 142.5 MW of electrical power.',
    limits: [
  ...
  miv: {
    ...
    description:
      'Double-seal spherical valve designed to isolate the turbine from the penstock during maintenance or emergency.',
    limits: [
  ...
  spiral_case: {
    ...
    description:
      'High-pressure casing that distributes water uniformly around the guide vanes to ensure balanced runner loading.',
    limits: [
  ...
  runner: {
    ...
    description:
      'The "Heart" of the turbine. X-shape Francis design utilizing both reaction and impulse forces.',
    limits: [
  ...
  shaft_seal: {
    ...
    description:
      'Multi-stage radial packing system maintaining a precise water film to prevent high-pressure leakage into the machine hall.',
    limits: [
  ...
  hpu: {
    ...
    description:
      'Hydraulic Power Unit generating the force required to modulate guide vanes and relief valves via high-pressure oil.',
    limits: [
  ...
  draft_tube: {
    ...
    description:
      'Diffuser section that converts residual kinetic energy of water leaving the runner back into static pressure.',
    limits: [
  ...
  'insp-de-bearing': {
    role: 'Radial Support',
    description:
      'Primary guide bearing maintaining rotor concentricity at the Drive End. Oil-lubricated pivoted pad design.',
    limits: [
  ...
  'insp-nde-bearing': {
    ...
    description:
      'Bottom combination bearing supporting total rotor weight (Thrust) and radial loads.',
    limits: [
  ...
  'insp-stator': {
    ...
    description:
      'Stationary armature winding where voltage is induced by the rotating magnetic field.',
    limits: [
  ...
  'insp-lube-oil': {
    ...
    description:
      'High-pressure oil circulation system for bearing film maintenance and heat removal.',
    limits: [
    ...
    return (
      <div className="h-full flex flex-col items-center justify-center text-slate-500 opacity-50 p-6 text-center border border-dashed border-white/10 rounded-xl m-4">
        ...
        <p className="text-[10px] font-mono">
          Select a component from the blueprint to view telemetry.
        </p>
      </div>
    );
  }
      ...
      <div className="space-y-6 overflow-y-auto pr-2 custom-scrollbar">
        ...
        <section>
          ...
          <div className="p-4 bg-white/5 rounded-xl border border-white/5">
            <p className="text-xs text-white font-bold mb-2 uppercase tracking-tight text-cyan-500">
              {info.role}
            </p>
        ...
        <section>
          ...
          <div className="space-y-2">
            {info.limits.map((limit, idx) => (
              <div
                key={idx}
                className="flex items-center justify-between p-3 bg-slate-950/40 rounded-lg border border-white/5"
              >
