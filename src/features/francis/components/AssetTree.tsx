...
const assets: AssetNode[] = [
  {
    id: 'generator',
    surgicalId: 'group-generator',
    label: 'Generator',
    icon: <Zap className="w-4 h-4" />,
  },
  {
    id: 'miv',
    surgicalId: 'group-miv',
    label: 'Main Inlet Valve',
    icon: <ShieldCheck className="w-4 h-4" />,
  },
  {
    id: 'spiral_case',
    surgicalId: 'group-spiral-case',
    label: 'Spiral Case',
    icon: <Droplets className="w-4 h-4" />,
  },
  {
    id: 'runner',
    surgicalId: 'group-runner',
    label: 'Francis Runner',
    icon: <Disc className="w-4 h-4" />,
  },
  {
    id: 'shaft_seal',
    surgicalId: 'group-seal',
    label: 'Shaft Seal',
    icon: <Activity className="w-4 h-4" />,
  },
  {
    id: 'hpu',
    surgicalId: 'group-hpu',
    label: 'HPU System',
...
export const AssetTree: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-2 p-4 bg-slate-900/40 backdrop-blur-md border-r border-white/5 h-full overflow-y-auto">
      <h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-cyan-500/50 mb-4 px-2">
        Surgical Index
      </h3>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3">
                <div
                  className={`w-1.5 h-1.5 rounded-full ${isActive ? 'bg-cyan-400' : 'bg-slate-600 group-hover:bg-slate-400'}`}
                />
