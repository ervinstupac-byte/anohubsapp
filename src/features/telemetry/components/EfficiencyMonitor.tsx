...
export const EfficiencyMonitor: React.FC<EfficiencyMonitorProps> = ({ className = '' }) => {
  ...
  return (
    <div
      className={`p-4 border border-white/5 rounded-xl bg-slate-900/40 backdrop-blur-sm ${className}`}
    >
      <div className="flex items-center justify-between mb-4">
        ...
        <div
          className={`px-2 py-1 rounded-full text-[8px] font-mono font-bold border ${statusColors[efficiencyMetrics.status]}`}
        >
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <span className="text-[10px] font-mono text-white">
              {efficiencyMetrics.delta.toFixed(1)}%
            </span>
