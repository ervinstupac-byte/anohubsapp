...
const MasterSovereignDashboard = lazy(() =>
  import('./components/dashboard/MasterSovereignDashboard').then(m => ({
    default: m.MasterSovereignDashboard,
  }))
);
...
const UserProfile = lazy(() =>
  import('./components/UserProfile.tsx').then(m => ({ default: m.UserProfile }))
);
const GlobalMap = lazy(() =>
  import('./components/GlobalMap.tsx').then(m => ({ default: m.GlobalMap }))
);
const RiskAssessment = lazy(() =>
  import('./components/RiskAssessment.tsx').then(m => ({ default: m.RiskAssessment }))
);
const InvestorBriefing = lazy(() =>
  import('./components/InvestorBriefing.tsx').then(m => ({ default: m.InvestorBriefing }))
);
const TurbineDetail = lazy(() =>
  import('./components/TurbineDetail.tsx').then(m => ({ default: m.TurbineDetail }))
);
const QuestionnaireSummary = lazy(() =>
  import('./components/QuestionnaireSummary.tsx').then(m => ({ default: m.QuestionnaireSummary }))
);
const RiskReport = lazy(() =>
  import('./components/RiskReport.tsx').then(m => ({ default: m.RiskReport }))
);
const StandardOfExcellence = lazy(() =>
  import('./components/StandardOfExcellence.tsx').then(m => ({ default: m.StandardOfExcellence }))
);
const DigitalIntroduction = lazy(() =>
  import('./components/DigitalIntroduction.tsx').then(m => ({ default: m.DigitalIntroduction }))
);
const HPPImprovements = lazy(() =>
  import('./components/HPPImprovements.tsx').then(m => ({ default: m.HPPImprovements }))
);
const InstallationGuarantee = lazy(() =>
  import('./components/InstallationGuarantee.tsx').then(m => ({ default: m.InstallationGuarantee }))
);
const GenderEquity = lazy(() =>
  import('./components/GenderEquity.tsx').then(m => ({ default: m.GenderEquity }))
);
const HPPBuilder = lazy(() =>
  import('./components/HPPBuilder.tsx').then(m => ({ default: m.HPPBuilder }))
);
const RiverWildlife = lazy(() =>
  import('./components/RiverWildlife.tsx').then(m => ({ default: m.RiverWildlife }))
);
const RevitalizationStrategy = lazy(() =>
  import('./components/RevitalizationStrategy.tsx').then(m => ({
    default: m.RevitalizationStrategy,
  }))
);
const DigitalIntegrity = lazy(() =>
  import('./components/DigitalIntegrity.tsx').then(m => ({ default: m.DigitalIntegrity }))
);
const ContractManagement = lazy(() =>
  import('./components/ContractManagement.tsx').then(m => ({ default: m.ContractManagement }))
);
const ComponentLibrary = lazy(() =>
  import('./components/ComponentLibrary.tsx').then(m => ({ default: m.ComponentLibrary }))
);
const InfrastructureHub = lazy(() =>
  import('./components/infrastructure/InfrastructureHub.tsx').then(m => ({
    default: m.InfrastructureHub,
  }))
);
const ExecutiveDashboard = lazy(() =>
  import('./components/dashboard/ExecutiveDashboard.tsx').then(m => ({
    default: m.ExecutiveDashboard,
  }))
);
const ExecutiveFinancialDashboard = lazy(() =>
  import('./components/ExecutiveFinancialDashboard.tsx').then(m => ({
    default: m.ExecutiveFinancialDashboard,
  }))
);
const StructuralIntegrity = lazy(() =>
  import('./components/StructuralIntegrity.tsx').then(m => ({ default: m.StructuralIntegrity }))
);

const AdminApproval = lazy(() =>
  import('./components/AdminApproval.tsx').then(m => ({ default: m.AdminApproval }))
);
const AdminHealth = lazy(() => import('./pages/AdminHealth').then(m => ({ default: m.default })));
const AIConstitution = lazy(() =>
  import('./components/docs/AIConstitution.tsx').then(m => ({ default: m.AIConstitution }))
);
...
const ScadaCore = lazy(() =>
  import('./components/dashboard/ScadaCore').then(m => ({ default: m.ScadaCore }))
); // NC-21100
const SystemAuditLog = lazy(() =>
  import('./components/ui/SystemAuditLog').then(m => ({ default: m.SystemAuditLog }))
);
const ForensicDashboard = lazy(() =>
  import('./components/forensics/ForensicDashboard').then(m => ({ default: m.ForensicDashboard }))
);
const ForensicDeepDive = lazy(() =>
  import('./components/forensics/ForensicDeepDive').then(m => ({ default: m.ForensicDeepDive }))
); // NC-21100

const ForensicHub = lazy(() => import('./pages/ForensicHub').then(m => ({ default: m.default })));
const SandboxPage = lazy(() => import('./pages/SandboxPage'));
const ToolboxLaunchpad = lazy(() =>
  import('./components/ToolboxLaunchpad.tsx').then(m => ({ default: m.ToolboxLaunchpad }))
);
const SpecializedDiagnostics = lazy(() =>
  import('./components/SpecializedDiagnostics.tsx').then(m => ({
    default: m.SpecializedDiagnostics,
  }))
);
const LearningLab = lazy(() =>
  import('./components/diagnostic-twin/LearningLab.tsx').then(m => ({ default: m.LearningLab }))
);
const PrecisionAudit = lazy(() =>
  import('./components/PrecisionAudit.tsx').then(m => ({ default: m.PrecisionAudit }))
);
const FrancisHub = React.lazy(() =>
  import('./features/francis/components/FrancisHub').then(module => ({
    default: module.FrancisHub,
  }))
);
const SOPViewer = React.lazy(() =>
  import('./components/francis/SOPViewer').then(module => ({ default: module.SOPViewer }))
);
const LegacySOPViewer = React.lazy(() =>
  import('./components/francis/LegacySOPViewer').then(module => ({
    default: module.LegacySOPViewer,
  }))
); // NC-21000
const AlignmentWizardWrapper = React.lazy(() =>
  import('./components/maintenance/AlignmentWizardWrapper').then(module => ({
    default: module.AlignmentWizardWrapper,
  }))
); // NC-21000
...
const EngineerLanding = React.lazy(() =>
  import('./pages/EngineerLanding').then(m => ({ default: m.EngineerLanding }))
);
const OwnerLanding = React.lazy(() =>
  import('./pages/OwnerLanding').then(m => ({ default: m.OwnerLanding }))
);
const HydroschoolLanding = React.lazy(() =>
  import('./pages/HydroschoolLanding').then(m => ({ default: m.HydroschoolLanding }))
);

// Unified Navigation States
const MapModule = lazy(() =>
  import('./components/MapModule.tsx').then(m => ({ default: m.MapModule }))
);
const AssetTypeSelector = lazy(() =>
  import('./components/navigation/AssetTypeSelector').then(m => ({ default: m.AssetTypeSelector }))
);
      ...
      <div className="p-6">
        <svg viewBox="0 0 1200 600" className="w-full h-[520px]">
          ...
          <rect
            ...
            strokeWidth="2"
          />
          <text x="80" y="110" fill="#888888" fontSize="14" fontFamily="monospace">
            Penstock
          </text>
          <circle cx="600" cy="150" r="55" fill="none" stroke="#444444" strokeWidth="4" />
          <text x="560" y="240" fill="#888888" fontSize="12" fontFamily="monospace">
            Runner
          </text>
          <rect
            x="840"
          ...
          <rect
            ...
            strokeWidth="2"
          />
          <text x="80" y="350" fill="#94a3b8" fontSize="12" fontFamily="monospace">
            Flow • NO DATA
          </text>
          <text x="80" y="400" fill="#94a3b8" fontSize="12" fontFamily="monospace">
            Static Head • NO DATA
          </text>
          <text x="540" y="300" fill="#ef4444" fontSize="16" fontFamily="monospace">
            SCADA MODULE RECOVERED • NO DATA
          </text>
        </svg>
      </div>
    </div>
...
const QuestionnaireWrapper = () => {
  return (
    <RiskAssessment onShowSummary={() => (window.location.hash = '#/questionnaire-summary')} />
  );
};
...
const AppLayout: React.FC = () => {
  ...
  useEffect(() => {
    try {
      ...
      try {
        useProjectConfigStore.getState().integrityCheck();
      } catch {}
  ...
  return (
    <NavigationProvider value={navValue}>
      <DrillDownProvider>
        ...
        <div
          className={`field-mode h-screen w-screen bg-[#05070a] text-slate-100 overflow-hidden selection:bg-cyan-500/30 font-sans relative grid ${isSidebarOpen ? 'grid-cols-[320px_1fr]' : 'grid-cols-[0px_1fr]'} transition-[grid-template-columns] duration-300 bg-[#020617] ${isCriticalDemo ? 'shadow-[inset_0_0_100px_rgba(239,68,68,0.2)]' : ''}`}
        >
            ...
            <div className={`flex-grow w-full relative z-10 ${isFullPage ? 'flex flex-col' : ''}`}>
              <Suspense fallback={<LoadingShimmer />}>
                <div
                  className={
                    !isFullPage
                      ? 'max-w-7xl mx-auto px-4 md:px-8 py-8 md:py-12'
                      : 'flex-grow w-full'
                  }
                >
                  {!isHub &&
                    location.pathname !== '/dashboard' &&
                    location.pathname !== '/executive' && <Breadcrumbs />}
                  <ErrorBoundary
                    fallback={
                  ...
                  >
                    <div className="w-full">
                      <Routes location={location}>
                        ...
                        <Route
                          path="standard-of-excellence"
                          element={<StandardOfExcellence onCommit={() => {}} />}
                        />
                        ...
                        <Route
                          path="revitalization-strategy"
                          element={<RevitalizationStrategy />}
                        />
                        ...
                        />
                        <Route
                          path="maintenance/alignment"
                          element={
                            <Suspense fallback={<LoadingScreen />}>
                              <AlignmentWizardWrapper />
                            </Suspense>
                          }
                        />
                        <Route
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const shouldReset =
      window.location.href.includes('reset=true') || urlParams.get('clean') === 'true';
        ...
        fallback={
          <div className="h-screen w-screen flex flex-col items-center justify-center bg-black text-white p-8">
            ...
            <p className="text-slate-400 mb-8 max-w-lg text-center">
              The Neural Core encountered an unrecoverable error during initialization.
            </p>
            <button
