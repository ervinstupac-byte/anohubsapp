    ...
    <div className="animate-fade-in pb-12 max-w-4xl mx-auto space-y-8">
      ...
      <div className="text-center space-y-2 mb-8">
        <h2 className="text-4xl font-black text-white tracking-tighter">
          {t('profile.title', 'Engineer Profile').split(' ')[0]}{' '}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">
            {t('profile.title', 'Engineer Profile').split(' ')[1]}
          </span>
        </h2>
        <p className="text-slate-400 font-medium">
          {t('profile.subtitle', 'Manage your identity and access levels.')}
        </p>
      </div>
      ...
      <GlassCard className="p-0 overflow-hidden border-t-4 border-t-cyan-500">
        <div className="p-8 md:p-10">
          <div className="flex flex-col md:flex-row gap-10 items-start">
            ...
            <div className="flex flex-col items-center gap-6 w-full md:w-1/3 border-b md:border-b-0 md:border-r border-white/5 pb-8 md:pb-0 md:pr-8">
              ...
              <div className="text-center w-full">
                <p className="text-xs text-slate-500 font-mono mb-2 truncate max-w-[200px] mx-auto bg-slate-950/50 py-1 px-2 rounded">
                  {user?.email}
                </p>
                <span
                  className={`inline-block px-4 py-1.5 text-xs font-bold rounded-full border ${role ? 'bg-cyan-950/30 text-cyan-400 border-cyan-500/20' : 'bg-slate-800 text-slate-500 border-slate-700'}`}
                >
          ...
          <div className="mt-8 p-6 border-t border-white/5 bg-slate-950/30">
            ...
            <p className="text-xs text-slate-500 mb-4">{t('profile.resetDataDesc')}</p>
            <button
              onClick={() => {
