...
const NeuralFlowMap = lazy(() =>
  import('./diagnostic-twin/NeuralFlowMap.tsx').then(m => ({ default: m.NeuralFlowMap }))
);
const IncidentSimulator = lazy(() =>
  import('./IncidentSimulator.tsx').then(m => ({ default: m.IncidentSimulator }))
);
        ...
        <div className="absolute top-0 left-0 w-full z-[150] animate-pulse bg-red-600/20 border-b border-red-500/50 backdrop-blur-xl p-4 flex flex-col items-center">
          <div className="flex items-center gap-4 mb-3">
            ...
            <h2 className="text-xl font-black text-white uppercase tracking-tighter">
              CRITICAL RISK DETECTED: {criticalDiagnosis.diagnosis?.diagnosis}
            </h2>
          </div>
          <div className="flex gap-4">
            {[
              ...
              <div
                key={i}
                className="px-4 py-2 bg-black/60 border border-red-500/30 rounded-lg text-[10px] font-bold text-red-400 uppercase"
              >
                {step}
              </div>
            ))}
          ...
          fallback={
            <div className="w-full h-full flex items-center justify-center bg-slate-950">
              <div className="flex flex-col items-center gap-4">
                ...
                <p className="text-cyan-500 font-mono text-[10px] uppercase tracking-widest animate-pulse">
