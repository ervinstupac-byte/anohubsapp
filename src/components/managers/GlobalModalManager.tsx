...
const PrintPreviewModal = React.lazy(() =>
  import('../modals/PrintPreviewModal').then(m => ({ default: m.PrintPreviewModal }))
);
  ...
  return (
    <>
      ...
      <Suspense fallback={<div />}>
        <PrintPreviewModal isOpen={isPreviewOpen} onClose={() => setIsPreviewOpen(false)} />
      </Suspense>
      ...
      <AssetOnboardingWizard isOpen={isWizardOpen} onClose={() => setIsWizardOpen(false)} />
        ...
        <div className="fixed inset-0 z-[120] flex items-center justify-center pointer-events-none">
          ...
          <div className="relative z-10 p-6 bg-white/6 border border-white/10 rounded-lg text-center max-w-lg">
            ...
            <p className="text-sm text-slate-300 mb-3">
              Replaying historical events to restore the requested snapshot. This may take a few
              seconds.
            </p>
