...
export const DigitalIntroduction: React.FC = () => {
    ...
    const handleSign = () => {
        setSigned(true);
        showToast('Immunity Protocol Activated. Welcome to the Command Center.', 'success');
        setTimeout(() => {
            navigateTo('hub');
        }, 1500);
    };
    ...
    return (
        <div className="animate-fade-in space-y-16 pb-16 max-w-5xl mx-auto font-sans">
            {!signed && <div className="absolute top-6 left-6 z-50"><BackButton text="Abort Sequence" /></div>}
            ...
            <div className="text-center space-y-8 pt-20 relative">
                ...
                <div className="relative inline-block">
                    <span className="text-xs font-mono text-cyan-400 tracking-[0.3em] uppercase mb-2 block animate-pulse">Vision Log v1.0</span>
                    <h1 className="text-6xl md:text-8xl font-black text-white tracking-tighter drop-shadow-2xl uppercase leading-[0.9]">
                        Architects of <br/>
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600">Immunity</span>
                    </h1>
                </div>
                
                <p className="text-slate-300 text-xl md:text-2xl max-w-4xl mx-auto leading-relaxed font-light">
                    We don't just inspect power plants. We solve the fundamental equation of <strong className="text-white">Dynamic Risk</strong> versus <strong className="text-white">Operational Certainty</strong>.
                </p>
            </div>
                ...
                <GlassCard className="relative border-l-4 border-l-cyan-500 bg-gradient-to-r from-slate-900 to-slate-900/50 italic">
                    ...
                    <div className="relative z-10 space-y-4 p-4">
                        <p className="text-slate-400 text-lg leading-relaxed">
                            "For years, I watched the industry accept a <span className="text-red-400 font-bold">48% failure rate</span> as 'unavoidable wear and tear'. 
                            I realized standard maintenance wasn't enough. We needed a forensic approach. 
                            We needed to treat a hydropower plant not like a static building, but like a <span className="text-cyan-300 font-bold">living organism with an immune system</span>."
                        </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <GlassCard className="group hover:-translate-y-2 transition-transform duration-500 border-t-4 border-t-purple-500">
                    ...
                    <h3 className="text-xl font-black text-white mb-3 uppercase tracking-tight">Forensic Truth</h3>
                    ...
                    <div className="text-[10px] font-mono text-purple-400 uppercase">Input: Sub-Surface NDT</div>
                </GlassCard>
                ...
                <GlassCard className="group hover:-translate-y-2 transition-transform duration-500 border-t-4 border-t-emerald-500">
                    ...
                    <h3 className="text-xl font-black text-white mb-3 uppercase tracking-tight">Dirty Hands. Clean Data.</h3>
                    <p className="text-sm text-slate-400 leading-relaxed mb-4">
                        We don't just generate reports. We turn wrenches, machine steel, and weld cavitation. From the banal basics to advanced forensics.
                    </p>
                    <div className="text-[10px] font-mono text-emerald-400 uppercase">Scope: End-to-End Execution</div>
                </GlassCard>
                ...
                <GlassCard className="group hover:-translate-y-2 transition-transform duration-500 border-t-4 border-t-red-500 bg-red-950/10">
                    ...
                    <h3 className="text-xl font-black text-white mb-3 uppercase tracking-tight">The Cultural Betrayal</h3>
                    <p className="text-sm text-slate-400 leading-relaxed mb-4">
                        Why the Low-Bid Policy is an act of <strong className="text-red-400">corporate violence</strong> against assets. We stand for the Zero-Tolerance Protocol.
                    </p>
                    <div className="text-[10px] font-mono text-red-400 uppercase">Enemy: The Execution Gap</div>
                </GlassCard>
            ...
            <div className="py-8 border-y border-white/5 bg-black/20 backdrop-blur-sm">
                <p className="text-center text-xs font-bold text-slate-500 uppercase tracking-[0.3em] mb-6">Mastery Across Architectures</p>
                <div className="flex flex-wrap justify-center gap-8 md:gap-16 opacity-70">
                    <div className="text-center group cursor-default">
                        <div className="text-3xl mb-2 grayscale group-hover:grayscale-0 transition-all">🌀</div>
                        <div className="text-sm font-bold text-white">FRANCIS</div>
                        <div className="text-[9px] text-slate-500 uppercase">The Pressure Beast</div>
                    </div>
                    <div className="text-center group cursor-default">
                        <div className="text-3xl mb-2 grayscale group-hover:grayscale-0 transition-all">⚙️</div>
                        <div className="text-sm font-bold text-white">KAPLAN</div>
                        <div className="text-[9px] text-slate-500 uppercase">The Flow Master</div>
                    </div>
                    <div className="text-center group cursor-default">
                        <div className="text-3xl mb-2 grayscale group-hover:grayscale-0 transition-all">💧</div>
                        <div className="text-sm font-bold text-white">PELTON</div>
                        <div className="text-[9px] text-slate-500 uppercase">The Kinetic King</div>
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-col items-center gap-6 pt-8">
                {signed ? (
                    <div className="animate-scale-in text-center p-8 bg-cyan-950/30 border border-cyan-500/50 rounded-3xl backdrop-blur-xl shadow-[0_0_50px_rgba(6,182,212,0.2)]">
                        ...
                        <h3 className="text-2xl font-black text-white uppercase tracking-tight">System Unlocked</h3>
                        <p className="text-cyan-400 font-mono mt-2 text-sm">Loading Command Center...</p>
                    </div>
                ) : (
                    <>
                        <div className="text-center space-y-2">
                            <p className="text-slate-400 text-sm font-light">You've Seen The Vision. Now See The Logic.</p>
                            <p className="text-xs text-slate-600 font-mono">ACCESS PROTOCOL: ENGINEERING IMMUNITY</p>
                        </div>
