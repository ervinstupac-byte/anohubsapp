    ...
    <div className="bg-slate-900 border border-slate-700 rounded-lg overflow-hidden">
      ...
      <div className="p-6 space-y-6">
        ...
        <div>
          ...
          <div
            className={`flex items-center gap-2 px-4 py-3 rounded border ${severityColors[finding.severity]}`}
          >
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span className="text-white font-bold">
                  {finding.expertName} ({finding.expertLicense})
                </span>
              </div>
              <div className="flex justify-between">
            ...
            {finding.expertComments && (
              <div className="mt-4 bg-emerald-950/20 border border-emerald-500/30 rounded p-4">
                ...
                {finding.expertCommentsDE && (
                  <p className="text-emerald-200/70 text-xs mt-2 italic">
                    {finding.expertCommentsDE}
                  </p>
                )}
              </div>
