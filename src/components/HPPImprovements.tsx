        ...
        <div className="animate-fade-in max-w-7xl mx-auto pb-12 space-y-8">
            ...
            <div className="text-center space-y-4 pt-6">
                ...
                <div>
                    <h2 className="text-4xl md:text-5xl font-black text-white tracking-tighter mb-4">
                        HPP <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">Ino-Hub</span>
                    </h2>
                    <p className="text-slate-400 text-lg font-light">
                        Collaborative Engineering Intelligence. Capture breakthrough ideas.
                    </p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-4">
                    <GlassCard 
                        title="Log New Concept" 
                        subtitle={`Contributor: ${user?.email?.split('@')[0] || 'GUEST'}`}
                    ...
                    >
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div>
                                <label className="block text-xs font-bold text-slate-400 uppercase mb-2 ml-1">Discipline</label>
                            ...
                            <div>
                                <label className="block text-xs font-bold text-slate-400 uppercase mb-2 ml-1">Technical Description</label>
                                <textarea 
                                    rows={5} 
                                    value={description} 
                    ...
                    <div className="space-y-4 max-h-[800px] overflow-y-auto custom-scrollbar pr-2">
                        {loading && (
                            <div className="text-center p-12">
                                ...
                                <p className="text-slate-500 font-mono animate-pulse">Syncing Innovation Database...</p>
                            </div>
                        )}
                        ...
                        {!loading && filteredIdeas.length === 0 && (
                            <div className="text-center p-16 border-2 border-dashed border-slate-800 rounded-3xl opacity-50">
                                ...
                                <p className="text-slate-400">No ideas found in this category.</p>
                                <p className="text-slate-600 text-sm mt-2">Be the first to innovate!</p>
                            </div>
                        )}
