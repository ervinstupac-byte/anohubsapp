          ...
          {actionPlan.length > 0 ? (
                ...
                <div className="space-y-2 pt-2 border-t border-white/5">
                  {sop.steps.map(step => (
                    <div key={step.step} className="flex gap-3 text-[10px]">
                      ...
                      <p
                        className={`flex-1 leading-tight ${step.critical ? 'text-white font-bold' : 'text-slate-400'}`}
                      >
                        {step.description}
                        {step.critical && (
                          <span className="ml-2 text-[8px] px-1 bg-red-500 text-white rounded font-black tracking-tighter">
                            CRITICAL
                          </span>
                        )}
                      </p>
            ...
            <div className="py-12 flex flex-col items-center justify-center opacity-40">
              ...
              <p className="text-[10px] font-black uppercase tracking-widest">
                No Active Maintenance Directives
              </p>
              <p className="text-[9px] text-slate-500 mt-1">
                System is operating within nominal thresholds
              </p>
            </div>
          )}
        </AnimatePresence>
