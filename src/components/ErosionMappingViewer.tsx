  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-slate-400">AR Camera - Cavitation Pitting Analysis</p>
      </div>
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <GlassCard
          className={`p-4 ${
            analysis.erosionAcceleration > 30 ? 'border-2 border-red-500 bg-red-950/20' : ''
          }`}
        >
          <p className="text-xs text-slate-400 uppercase font-bold mb-1">Acceleration</p>
          <p
            className={`text-3xl font-black ${analysis.erosionAcceleration > 30 ? 'text-red-400' : 'text-white'}`}
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <GlassCard className="p-6">
          <h3 className="text-sm font-black text-white uppercase mb-4">
            AR Blade Scan - Blade #{blade.bladeId}
          </h3>
        ...
        <div className="space-y-4">
          ...
          <GlassCard
            className={`p-4 border-2 ${
              analysis.recommendedAction === 'STELLITE_WELD'
                ? 'border-red-500 bg-red-950/20'
                : analysis.recommendedAction === 'REGIME_CHANGE'
          ...
          >
            <div className="flex items-center gap-2 mb-3">
              <Wrench
                className={`w-5 h-5 ${
                  analysis.recommendedAction === 'STELLITE_WELD' ? 'text-red-400' : 'text-amber-400'
                }`}
              />
            ...
            {analysis.recommendedRegimeChange && (
              <div className="mt-3 p-3 bg-black/30 rounded">
                ...
                <p className="text-sm text-white">
                  {analysis.recommendedRegimeChange.parameter}:{' '}
                  {analysis.recommendedRegimeChange.currentValue} →{' '}
                  {analysis.recommendedRegimeChange.recommendedValue}
                </p>
