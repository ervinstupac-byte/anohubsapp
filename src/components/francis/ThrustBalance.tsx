                    ...
                    <div className="flex items-center gap-4 text-center md:text-left">
                        ...
                        <div>
                            <div className="flex items-center justify-center md:justify-start gap-2 mb-1">
                                <span className="px-2 py-0.5 rounded-none bg-emerald-950 text-emerald-500 text-[10px] font-black border border-emerald-900/50 uppercase tracking-widest">SOP-MECH-012</span>
                ...
                <div className="bg-red-950/20 border-l-[16px] border-red-600 p-12 rounded-none border border-red-900/20 relative group overflow-hidden shadow-none">
                    ...
                    <div className="flex items-start gap-10 relative z-10">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="px-4 py-1 bg-red-900/40 text-red-500 text-[10px] font-black uppercase tracking-widest rounded-none border border-red-900/50 inline-block italic mb-8">Structural Integrity Warning</div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        <div className="space-y-10">
                            ...
                            <div className="grid grid-cols-1 gap-6">
                                {[1, 2].map(n => (
                                    <div key={n} className="p-8 bg-black/40 rounded-none border border-emerald-500/20 flex gap-8 items-center group/intent hover:bg-emerald-950/5 transition-all">
