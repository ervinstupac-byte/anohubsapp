                    ...
                    <div className="flex items-center gap-4 text-center md:text-left">
                        ...
                        <div>
                            <div className="flex items-center justify-center md:justify-start gap-2 mb-1">
                                <span className="px-2 py-0.5 rounded-none bg-red-950 text-red-500 text-[10px] font-black border border-red-900/50 uppercase tracking-widest">SOP-ELEC-005</span>
                                <NeuralPulse />
                            </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                <div className="flex justify-between items-center p-6 bg-emerald-950/10 border border-emerald-500/20 rounded-none group/psu">
                                    <div className="flex items-center gap-4">
                                        <div className="w-12 h-12 rounded-none bg-emerald-600/20 flex items-center justify-center border border-emerald-500/30 text-emerald-500 font-black">AC1</div>
                                        <span className="text-sm text-white font-black uppercase tracking-tighter">{t('francis.dcSystems.psu1')}</span>
                                    </div>
                                    <span className="text-[10px] font-black px-4 py-1.5 bg-emerald-600 text-white rounded-none uppercase tracking-widest shadow-none">Active Flux</span>
                                </div>
                                <div className="flex justify-between items-center p-6 bg-slate-900 border border-white/5 rounded-none group/psu grayscale opacity-60">
                                    <div className="flex items-center gap-4">
                                        <div className="w-12 h-12 rounded-none bg-slate-800 flex items-center justify-center border border-white/10 text-slate-500 font-black">AC2</div>
                                        <span className="text-sm text-slate-400 font-black uppercase tracking-tighter">{t('francis.dcSystems.psu2')}</span>
                                    </div>
                                    <span className="text-[10px] font-black px-4 py-1.5 bg-slate-800 text-slate-500 rounded-none uppercase tracking-widest">Neural Standby</span>
                                </div>
                            </div>
                        </div>
                    </GlassCard>
                    ...
                    <GlassCard title={t('francis.dcSystems.distFault')} icon={<Activity className="text-amber-500" />}>
                        <div className="p-8 bg-black/40 border border-white/5 rounded-none h-full flex flex-col justify-center">
                            ...
                            <div className="mt-8 flex gap-3">
                                <div className="px-4 py-2 bg-white/5 border border-white/10 rounded-none text-[9px] font-black text-slate-500 uppercase tracking-widest">Galvanic Isolation 100%</div>
                                <div className="px-4 py-2 bg-emerald-950/20 border border-emerald-500/20 rounded-none text-[9px] font-black text-emerald-400 uppercase tracking-widest">Status: CLEAN</div>
                            </div>
                        </div>
                    </GlassCard>
                </div>
