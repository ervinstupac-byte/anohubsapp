                    ...
                    <div className="flex items-center gap-4 text-center md:text-left">
                        ...
                        <div>
                            <div className="flex items-center justify-center md:justify-start gap-2 mb-1">
                                <span className="px-2 py-0.5 rounded-none bg-red-950 text-red-500 text-[10px] font-black border border-red-900/50 uppercase tracking-widest">SOP-MECH-003</span>
                                <NeuralPulse />
                            </div>
                    ...
                    <GlassCard title={t('francis.braking.s2Title')} icon={<Fan className="text-slate-400" />}>
                        <div className="space-y-6">
                            <div className="flex justify-between items-start mb-4 relative z-10">
                                <span className="text-[10px] font-black bg-emerald-900/30 text-emerald-500 px-4 py-1.5 rounded-none border border-emerald-900 uppercase tracking-widest">STATUS: SYSTEM_SYNC</span>
                            </div>
                    ...
                    <GlassCard title={t('francis.braking.s3Title')} icon={<ArrowUpCircle className="text-amber-500" />}>
                        <div className="space-y-8">
                            ...
                            <div className="grid grid-cols-2 gap-4 pt-4">
                                <div className="p-4 bg-emerald-950/10 border border-emerald-500/20 rounded-none text-[10px] font-black text-emerald-500 uppercase tracking-widest text-center">Permissive: Speed 0%</div>
                                <div className="p-4 bg-emerald-950/10 border border-emerald-500/20 rounded-none text-[10px] font-black text-emerald-500 uppercase tracking-widest text-center">Brakes Released</div>
                            </div>
                        </div>
                    </GlassCard>
                </div>
