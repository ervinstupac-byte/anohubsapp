  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans pb-12">
      ...
      <main className="max-w-6xl mx-auto px-4 md:px-8 space-y-8">
        ...
        <GlassCard
          title="Emergency Response & Braking Intelligence"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
            <div className="p-6 bg-black/60 rounded-none border border-white/5">
              ...
              <p className="text-3xl font-black text-white font-mono tracking-tighter">
                {rpmPerc.toFixed(1)}{' '}
                <span className="text-xs text-slate-500 uppercase ml-2">% RPM</span>
              </p>
            </div>
            <div className="p-6 bg-black/60 rounded-none border border-white/5">
              <p className="text-[10px] text-red-500 uppercase font-black mb-2 tracking-[0.2em] flex items-center gap-2">
            ...
            <div className="p-6 bg-black/60 rounded-none border border-white/5">
              ...
              <p
                className={`text-3xl font-black font-mono tracking-tighter uppercase ${canBrake ? 'text-emerald-400' : 'text-red-500 opacity-40'}`}
              >
        ...
        <section className="bg-red-950/10 border-l-[12px] border-red-600 p-8 rounded-none shadow-none backdrop-blur-sm border border-red-900/20 relative group overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-8 relative z-10">
            <div className="flex-grow">
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                <div className="p-8 bg-black/40 rounded-none border border-white/5 transition-all group/opt hover:bg-black/60">
                  ...
                  <div className="text-2xl font-black text-white tracking-tighter italic">
                    &lt; 20%{' '}
                    <span className="text-xs font-bold text-slate-600 lowercase ml-2">
                      ({(428.5 * 0.2).toFixed(0)} RPM)
                    </span>
                  </div>
                </div>
                <div className="p-8 bg-black/40 rounded-none border border-white/5 transition-all group/opt hover:bg-black/60">
              ...
              <div className="p-6 bg-red-600 text-white rounded-none shadow-none flex items-start gap-4">
                <ShieldAlert className="w-10 h-10 flex-shrink-0" />
                <div>
                  <h4 className="text-xs font-black uppercase mb-1 tracking-widest">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <GlassCard title={t('francis.braking.s2Title')} icon={<Fan className="text-slate-400" />}>
            <div className="space-y-6">
              <div className="flex justify-between items-start mb-4 relative z-10">
                <span className="text-[10px] font-black bg-emerald-900/30 text-emerald-500 px-4 py-1.5 rounded-none border border-emerald-900 uppercase tracking-widest">
                  STATUS: SYSTEM_SYNC
                </span>
              </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-4 bg-white/5 rounded-none border border-white/10">
                    ...
                    <span className="text-lg font-black text-white font-mono">
                      120 <span className="text-[10px] opacity-40">Pa</span>
                    </span>
                  </div>
                  <div className="p-4 bg-white/5 rounded-none border border-white/10">
                    <span className="text-[9px] text-slate-500 font-black uppercase tracking-widest block mb-1">
                    ...
                    <span className="text-lg font-black text-white font-mono">
                      +15 <span className="text-[10px] opacity-40">MINS</span>
                    </span>
                  </div>
                </div>
              </div>
              <div className="p-6 bg-black/40 rounded-none border border-white/5 relative group/warn overflow-hidden">
                ...
                <p className="text-[11px] text-slate-400 font-bold leading-relaxed italic relative z-10">
          ...
          {/* Jacking System */}
          <GlassCard
            title={t('francis.braking.s3Title')}
            icon={<ArrowUpCircle className="text-amber-500" />}
          >
            <div className="space-y-8">
              <div className="p-8 bg-amber-950/20 rounded-none border border-amber-900/30 text-center relative group/jack overflow-hidden">
                ...
                <span className="text-[10px] text-amber-500/60 font-black uppercase mb-2 tracking-[0.2em] block relative z-10">
                  {t('francis.braking.oilPress')}
                </span>
                <div className="text-5xl font-black text-white font-mono tracking-tighter relative z-10">
                  0{' '}
                  <span className="text-xl font-normal text-slate-500 uppercase ml-2 tracking-widest italic">
                    BAR
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 pt-4">
                <div className="p-4 bg-emerald-950/10 border border-emerald-500/20 rounded-none text-[10px] font-black text-emerald-500 uppercase tracking-widest text-center">
                  Permissive: Speed 0%
                </div>
                <div className="p-4 bg-emerald-950/10 border border-emerald-500/20 rounded-none text-[10px] font-black text-emerald-500 uppercase tracking-widest text-center">
                  Brakes Released
