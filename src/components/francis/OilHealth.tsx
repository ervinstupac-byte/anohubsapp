                    ...
                    <div className="flex items-center gap-4 text-center md:text-left">
                        ...
                        <div>
                            <div className="flex items-center justify-center md:justify-start gap-2 mb-1">
                                <span className="px-2 py-0.5 rounded-none bg-amber-950 text-amber-500 text-[10px] font-black border border-amber-900/50 uppercase tracking-widest">SOP-OIL-003</span>
                    ...
                    <div className="flex items-start gap-10 relative z-10">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="grid md:grid-cols-3 gap-6">
                                {[1, 2, 3].map((num) => (
                                    <div key={num} className="p-6 bg-black/40 rounded-none border border-red-500/30 group/rule hover:bg-black/60 transition-all flex flex-col justify-between h-full">
                    ...
                    <section className="bg-amber-950/20 border-l-[12px] border-amber-600 p-12 rounded-none border border-amber-900/20 relative group overflow-hidden">
                        ...
                        <div className="space-y-6">
                            {[
                                ...
                                <div key={idx} className="p-8 bg-black/60 rounded-none border border-white/5 hover:border-amber-500/30 transition-all group/cause">
                    ...
                    <section className="bg-red-950/10 border-l-[12px] border-red-600 p-12 rounded-none border border-red-900/20 relative group overflow-hidden">
                        ...
                        <div className="space-y-6">
                            {[
                                ...
                                <div key={idx} className="p-8 bg-black/60 rounded-none border border-white/5 hover:border-red-500/30 transition-all group/cause">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12">
                        <div className="space-y-6">
                            ...
                            <div className="space-y-3">
                                {[1, 2, 3].map(n => (
                                    <div key={n} className="p-6 bg-black/40 rounded-none border border-emerald-500/20 flex gap-6 items-center italic">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                                {[
                                    ...
                                    <div key={i} className="flex flex-col md:flex-row gap-4 p-4 bg-black/40 rounded-none border border-white/5 items-center group/item hover:border-red-500/30 transition-all font-black uppercase text-[10px]">
                                        <div className={`px-4 py-2 rounded-none w-full md:w-32 text-center shadow-none italic ${row.color}`} dangerouslySetInnerHTML={{ __html: t(`francis.oilHealth.${row.k}`) }} />
                        ...
                        <div className="space-y-8">
                            {[
                                ...
                                <div key={step.id} className="flex gap-8 items-start group/step">
                                    <div className="w-14 h-14 rounded-none bg-amber-600 flex items-center justify-center font-black text-white text-xl shadow-none group-hover/step:scale-110 transition-transform">0{step.id}</div>
                                    <div className="flex-1">
                                        ...
                                        {step.sub && (
                                            <div className="grid grid-cols-2 gap-4 mt-6">
                                                {step.sub.map(s => (
                                                    <div key={s} className="p-6 bg-black/60 rounded-none border border-white/5 text-xs text-slate-400 font-bold uppercase tracking-tight bg-gradient-to-br from-amber-500/5 to-transparent italic" dangerouslySetInnerHTML={{ __html: t(`francis.oilHealth.${s}`) }} />
                                                ))}
                                            </div>
                                        )}
                                    </div>
                        ...
                        <div className="p-12 bg-black/40 rounded-none border border-white/5 shadow-none">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
                                {['daily', 'weekly', 'mth', 'quart', 'yr'].map((p) => (
                                    <div key={p} className="p-6 bg-slate-900/60 rounded-none border border-white/5 hover:border-amber-500/30 transition-all flex justify-between items-center group/p">
