                    ...
                    <div className="flex items-center gap-4 text-center md:text-left">
                        ...
                        <div>
                            <div className="flex items-center justify-center md:justify-start gap-2 mb-1">
                                <span className="px-2 py-0.5 rounded-none bg-red-950 text-red-500 text-[10px] font-black border border-red-900/50 uppercase tracking-widest">SOP-LOGIC-003</span>
                    ...
                    <div className="space-y-12 relative mt-8">
                        ...
                        {[1, 2, 3].map((num) => (
                            <div key={num} className="relative pl-16 group/step">
                                <div className={`absolute left-0 top-0 w-12 h-12 rounded-none flex items-center justify-center font-black text-lg transition-all duration-500 shadow-none border-2 z-10 ${num === 3 ? 'bg-slate-950 border-slate-800 text-slate-700 opacity-50' : 'bg-red-600 border-red-400 text-white shadow-none'}`}>
                                    {num}
                                </div>
                                <div className={`p-8 rounded-none border transition-all duration-500 hover:translate-x-2 ${num === 3 ? 'bg-slate-900/40 border-white/5 opacity-50' : 'bg-black/40 border-red-500/20 hover:border-red-500/50 shadow-none'}`}>
                                    <div className="flex justify-between items-start mb-4">
                                        ...
                                        {num < 3 && <span className="text-[9px] font-black px-3 py-1 bg-red-600 text-white rounded-none uppercase tracking-widest shadow-none">Executing</span>}
                                    </div>
                                    ...
                                    {num === 2 && (
                                        <div className="mt-8 flex gap-4">
                                            <div className="px-4 py-2 bg-red-900/20 border border-red-500/30 rounded-none text-[10px] font-black text-red-400 uppercase tracking-widest">{t('francis.loadRejection.step2.p1')} Active</div>
                                            <div className="px-4 py-2 bg-red-900/20 border border-red-500/30 rounded-none text-[10px] font-black text-red-400 uppercase tracking-widest">{t('francis.loadRejection.step2.p2')} Standby</div>
                                        </div>
                                    )}
                                </div>
                            </div>
