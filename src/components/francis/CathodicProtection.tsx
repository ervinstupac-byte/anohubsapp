  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans pb-12">
      ...
      <main className="max-w-6xl mx-auto px-4 md:px-8 space-y-8">
        ...
        <GlassCard
          title="Electrochemical Protection Monitor"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
            <div className="p-6 bg-black/60 rounded-none border border-white/5">
              ...
              <p className="text-3xl font-black text-white font-mono tracking-tighter">
                {sacrificialCurrent.toFixed(2)}{' '}
                <span className="text-xs text-slate-500 uppercase ml-2">Amps</span>
              </p>
            </div>
            <div className="p-6 bg-black/60 rounded-none border border-white/5">
              <p className="text-[10px] text-emerald-500 uppercase font-black mb-2 tracking-[0.2em] flex items-center gap-2">
              ...
              <p
                className={`text-3xl font-black font-mono tracking-tighter ${isOptimal ? 'text-emerald-400' : 'text-amber-500'}`}
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <GlassCard
            title={t('francis.cathodic.s1Title')}
          ...
          >
            <div className="space-y-6">
              ...
              <div className="p-6 bg-black/40 border border-white/5 rounded-none shadow-none group/rule overflow-hidden relative">
                ...
                <span className="text-emerald-500 text-[10px] font-black uppercase block mb-3 tracking-[0.2em] relative z-10">
                  {t('francis.cathodic.h1Rule')}
                </span>
              ...
              <div className="p-6 bg-emerald-950/20 border border-emerald-900/30 rounded-none relative group/spec overflow-hidden">
                ...
                <h4 className="text-white text-[10px] font-black uppercase mb-4 tracking-[0.2em] relative z-10">
                  {t('francis.cathodic.h1Spec')}
                </h4>
                <div className="flex items-center gap-6 p-6 bg-black/60 rounded-none mb-4 relative z-10 border border-white/10">
                  ...
                  <div>
                    <span className="text-[10px] text-emerald-400 font-black block uppercase tracking-widest mb-1">
                      Target Potency
                    </span>
                    <span className="text-3xl font-black text-white font-mono tracking-tighter">
                      {t('francis.cathodic.targetVal')}
                    </span>
                  </div>
                </div>
          ...
          <GlassCard
            title={t('francis.cathodic.s3Title')}
                  ...
                  {[1, 2, 3].map(rowIdx => (
                    ...
                    >
                      ...
                      <td className="p-4 font-bold opacity-70 group-hover:opacity-100 italic">
                        {t(`francis.cathodic.diag${rowIdx}`)}
                      </td>
        ...
        <section className="bg-slate-900/60 p-8 rounded-none border border-white/5 space-y-8 relative overflow-hidden group">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-4">
              <h4 className="text-emerald-400 text-[10px] font-black uppercase tracking-[0.2em]">
                {t('francis.cathodic.steps')}
              </h4>
              {[1, 2, 3].map(num => (
                <div
                  key={num}
                  className="p-5 bg-black/40 rounded-none border border-white/5 flex gap-5 items-center group/step hover:border-emerald-500/30 transition-all"
                >
                  ...
                  <div className="text-[11px] text-slate-300 font-bold uppercase tracking-tight leading-relaxed">
                    {num === 1 ? (
                      <span dangerouslySetInnerHTML={{ __html: t('francis.cathodic.l1') }} />
                    ) : (
                      t(`francis.cathodic.l${num}`)
                    )}
                  </div>
                </div>
              ))}
