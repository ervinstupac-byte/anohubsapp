    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans pb-12">
          ...
          <div className="flex items-center gap-4 text-center md:text-left">
            ...
            <div>
              <div className="flex items-center justify-center md:justify-start gap-2 mb-1">
                <span className="px-2 py-0.5 rounded-none bg-slate-900 text-slate-500 text-[10px] font-black border border-white/5 uppercase tracking-widest">
                  SOP-MECH-002
                </span>
      ...
      <main className="max-w-6xl mx-auto px-4 md:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <GlassCard
            title={t('francis.coupling.s2Title')}
            ...
            <div className="flex items-center gap-12">
              ...
              <div className="flex-1 space-y-4">
                ...
                <div className="flex gap-4">
                  <div className="px-4 py-2 bg-slate-900 rounded-none border border-white/5 text-[10px] font-black text-slate-400">
                    Radial Lim: 0.05mm
                  </div>
                  <div className="px-4 py-2 bg-slate-900 rounded-none border border-white/5 text-[10px] font-black text-slate-400">
                    Status: Nominal
          ...
          <GlassCard
            title={t('francis.coupling.s3Title')}
            icon={<Split className="text-slate-400" />}
          >
            <div className="flex items-center gap-12">
              <div className="w-32 h-32 rounded-none bg-black border-4 border-slate-800 flex items-center justify-center relative overflow-hidden group/viz">
        ...
        <GlassCard
          title={t('francis.coupling.s4Title')}
          ...
          <div className="space-y-8 relative">
            <div className="flex flex-col md:flex-row gap-8">
              {[1, 2, 3].map(num => (
                <div
                  key={num}
                  className="p-8 bg-black/40 rounded-none border border-white/5 hover:border-blue-500/30 transition-all flex-1 group/step"
                >
          ...
          <section className="bg-blue-950/10 border-l-[12px] border-blue-600 p-10 rounded-none border border-blue-900/20 relative group overflow-hidden">
            <div className="flex items-center gap-6 mb-8 relative z-10">
              ...
              <h2 className="text-2xl font-black text-white uppercase tracking-tighter">
                {t('francis.coupling.s5Title')}
              </h2>
            </div>
            <div className="space-y-6 relative z-10">
              <div className="p-8 bg-black/60 rounded-none border border-blue-500/20 shadow-none group/loctite">
                <h4 className="text-blue-400 text-[10px] font-black uppercase mb-2 tracking-[0.2em] italic">
                  {t('francis.coupling.loctite')}
                </h4>
                <p className="text-sm text-slate-200 font-black italic">
                  {t('francis.coupling.loctiteDesc')}
                </p>
              </div>
              <div className="p-8 bg-slate-900/40 rounded-none border border-white/5 group/sympt">
                <h4 className="text-slate-500 text-[10px] font-black uppercase mb-2 tracking-[0.2em] italic">
                  {t('francis.coupling.sympt')}
                </h4>
                <p className="text-sm text-slate-400 font-bold italic">
                  {t('francis.coupling.symptDesc')}
                </p>
              </div>
            </div>
          </section>
