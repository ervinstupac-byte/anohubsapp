        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-center md:text-left">
            ...
            <p className="text-blue-400 font-bold mt-1 uppercase text-xs tracking-widest flex items-center gap-2">
              <NeuralPulse /> {t('francis.auxiliary.subtitle')} // NC-9.0 AI-TUNED
            </p>
          </div>
      ...
      <main className="max-w-6xl mx-auto px-4 md:px-8 space-y-8">
                  ...
                  <li className="flex gap-4">
                    ...
                    <span>
                      <strong className="text-red-100 uppercase tracking-tighter mr-2">
                        {t('francis.auxiliary.danger')}:
                      </strong>{' '}
                      {t('francis.auxiliary.s1Li1')}
                    </span>
                  </li>
                  <li className="flex gap-4">
                    <span className="text-red-600">▸</span>
                    <span>
                      <strong className="text-red-100 uppercase tracking-tighter mr-2">
                        {t('francis.auxiliary.rule')}:
                      </strong>{' '}
                      {t('francis.auxiliary.s1Li2')}
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <section className="bg-slate-900/60 p-8 rounded-none border border-white/5 space-y-6">
            ...
            <div className="space-y-6 pt-4">
              <div>
                <h4 className="text-blue-400 text-[10px] font-black uppercase mb-3 tracking-widest">
          ...
          <section className="bg-slate-900/60 p-8 rounded-none border border-white/5 space-y-6">
            ...
            <div className="space-y-4 pt-4">
              <h4 className="text-purple-400 text-[10px] font-black uppercase mb-3 tracking-widest">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={idx} className="bg-black/40 p-3 rounded-none border border-white/5">
                    <span className="block text-[8px] text-slate-600 font-black uppercase mb-1">
                      {item.label}
                    </span>
        ...
        <div className="bg-black/60 p-8 rounded-none border border-white/5 flex flex-wrap gap-12 items-center justify-center shadow-none">
          {[
            {
              icon: Clock,
              label: t('francis.auxiliary.weekly'),
              desc: t('francis.auxiliary.weeklyDesc'),
              color: 'text-blue-500',
            },
            {
              icon: Activity,
              label: t('francis.auxiliary.monthly'),
              desc: t('francis.auxiliary.monthlyDesc'),
              color: 'text-amber-500',
            },
            {
              icon: Calendar,
              label: t('francis.auxiliary.annually'),
              desc: t('francis.auxiliary.annuallyDesc'),
