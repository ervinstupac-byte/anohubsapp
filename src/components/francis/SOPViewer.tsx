    ...
    <div className="flex flex-col h-screen bg-slate-950 text-slate-200 font-sans overflow-hidden">
      ...
      <header className="bg-black/60 border-b-2 border-stone-800 px-8 py-6 z-50 backdrop-blur-xl flex items-center justify-between shadow-none">
          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              <div className="flex items-center gap-2 mb-0.5">
                <span className="px-2 py-0.5 rounded-none bg-slate-900 border border-white/5 text-[9px] font-black text-slate-500 uppercase tracking-widest italic">
                  Digital Dossier
                </span>
        ...
        <div className="flex items-center gap-8">
          <div className="hidden lg:flex items-center gap-3 px-6 py-2 bg-emerald-950/20 rounded-none border border-emerald-900/40">
            ...
            <span className="text-[10px] font-black text-emerald-400 uppercase tracking-widest italic tracking-tighter">
              Identity Verified
            </span>
          </div>
      ...
      <footer className="bg-black/80 border-t border-white/5 px-8 py-3 flex justify-between items-center relative z-50">
        <div className="flex items-center gap-4 text-[10px] font-black text-slate-500 uppercase tracking-widest italic">
          ...
          <span>
            Neural Link: <span className="text-cyan-500">Active</span>
          </span>
          <span className="opacity-20 mx-2">|</span>
          <span>
            Buffer: <span className="text-emerald-500">100%</span>
          </span>
        </div>
