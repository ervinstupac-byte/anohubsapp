    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans pb-12">
      ...
      <main className="max-w-6xl mx-auto px-4 md:px-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
            <div className="p-6 bg-black/60 rounded-none border border-white/5">
              ...
              <p className="text-3xl font-black text-white font-mono tracking-tighter">
                {frictionFactor.toFixed(2)}{' '}
                <span className="text-xs text-slate-500 uppercase ml-1">μ</span>
              </p>
            </div>
            <div className="p-6 bg-black/60 rounded-none border border-white/5">
              <p className="text-[10px] text-indigo-500 uppercase font-black mb-2 tracking-[0.2em] flex items-center gap-2">
            ...
            <div className="p-6 bg-black/60 rounded-none border border-white/5">
              ...
              <p
                className={`text-3xl font-black font-mono tracking-tighter uppercase ${huntingActive ? 'text-red-500 animate-pulse' : 'text-white'}`}
              >
            ...
            <div className="flex-grow">
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-4">
                <div className="space-y-3 text-[11px] font-bold text-slate-300 leading-relaxed italic border-l-2 border-red-500/30 pl-6">
                  <p>
                    <strong className="text-red-400 uppercase tracking-widest block mb-1">
                      {t('francis.regRing.context')}
                    </strong>{' '}
                    {t('francis.regRing.risk')}
                  </p>
                </div>
                <div className="space-y-3 text-[11px] font-bold text-slate-300 leading-relaxed italic border-l-2 border-red-500/30 pl-6">
                  <p>
                    <strong className="text-red-400 uppercase tracking-widest block mb-1">
                      {t('francis.regRing.rootCause')}
                    </strong>{' '}
                    {t('francis.regRing.impact')}
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <GlassCard
            title={t('francis.regRing.s1Title')}
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-8 mb-4">
              <div className="p-6 bg-amber-950/10 rounded-none border border-amber-600/30 group relative overflow-hidden">
                ...
                <h4 className="text-amber-500 text-[11px] font-black uppercase mb-3 tracking-[0.2em] relative z-10">
                  {t('francis.regRing.s1RiskTitle')}
                </h4>
                <p className="text-[11px] text-slate-300 mb-6 font-bold leading-relaxed relative z-10">
                  {t('francis.regRing.s1RiskText')}
                </p>
              ...
              <div className="space-y-4">
                <h4 className="text-indigo-400 text-[10px] font-black uppercase tracking-[0.2em] border-b border-white/5 pb-2">
                  {t('francis.regRing.s1ProcTitle')}
                </h4>
                <div className="space-y-3">
                  <div className="p-4 bg-white/5 rounded-none border border-white/10 flex gap-4 items-center group/opt">
                    <div className="w-8 h-8 rounded-none bg-indigo-500/20 flex items-center justify-center border border-indigo-500/30 text-indigo-400 font-black text-[10px]">
                      1
                    </div>
                    <span className="text-xs text-slate-300 font-bold opacity-80 group-hover/opt:opacity-100 transition-opacity">
                      {t('francis.regRing.s1Step1')}
                    </span>
                  </div>
                  <div className="p-4 bg-white/5 rounded-none border border-white/10 flex gap-4 items-center group/opt">
                    <div className="w-8 h-8 rounded-none bg-indigo-500/20 flex items-center justify-center border border-indigo-500/30 text-indigo-400 font-black text-[10px]">
          ...
          <GlassCard
            title={t('francis.regRing.s2Title')}
          ...
          >
            ...
            <div className="space-y-6">
              <h4 className="text-white text-[10px] font-black uppercase tracking-[0.2em] border-b border-white/5 pb-2">
                {t('francis.regRing.s2ProcTitle')}
              </h4>
              <div className="grid grid-cols-1 gap-4">
                {[1, 2, 3, 4].map(step => (
                  <div
                    key={step}
                    className="flex gap-4 p-5 bg-white/5 rounded-none border border-white/5 hover:bg-white/10 transition-colors group/step"
                  >
        ...
        <section className="bg-indigo-900/10 border-l-[12px] border-indigo-600 p-8 rounded-none shadow-none backdrop-blur-sm border border-indigo-900/20 relative group overflow-hidden">
          ...
          <div className="flex items-center gap-3 border-b border-white/5 pb-4 mb-8 relative z-10">
            ...
            <h2 className="text-2xl font-black text-white uppercase tracking-tighter">
              {t('francis.regRing.s3Title')}
            </h2>
            <div className="ml-4 px-3 py-1 bg-white/5 border border-white/10 text-indigo-400 text-[10px] font-black rounded-none uppercase tracking-widest">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
            {[1, 2, 3].map(step => (
              <div
                key={step}
                className="p-8 bg-black/60 rounded-none border border-white/10 text-center space-y-4 hover:border-indigo-500/30 transition-all group/card"
              >
