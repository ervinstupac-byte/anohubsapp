                    ...
                    <div className="flex items-center gap-4 text-center md:text-left">
                        ...
                        <div>
                            <div className="flex items-center justify-center md:justify-start gap-2 mb-1">
                                <span className="px-2 py-0.5 rounded-none bg-indigo-950 text-indigo-500 text-[10px] font-black border border-indigo-900/50 uppercase tracking-widest">SOP-DIAG-002</span>
                                <NeuralPulse />
                            </div>
                    ...
                    <div className="flex items-start gap-6 relative z-10">
                        ...
                        <div>
                            <h2 className="text-red-500 font-extrabold text-2xl uppercase tracking-tighter mb-4 flex items-center gap-3">
                                ...
                                <span className="px-3 py-1 bg-red-900 border border-red-800 text-white text-[10px] font-black rounded-none uppercase tracking-widest animate-pulse">Critical Alert</span>
                            </h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <GlassCard title={t('francis.elecHealth.cTitle')} icon={<Sparkles className="text-indigo-400" />}>
                        <div className="space-y-6">
                            {[1, 2].map((i) => (
                                <div key={i} className="p-6 bg-black/40 border border-indigo-500/20 rounded-none hover:bg-indigo-900/10 transition-all group">
                    ...
                    <div className="grid md:grid-cols-4 gap-8">
                        <div className="md:col-span-3 space-y-6">
                            <div className="p-8 bg-amber-950/10 border border-amber-500/20 rounded-none relative">
                                <div className="absolute top-0 right-0 px-4 py-1 bg-amber-600 text-black text-[9px] font-black uppercase rounded-none tracking-widest">Logic Rule</div>
                        ...
                        <div className="space-y-4">
                            {[
                                ...
                                <div key={idx} className="p-4 bg-black/60 rounded-none border border-white/5 flex justify-between items-center group/stat">
                                    ...
                                    <div className={`w-3 h-3 rounded-none ${stat.color} opacity-40 group-hover/stat:opacity-100 transition-opacity ${stat.active ? 'shadow-none' : ''}`} />
                                </div>
                            ))}
                        </div>
                    </div>
