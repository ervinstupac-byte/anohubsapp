...
const AccordionSector: React.FC<AccordionSectorProps> = ({
  ...
  return (
    <div
      className={`rounded-none bg-slate-900/60 border ${borderColor} overflow-hidden transition-all duration-300`}
    >
      <button
        onClick={onToggle}
    ...
    <div className="min-h-screen p-4 md:p-8 bg-[#020617] font-mono text-slate-300">
      ...
      <header className="mb-10 border-b border-slate-800 pb-6">
        <div className="mb-6">
          <button
            onClick={() => navigate('/')}
            className="inline-flex items-center gap-2 text-slate-400 hover:text-cyan-400 transition group"
          >
            <ArrowLeft className="w-4 h-4 group-hover:-translate-x-1 transition" />
            <span className="text-sm font-bold">
              {t('common.back', 'Back to Turbine Selection')}
            </span>
          </button>
        </div>
        ...
        <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-8 bg-gradient-to-r from-slate-900/50 via-slate-800/30 to-slate-900/50 p-6 rounded-none border border-slate-700/50">
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <h1 className="text-4xl font-black text-white tracking-tighter uppercase">
                  {t('francis.title').split('•')[0]}{' '}
                  <span className="text-cyan-400">
                    {t('francis.title').split('•')[1] || 'UNIT 1'}
                  </span>
                </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            >
              ...
              <div className="text-left">
                <div className="text-[9px] text-red-400 font-bold uppercase tracking-wider">
                  {t('francis.actions.missionControl')}
                </div>
                <div className="text-white text-xs font-black tracking-widest">
                  {t('francis.actions.startSequence')}
                </div>
              </div>
            </button>
            ...
            >
              ...
              <div className="text-left">
                <div className="text-[9px] text-orange-400 font-bold uppercase tracking-wider">
                  {t('francis.actions.emergency')}
                </div>
                <div className="text-white text-xs font-black tracking-widest">
                  {t('francis.actions.protocols')}
                </div>
              </div>
            </button>
            ...
            >
              ...
              <div className="text-left">
                <div className="text-[9px] text-green-400 font-bold uppercase tracking-wider">
                  {t('francis.actions.startup')}
                </div>
                <div className="text-white text-xs font-black tracking-widest">
                  {t('francis.actions.flowchart')}
                </div>
              </div>
            </button>
          </div>
              ...
              <div className="flex items-center gap-4">
                <div className="text-right">
                  ...
                  <p className="text-xl font-mono text-white font-bold">
                    50.02 <span className="text-xs text-slate-500">Hz</span>
                  </p>
                </div>
                <div className="h-8 w-px bg-white/10" />
                <div className="text-right">
                  <p className="text-[10px] text-slate-400 uppercase font-bold">Active Power</p>
                  <p className="text-xl font-mono text-[#2dd4bf] font-bold">
                    142.5 <span className="text-xs text-slate-500">MW</span>
                  </p>
                </div>
              </div>
            </GlassCard>
      ...
      <div className="mt-8 flex justify-between items-end border-t border-slate-800 pt-4">
        ...
        <button className="flex items-center gap-2 px-4 py-2 bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white rounded-none border border-slate-600 transition group">
          ...
          <span className="text-xs font-bold uppercase tracking-widest">
            [ {t('francis.actions.generateReport', 'Generate Report')} ]
          </span>
        </button>
      </div>
    </div>
