  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans pb-12">
          ...
          <div className="flex items-center gap-4 text-center md:text-left">
            ...
            <div>
              <div className="flex items-center justify-center md:justify-start gap-2 mb-1">
                <span className="px-2 py-0.5 rounded-none bg-blue-950 text-blue-500 text-[10px] font-black border border-blue-900/50 uppercase tracking-widest">
                  SOP-MECH-006
                </span>
      ...
      <main className="max-w-6xl mx-auto px-4 md:px-8 space-y-12">
        ...
        <div className="bg-blue-900/10 border-l-[12px] border-blue-600 p-10 rounded-none shadow-none backdrop-blur-sm border border-blue-900/20 relative group overflow-hidden">
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  <div className="flex gap-4 p-4 bg-black/40 rounded-none border border-white/5 group/ctx">
                    <div className="text-[10px] text-slate-500 font-black uppercase tracking-widest min-w-[80px]">
                      Context:
                    </div>
                    <p className="text-xs text-slate-300 font-bold">
                      {t('francis.linkage.context').split(':')[1]}
                    </p>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="flex gap-4 p-4 bg-red-950/20 rounded-none border border-red-500/20 group/risk">
                    <div className="text-[10px] text-red-500 font-black uppercase tracking-widest min-w-[80px]">
                      Risk:
                    </div>
                    <p className="text-xs text-red-200 font-bold">
                      {t('francis.linkage.risk').split(':')[1]}
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* SOP 1: Linkage Logic */}
          <GlassCard
            title={t('francis.linkage.s1Title')}
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                {[1, 2].map(step => (
                  <div
                    key={step}
                    className="p-6 bg-black/40 rounded-none border border-white/5 flex gap-6 items-center group/step hover:border-cyan-500/30 transition-all"
                  >
                    <div className="w-12 h-12 rounded-none bg-cyan-600/20 border-2 border-cyan-500 flex items-center justify-center text-cyan-500 font-black shadow-none">
                      0{step}
                    </div>
                    <p className="text-xs text-white font-black uppercase tracking-tight italic">
                      {t(`francis.linkage.s1Step${step}`)}
                    </p>
                  </div>
                ))}
              </div>
              ...
              <div className="grid grid-cols-2 gap-6 mt-8">
                <div className="p-6 bg-emerald-950/20 border border-emerald-500/30 rounded-none group/pass overflow-hidden relative">
                  ...
                  <p className="text-[9px] text-slate-300 font-bold uppercase relative z-10">
                    {t('francis.linkage.s1Pass')}
                  </p>
                </div>
                <div className="p-6 bg-red-950/20 border border-red-500/30 rounded-none group/fail overflow-hidden relative">
          ...
          <div className="space-y-12">
            ...
            <GlassCard
              title={t('francis.linkage.s2Title')}
              icon={<Droplet className="text-yellow-400" />}
            >
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 gap-4">
                  <div className="p-8 bg-yellow-950/10 border-l-[12px] border-yellow-600 rounded-none border border-yellow-900/20 group/audit">
                    <h4 className="text-yellow-500 text-[10px] font-black uppercase mb-2 tracking-widest italic">
                      Industrial Audit Requirement
                    </h4>
                    <p className="text-xs text-slate-200 font-bold uppercase tracking-tight">
                      {t('francis.linkage.s2Audit').split(':')[1]}
                    </p>
                  </div>
                  <div className="p-8 bg-black/40 border border-white/5 rounded-none group/vis">
                    ...
                    <p className="text-xs text-slate-300 font-bold uppercase tracking-tight">
                      {t('francis.linkage.s2Vis').split(':')[1]}
                    </p>
                  </div>
                </div>
              </div>
            ...
            {/* Checklist */}
            <div className="p-10 bg-black/60 rounded-none border border-white/5 shadow-none relative group overflow-hidden">
              ...
              <div className="space-y-4 relative z-10">
                {[1, 2, 3].map(num => (
                  <div
                    key={num}
                    className="flex items-center gap-5 p-4 bg-slate-900/40 rounded-none border border-white/5 group/item hover:border-emerald-500/30 transition-all"
                  >
                    <div className="w-8 h-8 rounded-none bg-emerald-600/10 border border-emerald-500 flex items-center justify-center text-emerald-500 group-hover:bg-emerald-600 group-hover:text-white transition-all">
        ...
        <section className="bg-red-950/10 border-l-[16px] border-red-600 p-12 rounded-none border border-red-900/20 relative group overflow-hidden">
          ...
          <div className="flex items-center gap-8 mb-10 relative z-10">
            ...
            <div>
              <h2 className="text-3xl font-black text-white uppercase tracking-tighter mb-1 italic">
                {t('francis.linkage.s3Title')}
              </h2>
              <div className="px-4 py-1 bg-red-900/30 text-red-500 text-[9px] font-black uppercase tracking-widest rounded-none border border-red-900/50 inline-block">
                High-Risk Dynamic Test
              </div>
            </div>
          </div>

          <div className="p-8 bg-black/60 rounded-none border border-red-500/30 shadow-none mb-12 relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-12 relative z-10">
            <div className="space-y-4">
              <h4 className="text-white text-xs font-black uppercase tracking-widest mb-6 opacity-60">
                Sequence Intelligence
              </h4>
              <div className="p-8 bg-slate-900/60 rounded-none border border-white/5 hover:border-blue-500/30 transition-all group/proc">
                <p className="text-xs text-slate-300 font-bold uppercase tracking-tight leading-relaxed">
                  {t('francis.linkage.s3Proc')}
                </p>
              </div>
            </div>
            <div className="space-y-4">
              ...
              <div className="p-8 bg-slate-900/60 rounded-none border border-white/5 hover:border-emerald-500/30 transition-all group/crit">
                <p className="text-xs text-slate-300 font-bold uppercase tracking-tight leading-relaxed">
                  {t('francis.linkage.s3Crit')}
                </p>
              </div>
            </div>
          </div>
