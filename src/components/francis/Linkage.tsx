                    ...
                    <div className="flex items-center gap-4 text-center md:text-left">
                        ...
                        <div>
                            <div className="flex items-center justify-center md:justify-start gap-2 mb-1">
                                <span className="px-2 py-0.5 rounded-none bg-blue-950 text-blue-500 text-[10px] font-black border border-blue-900/50 uppercase tracking-widest">SOP-MECH-006</span>
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="p-10 bg-black/60 rounded-none border border-white/5 shadow-none relative group overflow-hidden">
                            ...
                            <div className="space-y-4 relative z-10">
                                {[1, 2, 3].map(num => (
                                    <div key={num} className="flex items-center gap-5 p-4 bg-slate-900/40 rounded-none border border-white/5 group/item hover:border-emerald-500/30 transition-all">
                ...
                <section className="bg-red-950/10 border-l-[16px] border-red-600 p-12 rounded-none border border-red-900/20 relative group overflow-hidden">
                    ...
                    <div className="flex items-center gap-8 mb-10 relative z-10">
                        ...
                        <div>
                            ...
                            <div className="px-4 py-1 bg-red-900/30 text-red-500 text-[9px] font-black uppercase tracking-widest rounded-none border border-red-900/50 inline-block">High-Risk Dynamic Test</div>
                        </div>
                    </div>
