      ...
      <main className="max-w-6xl mx-auto px-4 md:px-8">
        <div className="bg-slate-900/40 backdrop-blur-xl border border-amber-500/20 rounded-none p-16 md:p-24 text-center relative overflow-hidden group min-h-[600px] flex flex-col items-center justify-center">
          ...
          <div className="relative z-10 mb-12">
            <div
              data-hotspot-id="seal_package"
              className="w-32 h-32 bg-amber-600 rounded-none shadow-none flex items-center justify-center mb-8 mx-auto relative group-hover:scale-110 transition-transform duration-700"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-4xl relative z-10">
            {[
              ...
              <div
                key={i}
                className="p-8 bg-black/40 rounded-none border border-white/5 flex flex-col items-center hover:border-amber-500/30 transition-all group/stat"
              >
                <stat.icon className="w-8 h-8 text-slate-600 group-hover/stat:text-amber-500 transition-colors mb-4" />
                <div className="text-[10px] text-slate-500 font-black uppercase tracking-widest mb-1 italic">
                  {stat.label}
                </div>
