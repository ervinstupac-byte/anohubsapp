                    ...
                    <div className="flex items-center gap-4 text-center md:text-left">
                        ...
                        <div>
                            <div className="flex items-center justify-center md:justify-start gap-2 mb-1">
                                <span className="px-2 py-0.5 rounded-none bg-indigo-950 text-indigo-500 text-[10px] font-black border border-indigo-900/50 uppercase tracking-widest">SOP-OPS-009</span>
                                <NeuralPulse />
                            </div>
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                <div className="p-6 bg-slate-900/60 border border-white/5 rounded-none hover:border-indigo-500/30 transition-all group/rule">
                                    <div className="flex items-start gap-4">
                                        <div className="w-12 h-12 rounded-none bg-indigo-600 flex items-center justify-center text-white font-black group-hover:scale-110 transition-transform">01</div>
                                        <div>
