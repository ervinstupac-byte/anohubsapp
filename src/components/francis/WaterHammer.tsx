...
export const WaterHammer: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-950 text-slate-200 font-mono pb-12 overflow-x-hidden">
            {/* Header */}
            <header className={`bg-gradient-to-r ${isOverLimit ? 'from-[#991b1b]' : 'from-[#7f1d1d]'} to-[#0c0a09] border-b ${isOverLimit ? 'border-red-500 animate-pulse' : 'border-red-900'} py-8 px-4 md:px-8 mb-8 sticky top-0 z-50 shadow-none transition-all`}>
                <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
                    <div className="flex items-center gap-4">
                        <div className={`p-3 ${isOverLimit ? 'bg-red-500' : 'bg-red-600'} rounded-none border border-red-400/30`}>
                            <ZapOff className="w-8 h-8 text-white" />
                        </div>
                        <div>
                            <div className="flex items-center gap-2 mb-1">
                                <span className={`px-2 py-0.5 rounded-none ${isOverLimit ? 'bg-red-600 text-white' : 'bg-red-900/30 text-red-400'} text-[10px] font-bold border border-red-900 uppercase`}>SOP-W-04</span>
                ...
                <GlassCard title={t('modules.penstock_safety')} className="relative overflow-hidden">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className={`p-6 rounded-none border-2 ${waterHammer.burstSafetyFactor < 1.5 ? 'bg-red-500/10 border-red-500/30' : 'bg-emerald-500/5 border-emerald-500/20 shadow-none'}`}>
