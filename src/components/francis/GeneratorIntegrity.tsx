    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans pb-12">
      ...
      <main className="max-w-6xl mx-auto px-4 md:px-8 space-y-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-8 relative z-10">
            <div className="flex-grow">
              <h2 className="text-red-500 font-extrabold text-2xl uppercase tracking-tighter mb-4 flex items-center gap-3">
                ...
                <span className="px-3 py-1 bg-red-900 border border-red-800 text-white text-[10px] font-black rounded-none uppercase tracking-widest animate-pulse">
              ...
              <div className="p-6 bg-red-600/90 text-white rounded-none shadow-none text-center transform hover:scale-105 transition-transform duration-500">
            ...
            <div className="w-full md:w-64 flex flex-col items-center justify-center p-8 bg-black/60 rounded-none border border-white/5 shadow-none">
              <div className="w-24 h-24 bg-red-500/20 rounded-none flex items-center justify-center border-2 border-red-500/50 mb-4">
                <Activity className="w-12 h-12 text-red-500 animate-pulse" />
              </div>
              <span className="text-[10px] text-slate-500 font-black uppercase tracking-widest">
                Grounding Risk
              </span>
              <span className="text-2xl font-black text-red-500 uppercase tracking-tighter">
                High
              </span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Brush Protocol */}
          <GlassCard
            title={t('francis.generatorIntegrity.brushTitle')}
            icon={<Brush className="text-indigo-400" />}
          >
            <div className="space-y-8">
              <div className="p-6 bg-black/40 rounded-none border border-white/5 group overflow-hidden relative">
                ...
                <div className="w-full bg-slate-800 h-2 rounded-none overflow-hidden mb-4 relative z-10">
              ...
              <div className="p-6 bg-black/40 rounded-none border border-white/5 group overflow-hidden relative">
                ...
                <div className="flex justify-between items-center mb-4 relative z-10">
                  ...
                  <span className="text-xl font-black text-indigo-400 font-mono tracking-tighter">
                    {brushPressure.toFixed(1)} <span className="text-[10px] opacity-60">N/cm²</span>
                  </span>
                </div>
                <div className="w-full bg-slate-800 h-2 rounded-none overflow-hidden mb-4 relative z-10">
                  <div className="w-[60%] bg-emerald-500 h-full shadow-none" />
                </div>
                <p className="text-[10px] text-slate-400 font-bold italic relative z-10 opacity-80 group-hover:opacity-100 transition-opacity">
          ...
          {/* Heater Logic */}
          <GlassCard
            title={t('francis.generatorIntegrity.heatTitle')}
            icon={<ThermometerSun className="text-indigo-400" />}
          >
            <div className="bg-indigo-950/20 p-8 rounded-none border border-indigo-900/30 mb-8 relative group overflow-hidden">
              ...
              <div className="flex items-center gap-6 mb-6 relative z-10">
                <div className="p-4 bg-indigo-600 rounded-none shadow-none group-hover:rotate-12 transition-transform">
                ...
                <div>
                  ...
                  <div className="text-xl font-black text-indigo-400 uppercase tracking-tighter">
                    Auto-Active on Stop
                  </div>
                </div>
              </div>
            ...
            <div className="flex justify-between items-center px-6 py-4 bg-black/40 rounded-none border border-white/5 group hover:border-emerald-500/30 transition-all">
              <span className="text-[10px] text-slate-500 font-black uppercase tracking-[0.2em]">
                Heater Relay Status
              </span>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-none bg-emerald-500 shadow-none animate-pulse"></div>
        ...
        <section className="bg-slate-900/60 p-8 rounded-none border border-white/5 space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[1, 2].map(num => (
              <div
                key={num}
                className="bg-black/40 border border-white/10 p-8 rounded-none relative overflow-hidden group hover:bg-black/60 transition-all border-l-4 border-l-indigo-600 shadow-none"
              >
                <div className="flex justify-between items-start mb-6">
                  <div className="px-4 py-1.5 bg-indigo-950/50 rounded-none border border-indigo-500/30 text-indigo-400 font-black text-[10px] tracking-widest uppercase">
                    {num === 1 ? 'Insulation (Megger)' : 'Terminal Sync'}
                  </div>
                  <span className="px-4 py-1 rounded-none text-[9px] font-black uppercase bg-white/5 text-slate-400 border border-white/10 tracking-widest">
