                    ...
                    <div className="flex items-center gap-4 text-center md:text-left">
                        ...
                        <div>
                            <div className="flex items-center justify-center md:justify-start gap-2 mb-1">
                                <span className="px-2 py-0.5 rounded-none bg-indigo-950 text-indigo-500 text-[10px] font-black border border-indigo-900/50 uppercase tracking-widest">SOP-ELEC-004</span>
                                <NeuralPulse />
                            </div>
            ...
            <main className="max-w-6xl mx-auto px-4 md:px-8 space-y-8">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start gap-8 relative z-10">
                        <div className="flex-grow">
                            <h2 className="text-red-500 font-extrabold text-2xl uppercase tracking-tighter mb-4 flex items-center gap-3">
                                ...
                                <span className="px-3 py-1 bg-red-900 border border-red-800 text-white text-[10px] font-black rounded-none uppercase tracking-widest animate-pulse">{t('francis.generatorIntegrity.critRisk')}</span>
                            </h2>
                ...
                <section className="bg-slate-900/60 p-8 rounded-none border border-white/5 space-y-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        {[1, 2].map((num) => (
                            <div key={num} className="bg-black/40 border border-white/10 p-8 rounded-none relative overflow-hidden group hover:bg-black/60 transition-all border-l-4 border-l-indigo-600 shadow-none">
