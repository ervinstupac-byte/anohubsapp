...
export const BearingsDetail: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-300 font-sans pb-12">
      {/* Header */}
      <header
        className={`bg-black/40 border-b-2 ${isCriticalTemp ? 'border-red-600 animate-pulse' : 'border-amber-500'} py-8 px-4 md:px-8 mb-8 sticky top-0 z-50 backdrop-blur-md shadow-none transition-all`}
      >
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-4 text-center md:text-left">
            <div
              className={`p-3 ${isCriticalTemp ? 'bg-red-600' : 'bg-amber-600'} rounded-none border border-white/10 shadow-none`}
            >
      ...
      <main className="max-w-6xl mx-auto px-4 md:px-8 space-y-8">
        ...
        <GlassCard
          title="Real-Time Thermal Intelligence"
            ...
            <div className="lg:col-span-1 flex flex-col justify-center items-center p-6 bg-black/60 rounded-none border border-white/5 shadow-none">
              <div className="relative w-40 h-40 flex items-center justify-center">
                <svg
                  ...
                  data-hotspot-id="upper_guide_bearing"
                >
                  <circle
                    cx="80"
                    cy="80"
                ...
                <div className="absolute flex flex-col items-center">
                  ...
                  <span className="text-[10px] text-slate-500 uppercase font-black tracking-widest text-[#00aaff]">
                    °Celsius
                  </span>
                </div>
              </div>
            ...
            <div className="lg:col-span-3 space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="p-4 bg-white/5 rounded-none border border-white/10">
                  <p
                    data-hotspot-id="upper_guide_bearing"
                    className="text-[10px] text-slate-500 uppercase font-black mb-2 tracking-widest flex items-center gap-2"
                  >
                ...
                <div className="p-4 bg-white/5 rounded-none border border-white/10">
                  ...
                  <p
                    className={`text-3xl font-black font-mono tracking-tighter ${isCriticalTemp ? 'text-red-500' : 'text-emerald-400'}`}
                  >
                ...
                <div className="p-4 bg-white/5 rounded-none border border-white/10">
                  ...
                  <p className="text-3xl font-black text-white font-mono tracking-tighter">
                    {mechanical.vibration.toFixed(2)}{' '}
              ...
              <div
                className={`p-6 rounded-none border-2 transition-all ${isHighTemp ? 'bg-red-500/10 border-red-500/30 shadow-none' : 'bg-blue-500/10 border-blue-500/30 shadow-none'}`}
              >
                <div className="flex items-center gap-3 mb-3">
                  <div
                    data-hotspot-id="guide_bearing_indicator"
                    className={`w-2 h-2 rounded-none ${isHighTemp ? 'bg-red-500' : 'bg-blue-400'}`}
                  />
                  <span
                    className={`text-[10px] ${isHighTemp ? 'text-red-500' : 'text-blue-400'} font-black uppercase tracking-[0.2em]`}
                  >
        ...
        <section
          className={`bg-slate-900/40 backdrop-blur-sm rounded-none p-8 border-l-[12px] ${isCriticalTemp ? 'border-red-600 animate-pulse' : 'border-red-600'} border border-white/5 shadow-none overflow-hidden relative`}
        >
          ...
          <div className="relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="p-6 bg-black/40 border border-red-500/20 rounded-none group hover:border-red-500/50 transition-colors">
              ...
              <div className="p-6 bg-black/40 border border-amber-500/20 rounded-none group hover:border-amber-500/50 transition-colors">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <section className="bg-slate-900/60 p-8 rounded-none border border-white/5 space-y-8">
            ...
            <div className="space-y-6">
              <div className="p-5 bg-white/5 rounded-none border border-white/10 group hover:bg-white/10 transition-colors">
                ...
                <ul className="text-xs text-slate-400 space-y-3 font-bold">
                  <li className="flex gap-3">
                    <span className="text-amber-500">▶</span> {t('francis.bearingsCheck.s2Li1')}
                  </li>
                  <li className="flex gap-3">
                    <span className="text-amber-500">▶</span> {t('francis.bearingsCheck.s2Li2')}
                  </li>
                </ul>
              </div>
              ...
              <div className="p-5 bg-white/5 rounded-none border border-white/10 group hover:bg-white/10 transition-colors">
                ...
                <ul className="text-xs text-slate-400 space-y-3 font-bold">
                  <li className="flex gap-3">
                    <span className="text-amber-500">▶</span> {t('francis.bearingsCheck.s3Li1')}
                  </li>
                  <li className="flex gap-3">
                    <span className="text-amber-500">▶</span> {t('francis.bearingsCheck.s3Li2')}
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="bg-slate-900/60 p-8 rounded-none border border-white/5 flex flex-col justify-between">
            ...
            <div className="flex-grow space-y-8">
              <div className="flex gap-6 items-center">
                <div className="w-20 h-20 bg-amber-500/10 border-2 border-amber-500/30 rounded-none flex items-center justify-center flex-shrink-0 animate-pulse">
                  <Droplet className="text-amber-500 w-10 h-10" />
                </div>
                <div>
                  <strong className="text-amber-400 text-xs font-black uppercase block mb-1 tracking-widest">
                    {t('francis.bearingsCheck.symptom')}
                  </strong>
                  <p className="text-xs text-slate-300 font-bold leading-relaxed">
                    {t('francis.bearingsCheck.s4Li1')}
                  </p>
                </div>
              </div>

              <div className="p-6 bg-red-600/10 border-2 border-red-500/30 rounded-none shadow-none">
                <div className="flex items-center gap-2 mb-3">
                  <Activity className="w-4 h-4 text-red-500" />
                  <strong className="text-red-500 text-[10px] font-black uppercase tracking-widest">
                    {t('francis.bearingsCheck.action')}
                  </strong>
                </div>
                <p className="text-xs text-slate-200 font-bold italic leading-relaxed">
                  {t('francis.bearingsCheck.s4Li3')}
                </p>
              </div>
            </div>
          </section>
        ...
        <div className="bg-black/60 p-8 rounded-none border border-white/5 flex flex-wrap gap-12 items-center justify-center shadow-none">
          <div className="flex items-center gap-4 border-r border-white/10 pr-12">
            ...
            <div>
              <span className="block text-[8px] text-slate-500 font-black uppercase tracking-tighter">
                {t('francis.bearingsCheck.daily')}
              </span>
              <span className="text-xs text-white font-black uppercase tracking-widest">
                {t('francis.bearingsCheck.dailyDesc')}
              </span>
            </div>
          </div>
          <div className="flex items-center gap-4">
            ...
            <div>
              <span className="block text-[8px] text-slate-500 font-black uppercase tracking-tighter">
                {t('francis.bearingsCheck.weekly')}
              </span>
              <span className="text-xs text-white font-black uppercase tracking-widest">
                {t('francis.bearingsCheck.weeklyDesc')}
              </span>
            </div>
          </div>
        </div>
