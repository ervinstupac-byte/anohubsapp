                    ...
                    <div className="flex items-center gap-4 text-center md:text-left">
                        ...
                        <div>
                            <div className="flex items-center justify-center md:justify-start gap-2 mb-1">
                                <span className="px-2 py-0.5 rounded-none bg-zinc-900 border border-zinc-800 text-zinc-500 text-[10px] font-black uppercase tracking-widest">SOP-MECH-003</span>
                                <NeuralPulse />
                            </div>
                    ...
                    <div className="flex items-start gap-6 relative z-10">
                        ...
                        <div>
                            <h2 className="text-red-500 font-extrabold text-2xl uppercase tracking-tighter mb-4">
                                ...
                                <span className="ml-4 px-3 py-1 bg-red-900 border border-red-800 text-white text-[10px] font-black rounded-none uppercase tracking-widest animate-pulse">Critical Fail-Point</span>
                            </h2>
