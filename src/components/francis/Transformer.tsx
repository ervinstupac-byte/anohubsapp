                    ...
                    <div className="flex items-center gap-4 text-center md:text-left">
                        ...
                        <div>
                            <div className="flex items-center justify-center md:justify-start gap-2 mb-1">
                                <span className="px-2 py-0.5 rounded-none bg-indigo-950 text-indigo-400 text-[10px] font-black border border-indigo-900/50 uppercase tracking-widest">SOP-ELEC-003</span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="lg:col-span-2 space-y-12">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className={`p-10 rounded-none border transition-all duration-700 relative overflow-hidden group/oil ${oilStatus === 'TRIP' ? 'bg-red-950/20 border-red-500 shadow-none' : oilStatus === 'ALARM' ? 'bg-amber-950/20 border-amber-500 shadow-none' : 'bg-slate-900/60 border-white/5 shadow-none'}`}>
                                ...
                                <div className="flex justify-between items-start mb-8 relative z-10">
                                    <div className="flex items-center gap-4">
                                        <div className={`p-4 rounded-none ${oilStatus === 'NORMAL' ? 'bg-white/5' : 'bg-white/10 animate-pulse'}`}>
                                    ...
                                    <div className={`px-4 py-1 rounded-none text-[10px] font-black uppercase tracking-widest italic border ${oilStatus === 'NORMAL' ? 'bg-emerald-950/40 text-emerald-400 border-emerald-900/50' : 'bg-red-600 text-white border-red-400 animate-pulse'}`}>
                                        {oilStatus}
                                    </div>
                                </div>
                            ...
                            <div className={`p-10 rounded-none border transition-all duration-700 relative overflow-hidden group/winding ${windingStatus === 'TRIP' ? 'bg-red-950/20 border-red-500 shadow-none' : windingStatus === 'ALARM' ? 'bg-amber-950/20 border-amber-500 shadow-none' : 'bg-slate-900/60 border-white/5 shadow-none'}`}>
                                <div className="absolute top-0 right-0 p-8 opacity-5 group-hover/winding:opacity-15 transition-opacity duration-700">
                                    <Activity className="w-32 h-32 text-white" />
                                </div>
                                <div className="flex justify-between items-start mb-8 relative z-10">
                                    <div className="flex items-center gap-4">
                                        <div className={`p-4 rounded-none ${windingStatus === 'NORMAL' ? 'bg-white/5' : 'bg-white/10 animate-pulse'}`}>
                                    ...
                                    <div className={`px-4 py-1 rounded-none text-[10px] font-black uppercase tracking-widest italic border ${windingStatus === 'NORMAL' ? 'bg-emerald-950/40 text-emerald-400 border-emerald-900/50' : 'bg-red-600 text-white border-red-400 animate-pulse'}`}>
                                        {windingStatus}
                                    </div>
                                </div>
                                <div className="text-6xl font-black text-white mb-8 italic tracking-tighter relative z-10 tabular-nums">
                        ...
                        <section className="bg-slate-900/60 p-12 rounded-none border border-white/5 h-full flex flex-col justify-between group overflow-hidden relative shadow-none backdrop-blur-md">
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="space-y-6">
                                    <div className={`p-8 rounded-none border transition-all duration-700 group/relay ${buchholzState === 'NORMAL' ? 'bg-black/60 border-emerald-500/30' : 'bg-black/20 border-white/5 opacity-40'}`}>
                                    ...
                                    <div className={`p-8 rounded-none border transition-all duration-700 group/relay ${buchholzState === 'ALARM' ? 'bg-amber-950/30 border-amber-500 shadow-none' : 'bg-black/60 border-white/5 hover:border-amber-500/30'}`}>
                                        <div className="flex justify-between items-center mb-6">
                                            ...
                                            <button onClick={() => triggerBuchholz('ALARM')} className="text-[9px] px-4 py-1 bg-amber-600/20 text-amber-400 border border-amber-500/50 rounded-none hover:bg-amber-600 hover:text-white transition-all font-black uppercase">Probe</button>
                                        </div>
                                    ...
                                    <div className={`p-8 rounded-none border transition-all duration-700 group/relay ${buchholzState === 'TRIP' ? 'bg-red-950/20 border-red-500 shadow-none animate-[pulse_2s_infinite]' : 'bg-black/60 border-white/5 hover:border-red-500/30'}`}>
                                        <div className="flex justify-between items-center mb-6">
                                            ...
                                            <button onClick={() => triggerBuchholz('TRIP')} className="text-[9px] px-4 py-1 bg-red-600/20 text-red-500 border border-red-500/50 rounded-none hover:bg-red-600 hover:text-white transition-all font-black uppercase">Force</button>
                                        </div>
                                        {buchholzState === 'TRIP' && (
