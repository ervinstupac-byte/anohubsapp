    ...
    return (
        <React.Fragment>
            <div className="mb-6 flex justify-between items-center">
                <button onClick={() => navigate('/')} className="inline-flex items-center gap-2 text-slate-400 hover:text-brand-400 transition group">
            ...
            <div className="flex items-center gap-3 mb-3">
                <div className="p-3 bg-brand-900/30 rounded-lg border border-brand-500/30">
                    <Cpu className="text-brand-400 w-8 h-8" />
                </div>
                <div>
                    <h1 className="text-4xl font-black text-white tracking-tighter uppercase">
                        {t('francis.title', 'FRANCIS UNIT • 01').split('•')[0]} <span className="text-brand-400">{t('francis.title', 'FRANCIS UNIT • 01').split('•')[1] || 'UNIT 1'}</span>
                    </h1>
