...
const RiskReport: React.FC = () => {
    ...
    const technicalRisk = Math.min(100, Math.floor(disciplineRiskScore * 1.2));
    const legalRisk = Math.min(100, Math.floor(disciplineRiskScore * 0.9));
    const financialRisk = Math.min(100, Math.floor(disciplineRiskScore * 1.5));
                        ...
                        {disciplineRiskScore > 50 ? (
                            <ul className="space-y-3">
                                <li className="flex items-start gap-3 text-red-200">
                                    ...
                                    <span><strong>Immediate Intervention:</strong> Schedule a 'Zero-Tolerance Audit' to identify specific points of failure in the installation process.</span>
                                </li>
