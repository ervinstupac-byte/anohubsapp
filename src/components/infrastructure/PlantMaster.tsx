          ...
          <GlassCard title="Geospatial Identity" icon={<Globe className="w-5 h-5 text-cyan-400" />}>
            <div className="space-y-4">
              <ModernInput
                ...
                onChange={(e: any) =>
                  setSelectedPlant({ ...selectedPlant, location_name: e.target.value })
                }
              />
              <div className="grid grid-cols-2 gap-4">
                <ModernInput
                  ...
                  onChange={(e: any) =>
                    setSelectedPlant({ ...selectedPlant, gps_lat: parseFloat(e.target.value) })
                  }
                />
                <ModernInput
                  label="Longitude"
                  ...
                  onChange={(e: any) =>
                    setSelectedPlant({ ...selectedPlant, gps_lng: parseFloat(e.target.value) })
                  }
                />
              </div>
              <ModernInput
                ...
                onChange={(e: any) =>
                  setSelectedPlant({ ...selectedPlant, elevation_masl: parseFloat(e.target.value) })
                }
              />
            </div>
          </GlassCard>
          ...
          <GlassCard title="Linked Assets" icon={<MapPin className="w-5 h-5 text-amber-400" />}>
            <div className="grid grid-cols-2 gap-3">
              <div className="p-3 bg-cyan-500/10 border border-cyan-500/20 rounded-lg">
                <p className="text-[9px] text-cyan-400 font-bold uppercase tracking-widest mb-1">
                  Turbines
                </p>
              ...
              <div className="p-3 bg-white/5 border border-white/10 rounded-lg">
                ...
                <div className="flex justify-between items-baseline">
                  <span className="text-xl font-black text-white">
                    12.5 <span className="text-[10px]">MW</span>
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="p-4 bg-white/5 rounded-xl border border-white/10">
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-white font-mono font-bold text-sm">
                  {selectedPlant?.ambient_temp_avg}°C
                </span>
              </div>
              <input
                type="range"
                ...
                onChange={e =>
                  setSelectedPlant({
                    ...selectedPlant,
                    ambient_temp_avg: parseFloat(e.target.value),
                  })
                }
            ...
            <div className="p-4 bg-white/5 rounded-xl border border-white/10">
              ...
              <input
                ...
                onChange={e =>
                  setSelectedPlant({ ...selectedPlant, humidity_avg: parseInt(e.target.value) })
                }
        ...
        <GlassCard title="Energy Forensic" icon={<Zap className="w-5 h-5 text-cyan-400" />}>
          <div className="space-y-4">
            ...
            <p className="text-[10px] text-slate-400 italic leading-relaxed">
              Site efficiency is within nominal range of ±1.2% compared to historical monthly
              average.
            </p>
          </div>
        </GlassCard>
