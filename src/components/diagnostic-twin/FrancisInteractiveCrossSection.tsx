    ...
    <div className="relative w-full aspect-square max-w-[500px] mx-auto group">
      ...
      >
        ...
        <g transform="translate(200,200)">
          ...
          <motion.circle
            ...
            animate={
              isCavitation
                ? { scale: [1, 1.2, 1], opacity: [0.3, 0.7, 0.3] }
                : { scale: 1, opacity: 0.2 }
            }
      ...
      <div className="absolute top-4 left-4 bg-black/40 backdrop-blur-md p-2 rounded border border-white/10">
        <div className="text-[10px] text-slate-500 uppercase font-black tracking-widest">
          {isCavitation ? 'Cavitation Warning' : 'Spiral Case Pressure'}
        </div>
        <div
          className={`text-xl font-mono font-black ${pressure > 100 ? 'text-red-400' : 'text-cyan-400'}`}
        >
