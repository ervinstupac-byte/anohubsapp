      ...
      <svg viewBox="0 0 400 400" className="w-full h-full">
        ...
        >
          ...
          <g transform="translate(10, -10)">
            ...
            />
            <text x="5" y="12" fill="white" fontSize="9" fontWeight="bold">
              {(efficiency * 100).toFixed(1)}% Eff
            </text>
            <text x="5" y="24" fill="#94a3b8" fontSize="8">
              {flow.toFixed(1)} m³/s
            </text>
          </g>
        </motion.g>
        ...
        {/* AXIS LABELS */}
        <text x="5" y="390" fill="rgba(255,255,255,0.4)" fontSize="10" fontStyle="italic">
          FLOW (m³/s)
        </text>
        <text
          x="10"
