  ...
  const principles = [
    {
      ...
      description:
        'All telemetry data is immutable, cryptographically signed, and owned solely by the operator. No external signals may override local safety protocols without cryptographic authorization.',
    },
    {
      id: 2,
      ...
      description:
        "Physical constraints (cavitation limits, thermal thresholds, vibration envelopes) override all economic optimization commands. The machine's integrity is non-negotiable.",
    },
    {
      id: 3,
      ...
      description:
        "Every AI decision must be traceable to a specific set of sensor inputs and logic rules. 'Black box' operations are prohibited in critical control loops.",
    },
    {
      id: 4,
      ...
      description:
        'Critical state transitions (Start/Stop/Trip) require explicit human confirmation or a pre-authorized autonomous mandate with a visible kill-switch.',
    },
  ];
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                <span className="text-[10px] font-mono text-slate-500">HASH: 0x7F...3A9</span>
              </div>
            </div>
          </div>
          <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="col-span-1 md:col-span-2 mb-4 p-6 bg-slate-900/30 border-l-2 border-slate-600">
              ...
              <p className="text-slate-400 font-mono text-sm leading-relaxed">
                We, the architects of the Sovereign Industrial Autonomy, in order to form a more
                perfect union between machine intelligence and human intent, establish this
                Constitution. This document defines the inviolable boundaries of AI agency within
                the Hydro-Electric context.
              </p>
            </div>
            ...
            {principles.map(p => (
              <div
                key={p.id}
                className="p-6 bg-slate-900/20 border border-slate-800 hover:border-slate-700 transition-colors group"
              >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      All logic gates are currently enforcing these parameters.
                    </p>
                  </div>
                </div>
