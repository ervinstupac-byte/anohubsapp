            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
              ...
              <div className="bg-red-950/30 border border-red-500/30 rounded-xl p-4">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="text-red-100 font-bold uppercase text-sm tracking-wider">
                    Safety Protocols
                  </h3>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    <div
                      className={`w-5 h-5 rounded border flex items-center justify-center ${checklist.loto ? 'bg-green-500 border-green-500 text-black' : 'border-slate-500'}`}
                    >
                      {checklist.loto && <CheckCircle2 className="w-3.5 h-3.5" />}
                    </div>
                    <span
                      className={`text-xs font-bold ${checklist.loto ? 'text-green-300' : 'text-slate-300'}`}
                    >
                      LOTO Verified
                    </span>
                  </button>
                  ...
                  >
                    <div
                      className={`w-5 h-5 rounded border flex items-center justify-center ${checklist.ppe ? 'bg-green-500 border-green-500 text-black' : 'border-slate-500'}`}
                    >
                      {checklist.ppe && <CheckCircle2 className="w-3.5 h-3.5" />}
                    </div>
                    <span
                      className={`text-xs font-bold ${checklist.ppe ? 'text-green-300' : 'text-slate-300'}`}
                    >
                      Full PPE Worn
                    </span>
                  </button>
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative bg-slate-900 border border-blue-500/30 rounded-xl p-4">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <h3 className="text-blue-100 font-black text-sm uppercase">
                          1. Critical Clearances
                        </h3>
                      </div>
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative bg-slate-900 border border-amber-500/30 rounded-xl p-4">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <h3 className="text-amber-100 font-black text-sm uppercase">
                          2. Torque Specs
                        </h3>
                      </div>
                ...
                <div className="relative group">
                  ...
                  <div className="relative bg-slate-900 border border-emerald-500/30 rounded-xl p-4">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <h3 className="text-emerald-100 font-black text-sm uppercase">
                        3. Service Schedule
                      </h3>
                    </div>
                    <div className="flex justify-between items-center">
                      ...
                      <div
                        className={`px-3 py-1 rounded text-xs font-bold ${daysUntilService < 30 ? 'bg-red-500/20 text-red-400' : 'bg-emerald-500/20 text-emerald-400'}`}
                      >
