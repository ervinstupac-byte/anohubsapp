...
export const OverdriveDashboard: React.FC<OverdriveDashboardProps> = ({
  thermal,
  cavitation,
  power,
}) => {
    ...
    <div className="w-full bg-slate-950 p-6">
      ...
      <div
        className={`mb-6 p-6 rounded-lg border-2 ${
          mode === 'OVERDRIVE' ? 'bg-red-950 border-red-500' : 'bg-blue-950 border-blue-500'
        }`}
      >
        <div className="text-center">
          ...
          <div
            className={`text-6xl font-bold ${
              mode === 'OVERDRIVE' ? 'text-red-300' : 'text-blue-300'
            }`}
          >
            {mode}
          </div>
          ...
          {!canOverdrive && (
            <div className="mb-4 p-3 bg-amber-950 border border-amber-500 rounded">
              <div className="flex items-center gap-2 text-amber-300 text-sm">
                ...
                {!thermal.overdriveAllowed ? 'Thermal limit' : 'Cavitation risk'}
              </div>
            </div>
          )}
                ...
                <div className="text-right">
                  ...
                  <div
                    className={`text-3xl font-bold font-mono ${
                      safetySlider > 105 ? 'text-red-400' : 'text-blue-400'
                    }`}
                  >
                    {safetySlider}%
                  </div>
        ...
        <div className="bg-slate-900 border border-orange-500 rounded-lg p-4">
          ...
          <div className="space-y-3">
            <div className="bg-slate-800 rounded p-3">
              ...
              <div
                className={`text-3xl font-bold font-mono ${
                  thermal.temperature > thermal.limit * 0.9
                    ? 'text-red-400'
                    : thermal.temperature > thermal.limit * 0.8
                      ? 'text-amber-400'
                      : 'text-emerald-400'
                }`}
              >
            ...
            <div className="bg-slate-800 rounded p-3">
              ...
              <div className="text-xs text-slate-500">Limit: {thermal.limit}°C (Class F)</div>
            </div>

            <div
              className={`p-3 rounded text-center font-bold ${
                thermal.overdriveAllowed
        ...
        <div className="bg-slate-900 border border-cyan-500 rounded-lg p-4">
          ...
          <div className="space-y-3">
            <div className="bg-slate-800 rounded p-3">
              ...
              <div
                className={`text-2xl font-bold ${
                  cavitation.severity === 'NONE'
                    ? 'text-emerald-400'
                    : cavitation.severity === 'INCIPIENT'
                      ? 'text-blue-400'
                      : cavitation.severity === 'MODERATE'
                        ? 'text-amber-400'
                        : 'text-red-400'
                }`}
              >
            ...
            <div className="bg-slate-800 rounded p-3">
              ...
              <div className="text-xs text-slate-500">Safety threshold: 5%</div>
            </div>
      ...
      {mode === 'OVERDRIVE' && (
        <div className="mt-6 p-4 bg-red-950 border border-red-500 rounded-lg">
          ...
          <div className="text-xs text-slate-300 mt-1">
            Operating beyond design limits. Continuous monitoring required. Extended operation may
            reduce component RUL.
          </div>
        </div>
      )}
    </div>
