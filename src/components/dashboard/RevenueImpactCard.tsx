 ...
 */
export const RevenueImpactCard: React.FC<{ className?: string }> = React.memo(
  ({ className = '' }) => {
    ...
    const hasData =
      data?.currentRevenuePerHour !== undefined && data?.currentRevenuePerHour !== null;
      ...
      >
        <div className="flex items-center justify-between p-4">
            ...
            <div className="flex items-center gap-2 mb-1">
              ...
              <InfoTooltip
                content={t(
                  ...
                  'Financial impact calculated from operating efficiency vs optimal baseline'
                )}
                size={12}
              />
            </div>
          ...
          <div className="text-right">
            <p className="text-[9px] text-scada-text/70 uppercase font-mono mb-1">
              Efficiency Delta
            </p>
