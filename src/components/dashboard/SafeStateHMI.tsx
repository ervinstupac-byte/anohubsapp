    ...
    <div className="fixed inset-0 bg-slate-950 flex items-center justify-center z-50">
      <div className="w-full max-w-4xl p-8">
        ...
        <div className="text-center mb-8">
          ...
          <div
            className={`text-2xl font-mono ${currentStatus.running ? 'text-emerald-400' : 'text-slate-500'}`}
          >
        ...
        <div className="grid grid-cols-3 gap-6 mb-8">
          ...
          <button
            ...
            className={`h-64 rounded-none border-4 font-bold text-2xl transition-all ${
          ...
          >
            <div className="flex flex-col items-center gap-4">
              ...
              {confirmStop && <div className="text-sm">Click again to confirm</div>}
            </div>
          </button>
            ...
            <div className="text-center">
              ...
              <div className="space-y-2 text-left px-4">
                ...
                <div className="flex justify-between gap-4 text-sm">
                  ...
                  <span
                    className={`font-mono ${
                      currentStatus.criticalAlarms.length > 0 ? 'text-red-400' : 'text-emerald-400'
                    }`}
                  >
          ...
          <button
            ...
            className={`h-64 rounded-none border-4 font-bold text-2xl transition-all ${
              currentStatus.running || currentStatus.criticalAlarms.length > 0
                ? 'bg-slate-800 border-slate-700 text-slate-600 cursor-not-allowed'
