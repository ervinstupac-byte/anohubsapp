...
export const SovereignVisualizer: React.FC<SovereignVisualizerProps> = ({
  sandboxStress = null,
  sandboxValues,
}) => {
  ...
  const handleCameraFocus = (target: THREE.Object3D) => {
    cameraControlsRef.current?.fitToBox(target, true, {
      paddingLeft: 1,
      paddingRight: 1,
      paddingTop: 1,
      paddingBottom: 1,
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="bg-slate-950 rounded p-3 font-mono text-[10px] text-slate-300 space-y-1 border border-slate-800">
                <div className="flex justify-between">
                  ...
                  <span
                    className={
                      snapshotData.telemetry.vibration > 4.5 ? 'text-red-400' : 'text-emerald-400'
                    }
                  >
                ...
                <div className="flex justify-between">
                  ...
                  <span
                    className={
                      snapshotData.telemetry.temperature > 70
                        ? 'text-orange-400'
                        : 'text-emerald-400'
                    }
                  >
                ...
                <div className="flex justify-between">
                  ...
                  <span
                    className={
                      snapshotData.telemetry.stress > 200 ? 'text-red-400' : 'text-emerald-400'
                    }
                  >
