...
export const ControlLoopVisualizer: React.FC<ControlLoopVisualizerProps> = ({
  controlType,
  pidData,
}) => {
        ...
        <div className="space-y-4">
          ...
          <div className="bg-slate-800 rounded p-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <ValueDisplay
                label="Setpoint"
                value={pidData.setpoint.toFixed(2)}
                unit="°"
                color="blue"
              />
              <ValueDisplay
                label="Process Var"
                value={pidData.processVariable.toFixed(2)}
                unit="°"
                color="emerald"
              />
              <ValueDisplay
                ...
                unit="°"
                color={Math.abs(errorPct) > 5 ? 'red' : 'amber'}
              />
              <ValueDisplay
                label="Output"
                value={pidData.output.toFixed(1)}
                unit="%"
                color="purple"
              />
            </div>
...
const ValueDisplay: React.FC<{ label: string; value: string; unit: string; color: string }> = ({
  label,
  value,
  unit,
  color,
