      ...
      <div className="relative z-10">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <div className="text-[10px] text-scada-muted font-mono mt-1">
              Economic-Technical Bridge Active
            </div>
          </div>
          <div className="text-right">
            <div className="text-[9px] text-scada-muted uppercase font-mono font-bold">
              Profit/Health Ratio
            </div>
            <div
              className={`text-2xl font-mono font-black ${profitHealthRatio > 1.5 ? 'text-status-ok' : 'text-status-warning'}`}
            >
        ...
        <div className="space-y-3">
          <h3 className="text-[10px] text-scada-muted font-mono font-black uppercase tracking-widest mb-2">
              ...
              recommendations.map((rec, idx) => (
                ...
                >
                  <div className="flex justify-between items-start">
                    <div>
                      <div className="text-sm font-bold text-status-info font-mono">
                        {rec.action}
                      </div>
                    ...
                    <div className="text-right">
                      <div className="text-xs font-black text-scada-text flex items-center justify-end gap-1">
                        <DollarSign className="w-3 h-3" />+{rec.expectedSavings} €
                      </div>
