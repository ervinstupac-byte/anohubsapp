      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-xs text-slate-400">
            Flow, Friction & Thermal Management • {data.unitId}
          </p>
        </div>
      </div>
          ...
          <div className="space-y-4">
            <div className="bg-slate-800 p-3 rounded">
              ...
              <div className="flex items-end gap-2">
                <span
                  className={`text-2xl font-mono font-bold ${data.bearing.filmThickness < 15 ? 'text-red-400' : 'text-emerald-400'}`}
                >
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="bg-slate-800 p-2 rounded">
                ...
                <div
                  className={`text-lg font-bold ${data.bearing.padMaxTemp > 80 ? 'text-amber-400' : 'text-slate-200'}`}
                >
              ...
              <div className="bg-slate-800 p-2 rounded">
                ...
                <div className="text-sm font-bold text-blue-300">{data.bearing.regime}</div>
              </div>
            </div>

            <div
              className={`text-center p-1 rounded text-xs font-bold border ${data.bearing.jackingPump === 'ON' ? 'bg-amber-900/30 border-amber-500 text-amber-400 animate-pulse' : 'bg-slate-800 border-slate-700 text-slate-500'}`}
            >
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between bg-slate-800 p-3 rounded">
              <div>
                ...
                <div
                  className={`text-xl font-bold ${data.cooling.oilCoolerEff < 70 ? 'text-red-400' : 'text-cyan-300'}`}
                >
              ...
              <div className="h-10 w-1 bg-slate-700 rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    height: `${data.cooling.oilCoolerEff}%`,
                    marginTop: `${100 - data.cooling.oilCoolerEff}%`,
                  }}
                />
              </div>
            </div>
            ...
            <div className="flex items-center justify-between bg-slate-800 p-3 rounded">
              <div>
                ...
                <div
                  className={`text-xl font-bold ${data.cooling.airCoolerEff < 70 ? 'text-red-400' : 'text-blue-300'}`}
                >
              ...
              <div className="h-10 w-1 bg-slate-700 rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    height: `${data.cooling.airCoolerEff}%`,
                    marginTop: `${100 - data.cooling.airCoolerEff}%`,
                  }}
                />
              </div>
            </div>
            ...
            <div className="text-xs text-center text-slate-500">
              ...
              <span
                className={
                  data.cooling.foulingTrend === 'RISING' ? 'text-amber-400' : 'text-emerald-400'
                }
              >
                {data.cooling.foulingTrend}
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-900/50 p-4 rounded-lg border border-slate-700">
          ...
          <div className="space-y-4">
            <div className="bg-slate-800 p-3 rounded">
              ...
              {data.oil.viscosity < 35 && (
                <div className="text-[10px] text-red-400">⚠️ TOO THIN</div>
              )}
              {data.oil.viscosity > 60 && (
                <div className="text-[10px] text-red-400">⚠️ OXIDIZED</div>
              )}
            </div>
            ...
            <div className="bg-slate-800 p-3 rounded">
              ...
              <div
                className={`text-xl font-bold font-mono ${data.oil.waterPPM > 500 ? 'text-red-400' : 'text-blue-300'}`}
              >
            ...
            <div
              className={`p-2 rounded text-center text-xs font-bold border ${data.oil.health === 'GOOD' ? 'bg-emerald-950/30 border-emerald-500/30 text-emerald-400' : 'bg-red-950/30 border-red-500 text-red-400'}`}
            >
