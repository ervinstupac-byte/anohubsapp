...
export const FoundationOverview: React.FC<FoundationOverviewProps> = ({
  structural,
  environmental,
  electrical,
}) => {
  ...
  const getOverallStatus = (): 'EXCELLENT' | 'GOOD' | 'WARNING' | 'CRITICAL' => {
    if (
      ...
      return 'WARNING';
    } else if (structural.status === 'MONITORING' || electrical.gridHealth === 'MONITORING') {
      return 'GOOD';
    } else {
      return 'EXCELLENT';
    }
  ...
  return (
    <div className="w-full bg-slate-950 p-6">
      ...
      <div className="grid grid-cols-3 gap-6">
        {/* 1. Structural Safety */}
        <div
          className={`bg-slate-900 border-2 rounded-lg p-6 ${
            ...
            <div className="bg-slate-800 rounded p-3">
              ...
              <div
                className={`text-lg font-bold ${
                  structural.seismicActivity === 'NONE'
                    ? 'text-emerald-400'
                    : structural.seismicActivity === 'LOW'
                      ? 'text-blue-400'
                      : structural.seismicActivity === 'MODERATE'
                        ? 'text-amber-400'
                        : 'text-red-400'
                }`}
              >
        ...
        >
          ...
          <div className="space-y-4">
            <div className="text-center mb-4">
              ...
              <div
                className={`text-4xl font-bold font-mono ${
                  environmental.complianceScore >= 95
                    ? 'text-emerald-300'
                    : environmental.complianceScore >= 85
                      ? 'text-amber-300'
                      : 'text-red-300'
                }`}
              >
            ...
            <div className="bg-slate-800 rounded p-3">
              ...
              <div
                className={`text-xl font-mono ${
                  environmental.currentDO >= 5 ? 'text-emerald-400' : 'text-red-400'
                }`}
              >
        ...
        >
          ...
          <div className="space-y-4">
            <div className="text-center mb-4">
              ...
              <div
                className={`text-2xl font-bold ${
                  electrical.transformerStatus === 'NORMAL'
                    ? 'text-emerald-300'
                    : electrical.transformerStatus === 'PARTIAL_DISCHARGE'
                      ? 'text-blue-300'
                      : electrical.transformerStatus === 'THERMAL_FAULT'
                        ? 'text-amber-300'
                        : 'text-red-300'
                }`}
              >
            ...
            <div className="bg-slate-800 rounded p-3">
              ...
              <div
                className={`text-xl font-mono ${
                  electrical.relayAlarms === 0 ? 'text-emerald-400' : 'text-red-400'
                }`}
              >
            ...
            <div className="bg-slate-800 rounded p-3">
              ...
              <div
                className={`text-xl font-mono ${
                  electrical.hotspotCount === 0
                    ? 'text-emerald-400'
                    : electrical.hotspotCount < 3
                      ? 'text-amber-400'
                      : 'text-red-400'
                }`}
              >
      ...
      <div className="mt-6 p-4 bg-slate-900 border border-purple-500 rounded-lg">
        ...
        <div className="grid grid-cols-3 gap-4 text-xs">
          <div>
            ...
            <span
              className={`ml-2 font-bold ${
                structural.status === 'SAFE' ? 'text-emerald-400' : 'text-amber-400'
              }`}
            >
              {structural.status}
            </span>
          ...
          <div>
            ...
            <span
              className={`ml-2 font-bold ${
                environmental.status === 'COMPLIANT' ? 'text-emerald-400' : 'text-amber-400'
              }`}
            >
              {environmental.status}
            </span>
          ...
          <div>
            ...
            <span
              className={`ml-2 font-bold ${
                electrical.gridHealth === 'HEALTHY' ? 'text-emerald-400' : 'text-amber-400'
              }`}
            >
              {electrical.gridHealth}
            </span>
