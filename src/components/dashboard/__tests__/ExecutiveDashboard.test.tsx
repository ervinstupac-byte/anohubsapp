...
vi.mock('../EngineeringWisdomVault', () => ({
  EngineeringWisdomVault: () => (
    <div data-testid="engineering-wisdom-vault">Engineering Wisdom Vault</div>
  ),
}));
...
vi.mock('../StrategicPrescription', () => ({
  StrategicPrescription: () => (
    <div data-testid="strategic-prescription">Strategic Prescription</div>
  ),
}));
...
vi.mock('../../../services/SovereignExpertTranslator', () => ({
  default: class {
    generateWisdomReport() {
      return {};
    }
    sampleBearingCoolingReport() {
      return {};
    }
  },
}));
...
vi.mock('../../ui/HeritagePrecisionBanner', () => ({
  HeritagePrecisionBanner: () => (
    <div data-testid="heritage-precision-banner">Heritage Precision Banner</div>
  ),
}));
...
vi.mock('../../../shared/components/ui/EngineeringCard', () => ({
  EngineeringCard: ({ children }: { children: any }) => (
    <div data-testid="engineering-card">{children}</div>
  ),
}));
...
vi.mock('../SecondaryMetricsGrid', () => ({
  SecondaryMetricsGrid: () => (
    <div data-testid="secondary-metrics-grid">Secondary Metrics Grid</div>
  ),
}));
...
vi.mock('../EngineeringDossierCard', () => ({
  EngineeringDossierCard: () => (
    <div data-testid="engineering-dossier-card">Engineering Dossier Card</div>
  ),
}));
