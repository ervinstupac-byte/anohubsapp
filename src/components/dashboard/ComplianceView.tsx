      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-xs text-slate-400">
            IEEE/IEC Grid Code Compliance • {report.overallStatus}
          </p>
        </div>
      </div>
          ...
          <div className="space-y-4">
            <div className="bg-slate-800 p-3 rounded flex justify-between items-center">
              <div>
                ...
                <div
                  className={`text-xl font-mono font-bold ${report.rejection.speed > 135 ? 'text-red-400' : 'text-emerald-400'}`}
                >
            ...
            <div className="bg-slate-800 p-3 rounded flex justify-between items-center">
              <div>
                ...
                <div
                  className={`text-xl font-mono font-bold ${report.rejection.passed ? 'text-emerald-400' : 'text-red-400'}`}
                >
              ...
              <div className="text-right">
                ...
                <div
                  className={`px-2 py-0.5 rounded text-[10px] font-bold ${report.rejection.passed ? 'bg-emerald-500 text-black' : 'bg-red-500 text-white'}`}
                >
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-slate-800 p-3 rounded">
                ...
                <div
                  className={`text-xl font-mono font-bold ${report.step.damping < 0.3 ? 'text-amber-400' : 'text-blue-300'}`}
                >
            ...
            <div className="p-3 rounded bg-slate-800/50 border border-slate-600 text-center">
              ...
              <div
                className={`text-lg font-bold ${report.overallStatus === 'COMPLIANT' ? 'text-emerald-400' : 'text-amber-400'}`}
              >
