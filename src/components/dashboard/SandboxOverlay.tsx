...
export const SandboxOverlay: React.FC<SandboxOverlayProps> = ({
  ...
  useEffect(() => {
    ...
    const pressure =
      SYSTEM_CONSTANTS.PHYSICS.WATER.DENSITY * SYSTEM_CONSTANTS.PHYSICS.GRAVITY * values.head;
        ...
        >
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3 mt-4">
              <div
                className={`p-3 rounded-lg border ${results.stress > 200 ? 'bg-red-500/10 border-red-500/50' : 'bg-slate-800/50 border-slate-700'}`}
              >
                <div className="flex items-center gap-2 mb-1">
                  <Gauge
                    className={`w-3 h-3 ${results.stress > 200 ? 'text-red-400' : 'text-slate-400'}`}
                  />
                ...
                <div
                  className={`text-lg font-mono font-bold ${results.stress > 200 ? 'text-red-400' : 'text-slate-200'}`}
                >
