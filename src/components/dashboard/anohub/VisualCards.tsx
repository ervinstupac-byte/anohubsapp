    ...
    <div className="bg-slate-900/80 border border-slate-700/50 p-4 rounded-lg relative overflow-hidden backdrop-blur-md group h-full flex flex-col justify-between metallic-border shadow-2xl min-h-0">
      ...
      <div className="flex gap-4 relative z-10 items-end min-h-0">
        <div className="flex-1 min-h-0">
          <div className="text-[clamp(1.2rem,2.5vh,2rem)] font-black tracking-tighter text-red-500 bloom-glow-red font-mono leading-none truncate">
            42.8<span className="text-[clamp(8px,1vh,12px)] text-slate-500 ml-1 uppercase">°C</span>
          </div>
          <div className="text-[clamp(7px,0.8vh,9px)] text-slate-500 font-mono font-bold uppercase tracking-wider opacity-60 mt-1 truncate">
            Lower Bearing Pad B
          </div>
        </div>
...
export const ShaftLiftCard: React.FC = () => {
  return (
    <div className="bg-slate-900/80 border border-slate-700/50 p-4 rounded-lg relative overflow-hidden backdrop-blur-md group h-full flex flex-col justify-between metallic-border shadow-2xl min-h-0">
      ...
      <div className="flex gap-4 relative z-10 items-end min-h-0">
        <div className="flex-1 min-h-0">
          <div className="text-[clamp(1.2rem,2.5vh,2rem)] font-black tracking-tighter text-cyan-400 bloom-glow-cyan font-mono leading-none truncate">
            +120<span className="text-[clamp(8px,1vh,12px)] text-slate-500 ml-1 uppercase">µM</span>
          </div>
          <div className="text-[clamp(7px,0.8vh,9px)] text-slate-500 font-mono font-bold uppercase tracking-wider opacity-60 mt-1 truncate">
            Axial Positioning Delta
          </div>
        </div>
...
export const LabyrinthCard: React.FC = () => {
  return (
    <div className="bg-slate-900/80 border border-slate-700/50 p-4 rounded-lg relative overflow-hidden backdrop-blur-md group h-full flex flex-col justify-between metallic-border shadow-2xl min-h-0">
      ...
      <div className="flex gap-4 relative z-10 items-end min-h-0">
        <div className="flex-1 min-h-0">
          <div className="text-[clamp(1.2rem,2.5vh,2rem)] font-black tracking-tighter text-emerald-400 bloom-glow-emerald font-mono leading-none truncate">
            0.45<span className="text-[clamp(8px,1vh,12px)] text-slate-500 ml-1 uppercase">MM</span>
          </div>
          <div className="text-[clamp(7px,0.8vh,9px)] text-slate-500 font-mono font-bold uppercase tracking-wider opacity-60 mt-1 truncate">
            Seal Gap Differential
          </div>
        </div>
        ...
        <div className="w-16 h-16 lg:w-24 lg:h-24 relative flex items-center justify-center shrink-0">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center pt-2">
            <span className="text-[clamp(8px,1vh,10px)] font-black text-white/80 font-mono">
              65%
            </span>
          </div>
        </div>
