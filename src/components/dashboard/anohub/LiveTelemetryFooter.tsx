      ...
      <div className="flex items-center justify-between w-full h-full px-4 relative z-10">
        ...
        <div className="flex items-center gap-6 shrink-0 border-l border-white/5 pl-6 h-full py-2">
          ...
          <div className="text-right">
            ...
            <div className="text-[7px] font-mono text-slate-600 uppercase tracking-tighter font-black">
...
const Waveform: React.FC<{
  ...
  label: string;
  freq: number;
}> = ({ color, glow, delay, label, freq }) => (
  <div className="flex-1 min-w-[120px] h-12 relative flex flex-col justify-center">
    <div className="absolute -top-1 left-0 text-[7px] font-black text-slate-600 font-mono tracking-widest uppercase">
      {label}
    </div>
...
const DigitalReadout: React.FC<{ label: string; value: string; unit: string; color: string }> = ({
  label,
  value,
  unit,
  color,
  ...
  <div className="flex flex-col items-end min-w-[60px]">
    <span className="text-[7px] font-black text-slate-600 uppercase tracking-widest font-mono">
      {label}
    </span>
