      ...
      <div className="flex items-center justify-between mb-6 relative z-10">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="px-3 py-1 bg-status-ok/20 border border-status-ok/30 rounded-none">
            <span className="text-xs text-status-ok font-black uppercase tracking-widest">
              LIVE
            </span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 relative z-10">
        ...
        <div className="bg-scada-bg border border-status-error/30 rounded-none p-4 hover:bg-status-error/5 transition-colors duration-300">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm text-status-error font-bold uppercase tracking-wider">
              Hourly Loss
            </span>
          </div>
          ...
          <div className="text-xs text-scada-muted mt-1 font-mono uppercase tracking-widest">
            per hour impact
          </div>
        </div>
        ...
        <div className="bg-scada-bg border border-status-warning/30 rounded-none p-4 hover:bg-status-warning/5 transition-colors duration-300">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm text-status-warning font-bold uppercase tracking-wider">
              30-Day Projection
            </span>
          </div>
        ...
        <div className="bg-scada-bg border border-status-info/30 rounded-none p-4 hover:bg-status-info/5 transition-colors duration-300">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm text-status-info font-bold uppercase tracking-wider">
              Maintenance Cost
            </span>
          </div>
      ...
      <div className="mt-6 pt-4 border-t border-scada-border relative z-10">
        <div className="flex items-center justify-between">
          <span className="text-xs text-scada-muted font-mono">
            Asset:{' '}
            <span className="text-scada-text font-bold">{identity?.assetName || 'Unknown'}</span>
          </span>
          <span className="text-xs text-scada-muted font-mono">
