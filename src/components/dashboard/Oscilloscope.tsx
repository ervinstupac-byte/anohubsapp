  ...
  return (
    <div className="w-full bg-slate-950 p-6">
        ...
        <div className="grid grid-cols-4 gap-4 text-xs">
          ...
          <div>
            ...
            <div className="text-cyan-300 font-mono font-bold">
              {(1000 / sampleRate).toFixed(2)} ms/sample
            </div>
          </div>
          <div>
      ...
      <div className="bg-slate-900 border border-slate-700 rounded-lg p-4">
        <canvas ref={canvasRef} width={1200} height={400} className="w-full rounded" />
      </div>
            ...
            <div className="grid grid-cols-3 gap-2 text-xs">
              ...
              <div>
                ...
                <div className="text-blue-400 font-mono">
                  {Math.sqrt(
                    channel.data.reduce((sum, v) => sum + v * v, 0) / channel.data.length
                  ).toFixed(2)}{' '}
                  {channel.unit}
                </div>
              </div>
