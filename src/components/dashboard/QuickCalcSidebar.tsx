...
export const QuickCalcSidebar: React.FC = () => {
  ...
  const handleValueChange = useCallback(
    (converterId: string, field: 'left' | 'right', inputValue: string) => {
      ...
      if (inputValue === '' || inputValue === '-') {
        setConverters(prev => ({
          ...prev,
          [converterId]: {
            leftValue: field === 'left' ? inputValue : '',
            rightValue: field === 'right' ? inputValue : '',
            activeField: field,
          },
        }));
        return;
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-500 font-mono">Decimal.js Precision</p>
              </div>
            </div>
            <button
