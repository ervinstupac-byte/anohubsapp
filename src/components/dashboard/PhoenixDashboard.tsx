...
export const PhoenixDashboard: React.FC<PhoenixDashboardProps> = ({
  ...
  return (
    <div className="w-full bg-slate-950 p-6">
      ...
      {/* Black Start Status */}
      <div
        className={`mb-6 p-6 rounded-none border-2 ${
          blackStart.status === 'COMPLETE'
        ...
        <div className="text-center">
          ...
          {blackStart.status === 'IN_PROGRESS' && (
            <div className="mt-4">
              ...
              <div className="relative h-4 bg-slate-800 rounded-none overflow-hidden">
                <div
      ...
      <div className="grid grid-cols-2 gap-6">
        {/* Island Grid Status */}
        <div
          className={`bg-slate-900 border-2 rounded-none p-4 ${
            island.active ? 'border-cyan-500' : 'border-slate-700'
          }`}
        >
          ...
          <div className="space-y-3">
            <div
              className={`p-4 rounded-none text-center ${
                island.active ? 'bg-cyan-950' : 'bg-slate-800'
              }`}
            >
              <div
                className={`text-3xl font-bold ${
                  island.active ? 'text-cyan-300' : 'text-slate-500'
                }`}
              >
            ...
            <div className="bg-slate-800 rounded-none p-3">
        ...
        <div className="bg-slate-900 border-2 border-emerald-500 rounded-none p-4">
          <div className="flex items-center gap-2 mb-4">
          ...
          <div className="space-y-3">
            <div className="bg-slate-800 rounded-none p-3">
              ...
              <div className="relative h-3 bg-slate-700 rounded-none overflow-hidden">
                <div
                  className="absolute inset-y-0 left-0 bg-emerald-500"
                  style={{
                    width: `${(restoration.loadsRestored / restoration.totalLoads) * 100}%`,
                  }}
                />
              </div>
            </div>
            ...
            <div className="bg-slate-800 rounded-none p-3">
              ...
              <div
                className={`text-3xl font-bold font-mono ${
                  restoration.stabilityIndex > 90
                    ? 'text-emerald-300'
                    : restoration.stabilityIndex > 70
                      ? 'text-blue-300'
                      : 'text-amber-300'
                }`}
              >
        ...
        {/* Recovery Timeline */}
        <div className="col-span-2 bg-slate-900 border border-orange-500 rounded-none p-4">
          <div className="text-lg font-bold text-orange-300 mb-4">🔥 Phoenix Rising Timeline</div>

          <div className="space-y-2 text-sm">
            <div className="flex items-center gap-3 p-2 bg-slate-800 rounded-none">
      ...
      <div className="mt-6 p-4 bg-gradient-to-r from-orange-950 to-red-950 border border-orange-500 rounded-none">
        <div className="text-sm font-bold text-orange-300">
          🔥 THE PHOENIX PROTOCOL: When the grid falls, we become the grid. Autonomous. Sovereign.
          Eternal.
        </div>
      </div>
    </div>
