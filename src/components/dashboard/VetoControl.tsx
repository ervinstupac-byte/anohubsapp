        ...
        >
          <div className="bg-slate-900 border border-red-500 rounded-xl p-6 w-full max-w-lg shadow-[0_0_30px_rgba(220,38,38,0.2)]">
            ...
            <p className="text-sm text-slate-400 mb-4 font-mono">
              You are overriding the Sovereign AI. Please provide a reason for the Active Learning
              Ledger.
            </p>
            ...
            <div className="space-y-2 mb-6">
              {[
                ...
                'Manual Inspection in Progress',
                'Operational Safety Limit',
                'External Grid Command',
              ].map(suggestion => (
                <button
                  key={suggestion}
            ...
            <div className="flex justify-end gap-3">
              <ModernButton variant="ghost" onClick={() => setVetoMode(false)}>
                Cancel
              </ModernButton>
              <ModernButton
                variant="primary"
