              ...
              <div
                ...
                className={`p-4 rounded-none border flex items-start gap-4 group relative overflow-hidden transition-colors ${
                  alarm.severity === 'CRITICAL'
                    ? 'bg-status-error/10 border-status-error/50 hover:bg-status-error/15'
                    : alarm.severity === 'WARNING'
                      ? 'bg-status-warning/10 border-status-warning/50 hover:bg-status-warning/15'
                      : 'bg-status-info/10 border-status-info/50 hover:bg-status-info/15'
                }`}
              >
                <div
                  className={`mt-1 p-1.5 rounded-none border ${
                    alarm.severity === 'CRITICAL'
