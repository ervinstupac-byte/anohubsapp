    ...
    <div className="w-full bg-slate-950 p-6">
        ...
        <div className="bg-slate-900 border border-cyan-500 rounded-lg p-4">
          ...
          <div className="space-y-3">
            <div className="bg-slate-800 rounded p-3">
              ...
              <div className="text-3xl font-bold text-cyan-300">{v2g.vehicles}</div>
            ...
            <div
              className={`p-3 rounded text-center font-bold ${
                v2g.discharging ? 'bg-emerald-950 text-emerald-300' : 'bg-slate-800 text-slate-500'
              }`}
            >
        ...
        <div className="bg-slate-900 border border-orange-500 rounded-lg p-4">
          ...
          <div className="space-y-3">
            <div className="bg-slate-800 rounded p-3">
              ...
              <div className="text-3xl font-bold text-orange-300">{swarm.inverters}</div>
            </div>
      ...
      <div className="mt-6 p-4 bg-gradient-to-r from-purple-950 to-cyan-950 border border-purple-500 rounded-lg">
        <div className="text-sm font-bold text-purple-300">
          🕸️ THE WEAVER: From centralized power plant to decentralized orchestrator. Every EV, every
          solar panel, every smart meter - woven into one resilient grid.
        </div>
      </div>
    </div>
  );
