          ...
          <GlassCard className="border-cyan-500/30">
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-white font-bold uppercase tracking-wider text-sm">
                    {t('francis.mechanism.shaftSealing', 'Shaft Sealing')}
                  </h3>
                  <p className="text-slate-400 text-xs mt-1">
                    {t(
                      'francis.mechanism.shaftSealingDesc',
                      'Active sealing prevents water ingress into the bearing housing. Currently operating at optimal pressure.'
                    )}
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-white font-bold uppercase tracking-wider text-sm">
                    {t('francis.mechanism.linkage', 'Distributor Linkage')}
                  </h3>
                  <p className="text-slate-400 text-xs mt-1">
                    {t(
                      'francis.mechanism.linkageDesc',
                      'Mechanical linkage converting servo linear motion to guide vane rotation.'
                    )}
                  </p>
                </div>
              </div>
