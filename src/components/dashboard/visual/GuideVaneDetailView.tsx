...
const GV_COMPONENTS = [
  {
    ...
    heritage:
      'Precise angular synchronization determines the purity of flow entry. Any deviation > 0.1° creates turbulence that hammers the runner blades.',
    icon: Aperture,
  ...
  },
  {
    ...
    heritage:
      'Never replace with standard bolts. Use only calibrated shear pins to protect the gate linkage in case of foreign object jam.',
    icon: ShieldAlert,
    pos: { x: 75, y: 35 },
  ...
  },
  {
    ...
    heritage:
      'Excessive top/bottom clearance acts as a high-velocity bypass leak, eroding surfaces and reducing efficiency measurable by 0.5-1%.',
    icon: Gauge,
    pos: { x: 25, y: 65 },
  ...
  },
  {
    ...
    heritage:
      'Smooth operation relies on regular greasing of the linkage bushings. A sticky linkage causes governor hunting and power fluctuations.',
    icon: Link,
    pos: { x: 60, y: 80 },
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-xl font-black text-white tracking-widest uppercase">
              {t('guidevane.detail.title', 'Guide Vane System')}{' '}
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-1 bg-cyan-900/40 px-2 py-0.5 rounded border border-cyan-500/30">
                ...
                <span className="text-[10px] font-mono font-black text-white">
                  {guideVaneOpening.toFixed(1)}% OPEN
                </span>
              </div>
            </div>
          </div>
          ...
          <AnimatePresence mode="sync">
            {activeData ? (
              ...
              <div className="h-full flex flex-col items-center justify-center p-8 bg-cyan-500/5 border border-dashed border-cyan-500/20 rounded-2xl text-center">
                ...
                <h3 className="text-cyan-500/60 font-black text-sm uppercase">
                  Select Regulation Point
                </h3>
                <p className="text-[10px] text-cyan-500/40 font-bold mt-2">
                  Explore Wicket Gates & Linkage
                </p>
              </div>
            )}
          </AnimatePresence>
