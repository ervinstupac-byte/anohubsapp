  ...
  >
    ...
    >
      <div className="flex items-center gap-5">
        ...
        <div>
          <h3
            className={`text-xl font-bold transition-colors ${isOpen ? 'text-white' : 'text-slate-300 group-hover:text-white'}`}
          >
            {item.title}
          </h3>
    ...
    >
      <div className="p-6 pt-0">
        <div className="pt-6 border-t border-white/10 animate-fade-in">{item.content}</div>
      </div>
    </div>
  </div>
);
...
export const RiverWildlife: React.FC = () => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-slate-900/40 p-5 rounded-xl border border-white/5 hover:border-cyan-500/30 transition-colors">
              <h4 className="font-bold text-cyan-400 mb-2">
                {t('riverWildlife.sections.fish_passage.ladders.title')}
              </h4>
              <p className="text-xs text-slate-400 leading-relaxed">
                {t('riverWildlife.sections.fish_passage.ladders.desc')}
              </p>
            </div>
            <div className="bg-slate-900/40 p-5 rounded-xl border border-white/5 hover:border-cyan-500/30 transition-colors">
              <h4 className="font-bold text-cyan-400 mb-2">
                {t('riverWildlife.sections.fish_passage.lifts.title')}
              </h4>
              <p className="text-xs text-slate-400 leading-relaxed">
                {t('riverWildlife.sections.fish_passage.lifts.desc')}
              </p>
            </div>
            <div className="bg-slate-900/40 p-5 rounded-xl border border-white/5 hover:border-cyan-500/30 transition-colors">
              <h4 className="font-bold text-cyan-400 mb-2">
                {t('riverWildlife.sections.fish_passage.bypass.title')}
              </h4>
              <p className="text-xs text-slate-400 leading-relaxed">
                {t('riverWildlife.sections.fish_passage.bypass.desc')}
              </p>
            </div>
            <div className="bg-slate-900/40 p-5 rounded-xl border border-white/5 hover:border-cyan-500/30 transition-colors">
              <h4 className="font-bold text-cyan-400 mb-2">
                {t('riverWildlife.sections.fish_passage.turbines.title')}
              </h4>
              <p className="text-xs text-slate-400 leading-relaxed">
                {t('riverWildlife.sections.fish_passage.turbines.desc')}
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-slate-800/50 p-4 rounded-xl text-center border border-white/5">
              <h4 className="font-bold text-white text-sm mb-1">
                {t('riverWildlife.sections.sediment_management.bypass.title')}
              </h4>
              <p className="text-[10px] text-slate-400">
                {t('riverWildlife.sections.sediment_management.bypass.desc')}
              </p>
            </div>
            <div className="bg-slate-800/50 p-4 rounded-xl text-center border border-white/5">
              <h4 className="font-bold text-white text-sm mb-1">
                {t('riverWildlife.sections.sediment_management.flushing.title')}
              </h4>
              <p className="text-[10px] text-slate-400">
                {t('riverWildlife.sections.sediment_management.flushing.desc')}
              </p>
            </div>
            <div className="bg-slate-800/50 p-4 rounded-xl text-center border border-white/5">
              <h4 className="font-bold text-white text-sm mb-1">
                {t('riverWildlife.sections.sediment_management.watershed.title')}
              </h4>
              <p className="text-[10px] text-slate-400">
                {t('riverWildlife.sections.sediment_management.watershed.desc')}
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="p-5 border-l-2 border-amber-500 bg-amber-900/10 rounded-r-xl">
              ...
              <ul className="list-disc list-inside text-xs text-slate-300 space-y-2">
                <li>
                  <strong className="text-amber-100">Batimetrijska Snimanja:</strong>{' '}
                  {t('riverWildlife.sections.sediment_management.vis.l1').split(':')[1]}
                </li>
                <li>
                  <strong className="text-amber-100">3D Wear Scans:</strong>{' '}
                  {t('riverWildlife.sections.sediment_management.vis.l2').split(':')[1]}
                </li>
              </ul>
            </div>
              ...
              <div className="space-y-2 text-xs text-slate-300">
                <p>
                  <strong className="text-white">
                    {t('riverWildlife.sections.sediment_management.rcfa.abrasion').split(':')[0]}:
                  </strong>{' '}
                  {t('riverWildlife.sections.sediment_management.rcfa.abrasion').split(':')[1]}
                </p>
                <p>
                  <strong className="text-white">
                    {t('riverWildlife.sections.sediment_management.rcfa.cavitation').split(':')[0]}:
                  </strong>{' '}
                  {t('riverWildlife.sections.sediment_management.rcfa.cavitation').split(':')[1]}
                </p>
                <p className="italic text-red-300 mt-2 border-t border-red-500/20 pt-2">
                  "{t('riverWildlife.sections.sediment_management.rcfa.quote')}"
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-slate-900/30 p-4 rounded-xl border border-white/5">
                <h4 className="font-bold text-white text-sm mb-1">
                  {t('riverWildlife.sections.water_quality.aerating.title')}
                </h4>
                <p className="text-xs text-slate-400">
                  {t('riverWildlife.sections.water_quality.aerating.desc')}
                </p>
              </div>
              <div className="bg-slate-900/30 p-4 rounded-xl border border-white/5">
                <h4 className="font-bold text-white text-sm mb-1">
                  {t('riverWildlife.sections.water_quality.withdrawal.title')}
                </h4>
                <p className="text-xs text-slate-400">
                  {t('riverWildlife.sections.water_quality.withdrawal.desc')}
                </p>
              </div>
            </div>
          </div>
      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              {
                title: t('riverWildlife.sections.habitat_restoration.gravel.title'),
                desc: t('riverWildlife.sections.habitat_restoration.gravel.desc'),
              },
              {
                title: t('riverWildlife.sections.habitat_restoration.riparian.title'),
                desc: t('riverWildlife.sections.habitat_restoration.riparian.desc'),
              },
              {
                title: t('riverWildlife.sections.habitat_restoration.structures.title'),
                desc: t('riverWildlife.sections.habitat_restoration.structures.desc'),
              },
            ].map((item, i) => (
              <div
                key={i}
                className="flex items-center p-4 bg-emerald-900/10 border border-emerald-500/20 rounded-xl hover:bg-emerald-900/20 transition-colors"
              >
  ...
  return (
    <div className="space-y-8 pb-12 max-w-5xl mx-auto">
      ...
      <div className="relative text-center space-y-4 animate-fade-in-up">
        ...
        <div className="pt-12">
          <h2 className="text-4xl md:text-6xl font-black text-white tracking-tighter mb-4 drop-shadow-lg">
            {t('riverWildlife.title').split(' ')[0]}{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-emerald-400">
              {t('riverWildlife.title').split(' ').slice(1).join(' ')}
            </span>
          </h2>
      ...
      {/* MANDATE BANNER */}
      <div
        className="relative overflow-hidden rounded-2xl border border-cyan-500/30 p-1 animate-fade-in-up"
      ...
      >
        ...
        <div className="relative z-10 flex flex-col md:flex-row gap-6 items-center p-6 md:p-8 text-center md:text-left">
          ...
          <div className="flex-grow">
            ...
            <p className="text-slate-300 leading-relaxed font-light">
              <Trans
                i18nKey="riverWildlife.mandateDesc"
                components={{ strong: <strong className="text-white font-bold block mt-1" /> }}
              />
            </p>
          </div>
        </div>
