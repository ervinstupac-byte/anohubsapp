...
import {
  ParticleAnalysisService,
  ParticleClassification,
} from '../services/ParticleAnalysisService';
...
export const ParticleFerographyViewer: React.FC = () => {
  ...
  const [selectedParticle, setSelectedParticle] = useState<ParticleClassification | null>(
    particles[0]
  );
  ...
  const correlation = ParticleAnalysisService.correlateTempAndParticles(
    particles,
    bearingTemp,
    baselineTemp
  );
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-slate-400">Visual Classification - Metal Wear Detection</p>
      </div>
                        ...
                        Array.from({ length: 12 }).map((_, i) => {
                          ...
                          return (
                            <polygon
                              ...
                              fill={
                                selectedParticle.characteristics.appearance === 'SHINY'
                                  ? '#fbbf24'
                                  : '#64748b'
                              }
              ...
              <GlassCard className="p-6">
                ...
                <div
                  className={`p-3 rounded-lg border-2 ${
                    selectedParticle.severity === 'CRITICAL'
                      ? 'border-red-500 bg-red-950/20'
                      : selectedParticle.severity === 'HIGH'
                        ? 'border-amber-500 bg-amber-950/20'
                        : selectedParticle.severity === 'MEDIUM'
  ...
  return (
    <motion.button
      ...
      className={`w-full p-3 rounded-lg border-2 transition-all text-left ${
        selected ? severityColors[particle.severity] : 'border-slate-700/50 bg-slate-800/30'
      }`}
    >
      <div className="flex items-center justify-between mb-2">
        ...
        <Icon
          className={`w-4 h-4 ${
            particle.severity === 'CRITICAL'
              ? 'text-red-400'
              : particle.severity === 'HIGH'
                ? 'text-amber-400'
                : particle.severity === 'MEDIUM'
                  ? 'text-orange-400'
                  : 'text-emerald-400'
          }`}
        />
