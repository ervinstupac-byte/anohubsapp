    ...
    return (
        <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <GlassCard className="p-6 border-l-4 border-brand-500 relative overflow-hidden">
                    <div className="absolute right-0 top-0 p-8 opacity-5">
                        <Network size={120} />
                    </div>

                    <h3 className="text-xs font-bold text-brand-400 uppercase mb-4">Source: Project Genesis</h3>

                    <div className="space-y-4">
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-lg bg-brand-950/50 flex items-center justify-center border border-brand-500/30">
                                <Droplets className="text-brand-400 w-5 h-5" />
                            </div>
                            <div>
                ...
                <div className="space-y-2">
                    {schedule.map((item, i) => (
                        <div key={i} className="flex gap-4 items-start text-sm p-2 hover:bg-white/5 rounded">
                            <div className="min-w-[150px] font-mono text-brand-400">{item.action}</div>
