    ...
    <div className="p-6">
      <h2 className="text-2xl font-black text-white uppercase tracking-tighter mb-6 flex items-center gap-3">
        ...
        <span className="text-slate-500 text-sm normal-case border-l border-slate-700 pl-3">
          Genesis Data → Operational Strategy
        </span>
      </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <GlassCard className="p-6 border-l-4 border-cyan-500 relative overflow-hidden">
          ...
          <h3 className="text-xs font-bold text-cyan-400 uppercase mb-4">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-lg font-black text-white">
                  {project.genesis.siteParams.waterQuality}
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-lg font-black text-white">
                  {project.genesis.siteParams.grossHead} m
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="hidden md:flex flex-col items-center justify-center text-slate-600">
          <div className="text-[10px] font-mono mb-2 uppercase tracking-widest">
            Auto-Calibrating
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-lg font-black text-white">
                  € {baselines.revenueImpactPerHourDowntime.toFixed(0)}{' '}
