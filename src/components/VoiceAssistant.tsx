    ...
    if (!isListening) {
        return (
            <button
                ...
                className="fixed bottom-20 right-4 w-14 h-14 bg-slate-900 border border-emerald-500/30 rounded-full flex items-center justify-center shadow-lg shadow-emerald-500/20 hover:scale-110 transition-all z-50 group"
            >
