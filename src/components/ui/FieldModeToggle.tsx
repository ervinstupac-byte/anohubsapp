    ...
    >
      {isFieldMode ? (
        <>
          ...
          <span className="text-[9px] font-mono font-black uppercase tracking-widest">FIELD</span>
        </>
      ) : (
        <>
          <Sun className="w-3.5 h-3.5" />
          <span className="text-[9px] font-mono font-bold uppercase tracking-wider">STD</span>
        </>
      )}
    </button>
  );
