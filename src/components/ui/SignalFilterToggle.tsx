    ...
    >
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          <div
            className={`w-2 h-2 rounded-full ${isFilteredMode ? 'bg-cyan-400 animate-pulse' : 'bg-slate-500'}`}
          />
      ...
      <div className="flex bg-slate-800/50 rounded-lg p-1 gap-1">
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-2 py-2 px-3 rounded-md text-xs font-bold uppercase tracking-wide transition-all ${
            !isFilteredMode
      ...
      <div className="mt-3 pt-2 border-t border-slate-700/50 flex items-center gap-2">
        <div
          className={`w-1.5 h-1.5 rounded-full ${isFilteredMode ? 'bg-cyan-400' : 'bg-amber-400'}`}
        />
