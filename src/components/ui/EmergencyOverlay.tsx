...
export const EmergencyOverlay: React.FC = () => {
  ...
  return (
    <div
      className={`fixed inset-0 z-[9999] pointer-events-none animate-[pulse_0.5s_ease-in-out_infinite] ${isCatastrophic ? 'bg-red-950/80' : 'bg-red-950/40'} ring-[12px] ring-inset ring-red-500/60 flex items-center justify-center`}
    >
      <div
        className={`bg-black/90 px-12 py-8 rounded-2xl border-2 ${isCatastrophic ? 'border-red-600 shadow-[0_0_150px_rgba(220,38,38,1)]' : 'border-red-500 shadow-[0_0_100px_rgba(220,38,38,0.6)]'} backdrop-blur-2xl transform scale-110`}
      >
