...
export const NeuralPulse: React.FC<NeuralPulseProps> = ({ color = 'cyan' }) => {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 h-12 bg-slate-950/95 backdrop-blur-sm border-t border-brand-900/20 z-40">
                    ...
                    {Object.entries(weights)
                        ...
                        .map(([pattern, weight]) => (
                            <div key={pattern} className="flex items-center gap-1.5">
                                <div className="w-1 h-3 bg-brand-500/30 rounded-full overflow-hidden">
                                    <div
