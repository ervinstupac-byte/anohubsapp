              ...
              <div className="p-6 space-y-6">
                ...
                {validation && (
                  <>
                    {/* Validation Info */}
                    <div
                      className={`mb-6 p-4 rounded-none border-2 ${
                      ...
                      <div className="space-y-2">
                        {validation.checklistBefore.map((item, index) => (
                          ...
                          >
                            ...
                            <div
                              className={`mt-0.5 ${checklistStatus.get(index) ? 'text-emerald-500' : 'text-slate-600 group-hover:text-slate-400'}`}
                            >
                              {checklistStatus.get(index) ? (
                        ...
                        >
                          <p
                            className={`text-xs font-bold uppercase mb-1 ${
                              tip.criticality === 'MUST_FOLLOW' ? 'text-red-400' : 'text-purple-400'
                            }`}
                          >
                  ...
                  <div className="mb-6">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-xs text-white font-bold">
                        {Array.from(checklistStatus.values()).filter(v => v).length} /{' '}
                        {checklistStatus.size}
                      </span>
                    </div>
                ...
                <div className="flex gap-3 pt-4 border-t border-slate-800">
                  ...
                  <motion.button
                    ...
                    className={`flex-1 px-6 py-3 rounded-none font-mono text-xs uppercase tracking-wider transition-all border ${
