    ...
    return (
      <div className="min-h-screen bg-[#050505] flex items-center justify-center text-white font-sans">
        <div className="text-center space-y-4">
          <h1 className="text-2xl font-bold tracking-widest text-[#2dd4bf]">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="text-right border-r border-white/10 pr-6 mr-2 hidden md:block">
            ...
            <div className="text-2xl font-black text-white font-mono">
              {activeClient.activePowerMW}{' '}
              <span className="text-sm text-slate-500">of {activeClient.capacityMW} MW</span>
            </div>
          </div>
                        ...
                        <div className="p-4 space-y-2">
                          <label className="flex items-center gap-2 cursor-pointer">
                            <input
                              ...
                              onChange={e => updateSettings({ allowCritical: e.target.checked })}
                            />
                    ...
                    {notifications.length === 0 ? (
                      ...
                      notifications.map(n => (
                        ...
                        >
                          ...
                          {!n.read && (
                            <div className="absolute top-2 right-2 w-1.5 h-1.5 bg-[#2dd4bf] rounded-full" />
                          )}
                        </div>
                      ))
                    )}
            ...
            {activeClient.reports.map(report => (
              ...
              >
                ...
                <div className="flex-1 w-full">
                  ...
                  <p className="text-sm text-slate-400 mt-2 leading-relaxed">{report.summary}</p>
                  <button
        ...
        <div className="col-span-1 lg:col-span-5 space-y-8">
            ...
            <div className="relative pl-6 border-l border-white/10 space-y-8">
              {activeClient.timeline.map((event, idx) => (
                <div key={event.id} className="relative">
                  {/* Dot */}
                  <div
                    className={`absolute -left-[29px] top-1 w-4 h-4 rounded-full border-2 ${
                      event.type === 'PAST'
                        ? 'bg-[#121212] border-emerald-500'
                        : 'bg-[#121212] border-amber-500'
                    }`}
                  />
                  ...
                  <div className="flex flex-col">
                    <span
                      className={`text-[10px] font-bold uppercase tracking-widest ${
                        event.type === 'PAST' ? 'text-emerald-500' : 'text-amber-500'
                      }`}
                    >
          ...
          <div className="bg-gradient-to-br from-[#2dd4bf]/10 to-transparent border border-[#2dd4bf]/20 rounded-lg p-6 text-center">
            ...
            <p className="text-sm text-slate-400 mb-6">
              Direct line to AnoHUB engineers for urgent consultations regarding your plant's
              physics or efficiency.
            </p>
            <button
