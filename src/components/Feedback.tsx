                ...
                <GlassCard className="p-0 border-t-4 border-t-cyan-500 shadow-2xl">
                    ...
                    {isSent ? (
                        <div className="text-center py-12 px-6">
                            ...
                            <p className="text-slate-400">Your feedback is invaluable for refining the Standard of Excellence.</p>
                        </div>
                    ) : (
                        <div className="p-8">
                            <div className="text-center mb-8">
                                <h3 className="text-2xl font-bold text-white mb-2">Rate Your Experience</h3>
                                <p className="text-slate-400 text-sm">Help us engineer a better platform.</p>
                            </div>
