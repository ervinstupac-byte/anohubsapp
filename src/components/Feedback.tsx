          ...
          {isSent ? (
            <div className="text-center py-12 px-6">
              ...
              <h3 className="text-2xl font-bold text-white mb-2">
                {t('feedback.thankYouTitle', 'Thank You!')}
              </h3>
              <p className="text-slate-400">
                {t(
                  'feedback.thankYouDesc',
                  'Your feedback is invaluable for refining the Standard of Excellence.'
                )}
              </p>
            </div>
          ) : (
            <div className="p-8">
              <div className="text-center mb-8">
                <h3 className="text-2xl font-bold text-white mb-2">
                  {t('feedback.rateTitle', 'Rate Your Experience')}
                </h3>
                <p className="text-slate-400 text-sm">
                  {t('feedback.rateDesc', 'Help us engineer a better platform.')}
                </p>
              </div>
              ...
              <div className="mb-6">
                <textarea
                  ...
                  placeholder={t(
                    ...
                    'Optional: What can we improve to close the Execution Gap?'
                  )}
                  value={comment}
