...
vi.mock('../VisionAnalyzer', () => ({
  VisionAnalyzer: () => <div data-testid="vision-analyzer" />,
}));
vi.mock('../AudioSpectrogram', () => ({
  AudioSpectrogram: () => <div data-testid="audio-spectrogram" />,
}));
vi.mock('../PostMortemMonitor', () => ({
  PostMortemMonitor: () => <div data-testid="post-mortem" />,
}));
