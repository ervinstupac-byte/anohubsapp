...
const BASE_CLASSES = `
    ...
    hover:text-brand-400 hover:bg-slate-800/80 hover:border-slate-700 hover:shadow-lg
    active:scale-95
...
export const BackButton: React.FC<BackButtonProps> = ({ 
    ...
    return (
        ...
        >
            <div className="w-5 h-5 rounded-full bg-slate-800 flex items-center justify-center group-hover:bg-brand-500/10 transition-colors">
                <svg 
