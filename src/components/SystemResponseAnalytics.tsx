...
export const SystemResponseAnalytics: React.FC = () => {
  ...
  return (
    <GlassCard
      title="System Response & Hysteresis"
      className={
    ...
    >
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center text-[10px] font-bold uppercase tracking-widest px-1">
          ...
          <span
            className={
              analysis.timeSinceCommand > 1000 ? 'text-amber-500 animate-pulse' : 'text-slate-500'
            }
          >
        ...
        <div
          className={`p-4 rounded-xl border ${analysis.severity === 'CRITICAL' ? 'bg-red-500/10 border-red-500/30' : analysis.severity === 'WARNING' ? 'bg-amber-500/10 border-amber-500/30' : 'bg-emerald-500/10 border-emerald-500/30'}`}
        >
        ...
        <div className="pt-4 border-t border-white/5">
          <p className="text-[9px] text-slate-500 uppercase font-black mb-3">
