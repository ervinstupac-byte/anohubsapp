  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      ForensicReportService.openAndDownloadBlob(
        blob,
        `AnoHUB_Audit_${state.identity.assetName}_${new Date().toISOString().split('T')[0]}.pdf`,
        true,
        {
                    ...
                    <div className="flex-1 z-10">
                      <div className="border-b-4 border-slate-900 pb-4 mb-8">
                        ...
                        <p className="text-slate-500 font-mono mt-2">
                          ID: {state.identity.assetId || 'UNKNOWN'} •{' '}
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="flex justify-between items-end border-b border-slate-200 pb-2">
                          ...
                          <span className="text-xl font-bold text-slate-800">
                            {state.identity.machineConfig.ratedPowerMW} MW
                          </span>
                        </div>
                      </div>
