        ...
        <div className="relative w-full h-[400px] bg-slate-950/50 rounded-none overflow-hidden border border-white/5 shadow-none">
            ...
            {plants.map(plant => (
                ...
                >
                    ...
                    <div className={`w-4 h-4 rounded-none border-2 ${plant.healthScore < 90 ? 'bg-amber-500 border-amber-300' : 'bg-brand-500 border-brand-300'} shadow-none transition-all group-hover:scale-125`}></div>
                            ...
                            {plants.map(plant => (
                                <div key={plant.id} className="group">
                                    ...
                                    <div className="w-full bg-slate-800 h-2 rounded-none overflow-hidden">
                                        <div
                                            className={`h-full rounded-none transition-all duration-1000 ${plant.efficiency < 89 ? 'bg-amber-500' : 'bg-gradient-to-r from-brand-600 to-brand-400'}`}
