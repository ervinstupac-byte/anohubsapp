      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex-1 space-y-2">
          <div className="flex items-center gap-2">
            <div
              className={`w-2 h-2 rounded-full ${triggers.acoustic ? 'bg-amber-500 animate-pulse' : 'bg-slate-600'}`}
            ></div>
            <span
          ...
          <div className="flex items-center gap-2">
            <div
              className={`w-2 h-2 rounded-full ${triggers.thermal ? 'bg-red-500 animate-pulse' : 'bg-slate-600'}`}
            ></div>
            <span
          ...
          <div className="flex items-center gap-2">
            <div
              className={`w-2 h-2 rounded-full ${triggers.hydraulic ? 'bg-blue-500 animate-pulse' : 'bg-slate-600'}`}
            ></div>
            <span
          ...
          <div
            className={`mt-4 p-3 rounded-lg border ${detected ? 'bg-red-950/30 border-red-500/30' : 'bg-slate-900/30 border-slate-700/30'}`}
          >
