...
import {
  ...
  InspectionResult,
  DamageType,
} from '../services/VisualInspectionService';
  ...
  return (
    <div className="p-6 h-full flex flex-col">
      <h2 className="text-2xl font-black text-white uppercase tracking-tighter mb-6 flex items-center gap-3">
        ...
        Blade Vision{' '}
        <span className="text-slate-500 text-sm normal-case border-l border-slate-700 pl-3">
          Gemini Powered Inspection
        </span>
      </h2>
            ...
            {!selectedImage && (
              <div className="text-center p-8">
                ...
                <p className="text-slate-400 text-sm mb-6">
                  Support for macro shots of Kaplan blades, Francis runners, and Pelton buckets.
                </p>
            ...
            {selectedImage && (
              <>
                <img
                  src={selectedImage}
                  alt="Analysis Target"
                  className="max-h-full max-w-full object-contain opacity-50 transition-opacity duration-1000"
                  style={{ opacity: isAnalyzing ? 0.3 : 0.8 }}
                />
                ...
                <div className="p-4 bg-red-950/20 border border-red-500/30 rounded">
                  ...
                  <div className="w-full bg-slate-800 h-1.5 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{ width: `${result.estimatedEfficiencyLoss * 20}%` }}
                    ></div>
                  </div>
                </div>
