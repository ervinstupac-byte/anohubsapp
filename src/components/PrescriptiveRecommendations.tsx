  ...
  if (assetPrescriptions.length === 0) {
    return (
      <GlassCard className="bg-slate-900/40 border-l-4 border-l-emerald-500">
        ...
        <p className="text-[10px] text-slate-500 mb-3">AI-generirane preporuke za akciju</p>
            ...
            >
              ...
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="text-lg">{isCritical ? '🔴' : isHigh ? '⚠️' : '🟡'}</span>
                    <h4
                      className={`text-sm font-black uppercase tracking-tight ${
                        isCritical ? 'text-red-300' : isHigh ? 'text-amber-300' : 'text-slate-300'
                      }`}
                    >
                  ...
                  <div className="space-y-0.5 text-[10px]">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-bold text-white uppercase">
                        {prescription.component.replace('_', ' ')}
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
              ...
              <div
                className={`p-3 rounded-lg mb-3 ${
                  isCritical ? 'bg-red-900/20' : isHigh ? 'bg-amber-900/20' : 'bg-slate-900/20'
                }`}
              >
