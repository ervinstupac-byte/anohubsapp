...
export const CommissioningModeDashboard: React.FC = () => {
  ...
  const { activeSession, isCommissioningMode, startCommissioningMode, exitCommissioningMode } =
    useCommissioning();
  ...
  if (!isCommissioningMode) {
    return (
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-black uppercase tracking-tighter mb-3">
            ...
            <span className="text-cyan-400 font-bold ml-2">
              {mapAssetToEnhancedAsset(selectedAsset).turbine_family?.toUpperCase()}
            </span>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400 ml-2">
              Mode
            </span>
          </h1>
          <p className="text-slate-400">Initial machine pairing and baseline recording system</p>
        </div>
        ...
        {mapAssetToEnhancedAsset(selectedAsset).turbine_family === 'PELTON' && (
          <GlassCard className="p-6 bg-gradient-to-br from-purple-950/30 to-pink-950/30 border-purple-500/30">
            ...
            <p className="text-sm text-slate-300 mb-2">
              <strong>Multi-Nozzle Jet Sync:</strong> Individual acoustic analysis of each nozzle to
              detect erosion, sand damage, and rotor force imbalance.
            </p>
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <CommissioningWizard
        asset={mapAssetToEnhancedAsset(selectedAsset)}
        onComplete={session => {
