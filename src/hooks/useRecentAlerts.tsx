...
export function useRecentAlerts(pollIntervalMs: number = 10000, pushToNotifications: boolean = true) {
    ...
    useEffect(() => {
        ...
        for (const a of alerts) {
            ...
            if (a.severity === 'CRITICAL' || a.severity === 'WARNING') {
                ...
                if (!ui) {
                    ui = { message: a.message || a.issue || 'Alert', uiSeverity: a.severity === 'CRITICAL' ? 'high' : 'medium', translationKey: 'notifications.alert' };
                }
