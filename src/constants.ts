...
export const TURBINE_CATEGORIES: TurbineCategories = {
  kaplan: {
    name: 'Kaplan Turbine',
    description:
      'Adjustable blades for low head (10-70m) and variable flow. High efficiency across wide operating ranges.',
    types: [
      {
        id: 'kaplan_vertical',
        name: 'Vertical Kaplan',
        description: 'Standard for large run-of-river plants.',
      },
      {
        id: 'kaplan_horizontal',
        name: 'Horizontal Kaplan',
        description: 'Shaft horizontal orientation.',
      },
      {
        id: 'kaplan_pit',
        name: 'Pit Kaplan',
        description: 'Low profile, recessed runner housing.',
      },
      {
        id: 'kaplan_bulb',
        name: 'Bulb Turbine',
        description: 'Submerged generator for very low heads.',
      },
      { id: 'kaplan_s', name: 'S-Type Kaplan', description: 'Cost-effective for small hydro.' },
      {
        id: 'kaplan_spiral',
        name: 'Spiral Casing Kaplan',
        description: 'Variant with spiral casing optimization.',
      },
    ],
  },
  francis: {
    ...
    description:
      'The workhorse of hydro. Medium heads (40-600m). Fixed blades, variable guide vanes.',
    types: [
      {
        id: 'francis_vertical',
        name: 'Vertical Francis',
        description: 'High capacity, standard configuration.',
      },
      {
        id: 'francis_horizontal',
        name: 'Horizontal Francis',
        description: 'Smaller units, easier installation.',
      },
      {
        id: 'francis_slow_runner',
        name: 'Slow Runner Francis',
        description: 'High torque, low speed configuration.',
      },
      {
        id: 'francis_fast_runner',
        name: 'Fast Runner Francis',
        description: 'Optimized for higher specific speed.',
      },
    ],
  },
  pelton: {
    ...
    types: [
      {
        id: 'pelton_vertical',
        name: 'Vertical Pelton',
        description: 'Multi-jet (4-6) for higher power.',
      },
      {
        id: 'pelton_horizontal',
        name: 'Horizontal Pelton',
        description: '1-2 jets, simple maintenance.',
      },
      {
        id: 'pelton_multi_jet',
        name: 'Multi-Jet Pelton',
        description: 'High-head with 4-6 needle jets.',
      },
    ],
  },
  crossflow: {
    ...
    types: [
      {
        id: 'crossflow_standard',
        name: 'Standard Crossflow',
        description: 'Simple design, easy repair.',
      },
    ],
  },
};
...
export const QUESTIONS: Question[] = [
  {
    id: 'q1',
    text: 'Are the turbine centerlines (mechanical vs. hydraulic) documented in the commissioning report?',
    options: ['Yes', 'No', 'Not Documented', 'Partial'],
  },
  {
    id: 'q2',
    text: 'Is there a digital log of the initial shaft alignment tolerance (< 0.05 mm/m)?',
    options: ['Yes', 'No', 'Partially', 'Paper Only'],
  },
  {
    id: 'q3',
    text: 'Have the foundation bolts been retightened and torqued after 500 operating hours?',
    options: ['Yes', 'No', 'Unknown', 'Scheduled'],
  },
  {
    id: 'q4',
    text: 'Is the "Acoustic Signature" (baseline vibration) recorded at varying loads?',
    options: ['Yes', 'No', 'Sometimes', 'Only at Full Load'],
  },
  {
    id: 'q5',
    text: 'Do you experience frequent shear pin failures on the guide vanes?',
    options: ['Never', 'Rarely', 'Occasionally', 'Frequently'],
  },
  {
    id: 'q6',
    text: 'Is the runner clearance (gap) monitored and logged annually?',
    options: ['Yes', 'No', 'Not Maintained', 'Partially Filled'],
  },
  {
    id: 'q7',
  ...
  },
  {
    ...
    options: ['Yes', 'No, only replacement is offered', 'Only Replacement', 'Sometimes'],
  },
  {
    id: 'q13',
  ...
  },
  {
    ...
    options: ['Yes', 'Not Installed/Functional', 'Some require checking'],
  },
  {
    id: 'q15',
  ...
  },
  {
    ...
    options: ['Good', 'Requires Minor Maintenance', 'Major Service Needed'],
  },
];
