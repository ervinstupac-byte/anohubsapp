...
export const EXAMPLE_THRUST_BEARING_PASSPORT: ComponentPassport = {
  ...
  mechanicalSpecs: {
    clearances: {
      radial: 0.03, // 30 microns radial clearance
      axial: 0.05, // 50 microns axial play
...
export const EXAMPLE_SERVICE_LOG: ServiceLogEntry = {
  ...
  description:
    'Tightened shaft seal mounting bolts after detecting minor water seepage. Seal face inspected and found to be in good condition.',
...
export function createThrustBearingWithHistory(): AssetNodeWithPassport {
  ...
  return createAssetWithPassport(thrustBearing, EXAMPLE_THRUST_BEARING_PASSPORT, [
    // Installation log
    {
      id: 'SVC-LOG-2024-001',
