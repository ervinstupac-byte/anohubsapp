...
export class ActiveHarmonicShaper {
  ...
  public static measureGridQuality(): GridHarmonics {
    ...
    const sumSquares = Array.from(harmonics.values()).reduce((sum, h) => sum + Math.pow(h, 2), 0);
  ...
  public static injectCounterHarmonics(gridQuality: GridHarmonics): HarmonicShapingResult {
