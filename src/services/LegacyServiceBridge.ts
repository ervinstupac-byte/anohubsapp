...
export class LegacyServiceBridge {
   ...
   */
  public static async enrichWithLegacyServices(
    telemetry: TelemetryStream
  ): Promise<TelemetryStream> {
  ...
  public static async processBatch(telemetryBatch: TelemetryStream[]): Promise<void> {
    console.log(
      `[LegacyBridge] Processing ${telemetryBatch.length} telemetry samples through legacy services...`
    );
