...
if (!SUPABASE_URL || !SUPABASE_ANON_KEY) {
  ...
  if (typeof window !== 'undefined') {
    ...
    errorBanner.style.cssText =
      'position:fixed;bottom:0;left:0;right:0;background:#ef4444;color:white;text-align:center;padding:12px;font-family:monospace;font-weight:bold;z-index:99999;border-top:2px solid #b91c1c;';
