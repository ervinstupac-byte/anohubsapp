...
export class KKSAssetTagger {
  ...
  public static initializeRegistry(): void {
    ...
    this.registerSensor(
      '10TTB01',
      'Turbine Temperature Bearing 1',
      'UNIT-1',
      'T',
      'Temperature',
      'Upper Guide Bearing Oil'
    );
    this.registerSensor(
      '10TTB02',
      'Turbine Temperature Bearing 2',
      'UNIT-1',
      'T',
      'Temperature',
      'Lower Guide Bearing Oil'
    );
    this.registerSensor(
      '10TPI01',
      'Turbine Pressure Inlet',
      'UNIT-1',
      'T',
      'Pressure',
      'Spiral Case'
    ...
    this.registerSensor(
      ...
      'T',
      'Blade',
      'Runner Servo Position'
    );
    this.registerSensor(
      '30THP01',
      'Turbine Hub Pressure',
      'UNIT-3',
      'T',
      'Pressure',
      'Runner Hub Cavity'
    ...
    this.registerSensor(
      '50TNP01',
      'Turbine Needle Position Nozzle 1',
      'UNIT-5',
      'T',
      'Needle',
      'Nozzle #1'
    ...
    this.registerSensor(
      '50TNP02',
      'Turbine Needle Position Nozzle 2',
      'UNIT-5',
      'T',
      'Needle',
      'Nozzle #2'
    ...
    this.registerSensor(
      '50TNP03',
      'Turbine Needle Position Nozzle 3',
      'UNIT-5',
      'T',
      'Needle',
      'Nozzle #3'
    ...
    this.registerSensor(
      '50TDF01',
      'Turbine Deflector Position Nozzle 1',
      'UNIT-5',
      'T',
      'Deflector',
      'Jet Deflector #1'
    ...
    this.registerSensor(
      '10ECB01',
      'Electrical Circuit Breaker Generator',
      'UNIT-1',
      'E',
      'Breaker',
      'CB-GEN'
    ...
    this.registerSensor(
      '10ECB02',
      'Electrical Circuit Breaker Transformer',
      'UNIT-1',
      'E',
      'Breaker',
      'CB-TX'
    ...
    this.registerSensor(
      '10ECB03',
      'Electrical Circuit Breaker Grid',
      'UNIT-1',
      'E',
      'Breaker',
      'CB-GRID'
