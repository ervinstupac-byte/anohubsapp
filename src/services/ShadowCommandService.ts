...
export class ShadowCommandService {
  ...
  public static calculateDelta(
    ...
    const actualResult = SovereignStrategist.calculateBridge(telemetry, financialContext, {
    ...
    const shadowResult = SovereignStrategist.calculateBridge(shadowTelemetry, financialContext, {
      accumulatedFatigue: 0,
    });
