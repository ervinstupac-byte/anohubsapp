...
import { getLastAutoTableFinalY, getPageCount, setGStateOpacity } from '../utils/pdfHelpers';
...
export function applyForensicFooter(doc: any) {
  ...
  for (let i = 1; i <= pageCount; i++) {
    ...
    doc.text('ISO 9001/14001/45001 INTEGRATED SYSTEMS VERIFIED', pageWidth / 2, pageHeight - 10, {
      align: 'center',
    });
  }
}
...
export function renderEvidenceTable(doc: any, startY: number, head: string[], body: any[]) {
  ...
  return getLastAutoTableFinalY(doc, startY);
}
