...
export class FleetOrchestratorV2 {
  ...
  public static calculateOptimalLoadDistribution(
    ...
    const unit3Degraded = unit3 && unit3.healthEffectiveness < 0.9;
  ...
  public static canMeetDemand(
    ...
    const availableCapacity = fleet.reduce((sum, asset) => {
      ...
      if (asset.assetId === 'UNIT-3' && asset.healthEffectiveness < 0.9) {
