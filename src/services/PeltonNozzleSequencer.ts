...
export class PeltonNozzleSequencer {
  ...
  public static calculateOptimalSequence(
    ...
    switch (targetCount) {
      case 1:
        activeNozzles = [1];
        break; // Unbalanced but unavoidable
      case 2:
        activeNozzles = [1, 4];
        break; // 180° apart (Perfect balance)
      case 3:
        activeNozzles = [1, 3, 5];
        break; // 120° apart (Perfect balance)
      case 4:
        activeNozzles = [1, 2, 4, 5];
        break; // X-shape (Balanced)
      case 5:
        activeNozzles = [1, 2, 3, 4, 5];
        break; // Slight unbalance
      case 6:
        activeNozzles = [1, 2, 3, 4, 5, 6];
