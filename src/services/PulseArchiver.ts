...
export class PulseArchiver {
  ...
  private static takeSample(): void {
    ...
    console.log(
      `[PulseArchiver] Sample #${this.samples.length} recorded: €${sample.liveROI.toLocaleString()}, ${sample.systemIntegrity.toFixed(1)}% integrity`
    );
   ...
   */
  public static getSamples(startTime?: number, endTime?: number): PulseSample[] {
