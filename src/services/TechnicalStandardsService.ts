...
export const STANDARDS_DB: TechnicalStandard[] = [
  ...
  },
  {
    ...
    titleDE:
      'Fluidtechnik - Hydraulikflüssigkeiten - Verfahren zur Kodierung des Verschmutzungsgrades durch feste Partikel',
    category: 'HYDRAULICS',
...
export class TechnicalStandardsService {
  ...
  static getApplicableStandards(analysisType: AnalysisType): TechnicalStandard[] {
    return STANDARDS_DB.filter(std => std.applicableConditions.includes(analysisType));
  }
