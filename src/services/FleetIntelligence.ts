...
export class FleetIntelligence {
   ...
   */
  public static benchmarkUnits(unitA: UnitPerformance, unitB: UnitPerformance): ComparisonResult {
    // 1. Normalize Inputs
    ...
    else if (laggard.vibration > leader.vibration * 1.5)
      diagnosis = 'Mechanical Defect: High vibration correlates with efficiency loss.';
