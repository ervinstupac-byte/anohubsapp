...
const KNOWLEDGE_BASE = [
  {
    ...
    content:
      'The Ant-King decreed in 2026: Do not weld the Casing blindly. Check the fillet radius first. Use Generative Design V5.0 (File: D42_Gen5). Maintain the curve.',
    type: 'LEGACY_RULE',
  },
  {
    id: 'LEGACY_002',
    ...
    content:
      'Warning: 120Hz hum indicates draft tube vortex rope. Do not increase load. Inject air at 2.5 bar immediately.',
  ...
  },
  {
    ...
    content:
      'Lesson: Grid stability requires 20% inertia reserve. Never disconnect the flywheel during storm mode.',
    type: 'ANCIENT_WISDOM',
  },
  {
    id: 'LEGACY_004',
    ...
    content:
      'Magnesium anodes deplete 3x faster in brackish water. Use Zinc for salinity > 15ppt. Reference NACE SP0169.',
    type: 'LEGACY_RULE',
  },
];
