  ...
  checkFilterCondition(telemetry: ExtendedAuxiliaryTelemetry): {
    ...
    if (deltaP >= CRITICAL_THRESHOLD) {
      return {
        ...
        recommendation:
          '🔴 IMMEDIATE ACTION: Switch to bypass filter NOW! Replace cartridges TODAY!',
        daysUntilCritical: 0,
      };
    }
    ...
    if (deltaP >= CLOGGED_THRESHOLD) {
      return {
        ...
        recommendation:
          '🟠 Clean or replace filter cartridges within 48 hours. Oil flow restricted.',
        daysUntilCritical: 2,
      };
    }
...
export const BIG_THRUST_BEARING_ENHANCED_PASSPORT: EnhancedBearingPassport = {
  ...
  thirstLevel: {
    ...
    description:
      'This bearing drinks oil like a thirsty elephant! Needs at least 15 L/min to stay happy. Give it 20 L/min for best performance.',
  },
  ...
  feverLimit: {
    ...
    description:
      'This bearing has a fever at 70°C! If it reaches 85°C, it will have a meltdown. Keep it below 55°C for long life.',
  },
};
