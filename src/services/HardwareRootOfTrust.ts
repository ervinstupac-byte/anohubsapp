...
export class HardwareRootOfTrust {
  ...
  private static readonly TRUSTED_KEYS = ['PUB_KEY_SCADA_MASTER_01', 'PUB_KEY_ENG_STATION_01'];

  /**
   * VERIFY SIGNATURE (Simulated)
   */
  public static verifyAction(payload: string, signature: string, publicKey: string): SignedAction {
    let verified = false;
